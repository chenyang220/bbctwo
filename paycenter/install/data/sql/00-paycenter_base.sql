...
-- ----------------------------
BEGIN;
INSERT INTO `pay_user_app` VALUES ('101', 'YuanfengERP', '', '', '1', '0'), ('102', 'ShopBuilder', '', '', '1', '0'), ('103', 'ImBuilder', '', '', '1', '0'), ('104', 'UCenter', '', '', '1', '0'), ('105', 'PayCenter', '', '', '1', '0');
COMMIT;
...
CREATE TABLE `pay_user_resource` (
  ...
  `user_money` decimal(16,2)  NOT NULL DEFAULT '0.00' COMMENT '用户资金-预付款充值、转账、结算后的款项等等',
