...
//加载支付code配置
if(is_file(INI_PATH.'/pay'.$server_id.'.ini.php')){
    $pay_config = include_once INI_PATH.'/pay'.$server_id.'.ini.php';
}else{
    $pay_config = include_once INI_PATH.'/pay.ini.php';
}
//把支付code注册为全局变量
Yf_Registry::set('pay_config',$pay_config);
if (!is_array($db_row))
{
	$db_row = array();
}
...
Yf_Registry::set('shop_app_url', $shop_app_url);
