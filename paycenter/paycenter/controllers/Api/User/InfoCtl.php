...
class Api_User_InfoCtl extends Api_Controller
{
	...
	public function editUserInfo()
	{
		...
		$edit_user_row['user_identity_card']     = request_string('number');
		$edit_user_row['user_identity_start_time']     = request_string('startime');
		$edit_user_row['user_identity_end_time']     = request_string('endime');
		$edit_user_row['user_identity_type']     = request_string('user_identity_type');
		$edit_user_row['user_identity_statu']     = request_string('user_identity_statu');
	...
	public function editReturnUserResourceInfo()
	{
		...
		if($user_data['user_money_frozen'] < 0)
		{
			...
			$edit['user_money_frozen'] = (-1)*$user_data['user_money_frozen'];
