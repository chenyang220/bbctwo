...
class Consume_RecordModel extends Consume_Record
{
	 ...
	 * @access public
	 */
    public function getRecordList($user_id = null,$type = null,$status = null, $page=1, $rows=100, $sort='asc',$user_nickname = null,$trade_type_id=null,$payorder='',$payorders='')
    {
        //需要分页如何高效，易扩展
        $offset = $rows * ($page - 1);
        ...
        if($payorders)
        {
            $this->sql->setWhere('order_id',$payorders);
        }
        if($type)
        {
