...
<div class="form-style-layout wrap" style="border:none;">
    <h2 class="pc_user_about"><?= __('支付密码') ?></h2>
        ...
        <div class="form-style">
            ...
            <form id="form" name="form" action="" method="post">
                ...
                <dl>
                    ...
                    <dd>
                        <input type="text" name="img_yzm" id="img_yzm" maxlength="6" style="width:86px;vertical-align:top;" placeholder="<?= __('请输入验证码') ?>" default="<i class=&quot;i-def&quot;></i><?= __('看不清？点击图片更换验证码') ?>"/>
                        &nbsp;&nbsp;&nbsp;
                ...
                <dl>
                    ...
                    <dd style="position: relative;">
                        ...
                        <span class="btn-eye-icon btn-eye-icon2"></span>
                    </dd>
                    <dt><em>*</em><?= __('重复密码'); ?>：</dt>
                    <dd style="position: relative;">
        ...
        <script type="text/javascript">
            ...
            $(".submit").click(function () {
                ...
                if (!password) {
                    ...
                    Public.tips.error("<?= __('密码中必须包含6-20个字符。')?>");
                    return false;
                }
    ...
    <?php }else{ ?>
        <div class="security-tips"><?= __('修改密码前必须先进行邮箱绑定或手机绑定，点击这里进行'); ?><a href="<?= Yf_Registry::get('ucenter_api_url') ?>?ctl=User&met=security&op=mobile"><?= __('手机绑定'); ?></a><?= __('或'); ?><a href="<?= Yf_Registry::get('ucenter_api_url') ?>?ctl=User&met=security&op=email"><?= __('邮箱绑定'); ?></a></div>
    <?php } ?>
</div>
<?php
