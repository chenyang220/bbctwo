...
<div class="wrap">
	...
	<div class="i-block account_mes">
        ...
        <dl class="detail">
            ...
            <?php if($v['withdraw_type'] == 2){ ?>
                <dd><span>支付宝账户：</span><em><?= $v['withdraw_identity'] ?></em></dd>
            <?php }else if($v['withdraw_type'] == 1){ ?>
                <dd><span>提现方式：</span><em>微信提现</em></dd>
            <?php }else{ ?>
            ...
            <dd><span>付款人：</span><em><?=$re['payer']?></em></dd>
