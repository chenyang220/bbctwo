...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'operating2', label:'公司资质信息', width:100, align:"center",fixed:true, formatter:company},
        ...
        function company(val, opt, row){
             var html_con = '<div class="operating" data-id="' + row.user_id + '"><span class="ui-icon ui-icon-search" title="详细资料"></span></div>';
            return html_con;
        }
    },
...
var handle = {
    operate: function (t, e)
    {
        if ("scan" == t)
        {
            var i = "查看信息公司信息", a = {oper: t, callback: this.callback};
                $.dialog({
                title: i,
                content: "url:./index.php?ctl=Paycen_PayInfo&met=scanUserInfo&type=bt&user_id="+e,
                data: a,
                width: 1000,
                height: 'auto',
                max: !1,
