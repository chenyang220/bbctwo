...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            {name:'consume_trade_id', label:'订单编号', width:350, align:"center"},
            ...
            {name:'goods_name', label:'商品名', width:250, align:"center"},
            {name:'order_goods_num', label:'数量', width:160, align:"center"},
    ...
    addEvent: function(){
        ...
        $("#btn-excel").click(function ()
        {
            ...
            var totalpage = $('#sp_1_page').text();
            queryConditions.page = page;
            queryConditions.totalpage = totalpage;
            $.dialog({
                title: '订单导出',
                content: "url:"+SITE_URL + '?ctl=Paycen_PayInfo&met=exportOrder',
