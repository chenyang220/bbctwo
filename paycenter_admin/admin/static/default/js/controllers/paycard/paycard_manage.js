    ...
    $_form.validator({
        rules: {
            check:function(element) {
                ...
                var datetime1 = Date.parse(card_start_time.replace(/-/g, "/"));
                var DateTime = new Date(new Date().toLocaleDateString());
                var now_time = DateTime.getTime();
                if(datetime1 < now_time)
                {
                    return false;
                }
            },
            checkTime:function (element) {
                ...
                var datetime1 = Date.parse(card_start_time.replace(/-/g, "/"));
                var datetime2 = Date.parse(card_end_time.replace(/-/g, "/"));
                ...
                if(card_start_time!=""&&card_end_time!=""&&datetime1 >=datetime2)
                {
                    return false;
                }
            },
        ...
        fields: {
            ...
            card_start_time: "check", //开始时间
            card_end_time: "checkTime" //结束时间
        },
        display: function (a)
        {
