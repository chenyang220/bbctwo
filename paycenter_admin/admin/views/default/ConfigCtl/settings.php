    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current"><span><?= __('站点'); ?>Logo</span></a></li>
    ...
    <form method="post" enctype="multipart/form-data" id="site-config-form" name="form">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <img id="site_logo_image" name="site[site_logo]" alt="<?= __('选择图片'); ?>" src="<?=($data['site_logo']['config_value'])?>" width="200px" height="200px" />
                    ...
                    <div class="notic"><?= __('默认网站'); ?>LOGO,<?= __('通用头部显示，最佳显示尺寸为'); ?>200*200<?= __('像素'); ?></div>
                </dd>
            </dl>
    ...
    $(function(){
        ...
        $('#site_logo_upload').on('click', function () {
            ...
            $.dialog({
                ...
                data: { PAYCENTER_URL: PAYCENTER_URL, width: imageWidth, height: imageHeight, callback: callback },    // <?= __('需要截取图片的宽高比例'); ?>
                width: '800px',
                lock: true
            })
        });
