...
<script>
	...
	function markupVension()
	{
		...
		if (SYSTEM.siType === 1)
		{
			...
			{
				case 1:
					imgModel.attr('src', imgSrcList.baseTrial).attr('alt', '<?= __('基础版试用版'); ?>');
					break;
				case 2:
					imgModel.attr('src', imgSrcList.baseExp).attr('alt', '<?= __('免费版（百度版）'); ?>');
					break;
				case 3:
					imgModel.attr('src', imgSrcList.base).attr('alt', '<?= __('基础版'); ?>');//标准版'); ?>
					break;
				case 4:
					imgModel.attr('src', imgSrcList.baseExp).attr('alt', '<?= __('基础版体验版'); ?>');//标准版'); ?>
					break;
			}
		...
		else
		{
			...
			{
				case 1:
					imgModel.attr('src', imgSrcList.standardTrial).attr('alt', '<?= __('标准版试用版'); ?>');
					break;
				case 3:
					imgModel.attr('src', imgSrcList.standard).attr('alt', '<?= __('标准版'); ?>');//标准版'); ?>
					break;
				case 4:
					imgModel.attr('src', imgSrcList.standardExp).attr('alt', '<?= __('标准版体验版'); ?>');//标准版'); ?>
					break;
			}
	...
	<div class="col-hd cf">
		...
		<div class="right cf">
			...
			<ol>
				...
				<li><a href="<?= $shop_admin_url ?>" target="_blank"><i class="nav_href"><?= __('商城系统'); ?></i></a></li>
<!-- 			<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Login&met=loginout"><i class="nav_href"><?= __('广告系统'); ?></i></a></li>
				<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Login&met=loginout"><i class="nav_href"><?= __('大数据'); ?></i></a></li>
				<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Login&met=loginout"><i class="nav_href"><?= __('备份系统'); ?></i></a></li>
				<li><a href="<?= $im_api_url ?>" target="_blank"><i class="nav_href">IM<?= __('系统'); ?></i></a></li> -->
	...
	<div class="col-bd">
		<div id="col-side">
			...
			<div class="nav-wrap hidden cf"><!--<?= __('订单'); ?>-->
				<ul id="nav" class="cf">
				...
				<div id="sub-nav">
					<ul class="cur cf" id="setting-base">
						...
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Config&met=site&typ=e&config_type%5B%5D=site" rel="pageTab" tabid="site-setting" tabtxt="<?= __('基础设置'); ?>"><?= __('基础设置'); ?></a>
						</li>

						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Config&met=api&typ=e&config_type%5B%5D=api" rel="pageTab" tabid="api-setting" tabtxt="API<?= __('设置'); ?>">API<?= __('设置'); ?></a>
						</li>
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Payment_Channel&met=index&typ=e" rel="pageTab" tabid="sale_order_manage"
																  tabtxt="<?= __('支付方式设置'); ?>"><?= __('支付方式设置'); ?></a></li>

						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=User_App&met=index" rel="pageTab" tabid="sale_order_manage" tabtxt="<?= __('支付应用管理'); ?>"><?= __('支付应用管理'); ?></a>
						</li>
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Message&met=template&typ=e" rel="pageTab" tabid="message_manage" tabtxt="<?= __('消息管理'); ?>"><?= __('消息管理'); ?></a>
						</li>


						<?php if(is_dir(APPPATH.'/../upgrade')){ ?>
                        <li>
                        <i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Config&met=update" rel="pageTab" tabid="sale_order_manage" tabtxt="<?= __('版本管理'); ?>"><?= __('版本管理'); ?></a>
                        </li>
						<?php } ?>
					...
					<ul class="cf" id="setting-manage">
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayWithdraw&met=index" rel="pageTab" tabid="PayWithdraw_Withdraw"
																  tabtxt="<?= __('提现服务'); ?>"><?= __('提现服务'); ?></a>
						</li>

						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayCard&met=index" rel="pageTab" tabid="Paycen_PayCard" tabtxt="<?= __('购物卡管理'); ?>"><?= __('购物卡管理'); ?></a>
						</li>
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayRecord&met=index" rel="pageTab" tabid="Paycen_PayRecord" tabtxt="<?= __('资金明细'); ?>"><?= __('资金明细'); ?></a>
						</li>
					</ul>

					<ul class="cf" id="setting-manage">
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayBase&met=index" rel="pageTab" tabid="Paycen_PayBase" tabtxt="<?= __('支付会员管理'); ?>"><?= __('支付会员管理'); ?></a>
						</li>
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Paycen_PayInfo&met=index" rel="pageTab" tabid="Paycen_PayInfo" tabtxt="<?= __('实名认证'); ?>"><?= __('实名认证'); ?></a>
						</li>
						<li>
							<i class="iconfont icon-point"></i><a data-right="BU_QUERY" href="index.php?ctl=Paycen_BtInfo&met=index" rel="pageTab" tabid="Paycen_BtInfo" tabtxt="<?= __('白条管理'); ?>"><?= __('白条管理'); ?></a>
						</li>
					</ul>
