...
/*	//__('公告'); ?>
	(function (){
		...
		var param = '?eventType=2&serviceId=' + SYSTEM.DBID;	//__('自带参数'); ?>
			...
			if(data.msg == 'success'){
				...
				for(var i=0; i<data.length; i++){
					...
					if(notice.msglink){
						...
						li = '<li><a href="/service/service.jsp?newsId=' + notice.msgid + '" rel="pageTab" tabId="myService" tabTxt=" __('服务支持'); ?>" parentOpen="true" title="' + notice.msgtitle + '" data-id="' + notice.msgid + '"><i></i>' + notice.msgtitle + '</a></li>'
					}
					html.push(li);
				}
