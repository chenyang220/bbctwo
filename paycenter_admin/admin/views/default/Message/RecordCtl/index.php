...
<div class="wrapper">
	<div class="mod-search cf">
		<div class="fl">
            <ul class="ul-inline">
				<li>
					<input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="<?= __('按发送人查询'); ?>">
				</li>
				<li>
					<input type="text" id="matchCon1" class="ui-input ui-input-ph matchCon1" value="<?= __('按接收人查询'); ?>">
				</li>
				<li>
                  <label><?= __('日期'); ?>:</label>
                ...
                <li><a class="mrb more" id="moreCon">(<?= __('高级搜索'); ?>)</a></li>
				<li><a class="ui-btn mrb" id="search"><?= __('查询'); ?></a></li>
			</ul>
		</div>
	</div>
	<div class="cf">
		<div class="grid-wrap fl cf">
			<h3><?= __('消息记录'); ?>:<span id='currentCategory'></span></h3>
			<table id="grid">
			</table>
			<div id="page"></div>
		</div>
