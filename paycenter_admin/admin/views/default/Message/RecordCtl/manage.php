...
<div class="wrapper">
	<div class="mod-search cf">
		<div class="fl">
            <ul class="ul-inline">
				<li>
					<input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" value="<?= __('请输入用户名查询'); ?>">
				</li>
				<li><a class="ui-btn mrb" id="search"><?= __('查询'); ?></a></li>
			</ul>
		</div>
		<div class="fr">
			<!--<a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add"><?= __('新增'); ?></a>-->
			<a href="#" class="ui-btn ui-btn-sp mrb" id="btn-batchDel"><?= __('推送消息'); ?></a>
		</div>
	</div>
	<div class="cf">
		<div class="grid-wrap fl cf">
			<h3><?= __('好友信息'); ?>:<span id='currentCategory'></span></h3>
			<table id="grid">
			</table>
			<div id="page"></div>
		</div>
