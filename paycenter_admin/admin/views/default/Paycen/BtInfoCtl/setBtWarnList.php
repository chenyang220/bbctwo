    ...
    <div class="item-title">
      <div class="subject">
       ...
       <ul class="tab-base nc-row">
          ...
          <li><a class="current"><?= __('白条提醒'); ?></a></li>
  ...
  <div class="ncap-form-default">
    ...
    <div class="fl">
      <ul class="ul-inline">
        ...
        <li>
          <label><?= __('还款日期'); ?>:</label>
          <input type="text" id="beginDate" value="" class="ui-input ui-datepicker-input" readonly>
          <i>-</i>
          <input type="text" id="endDate" value="" class="ui-input ui-datepicker-input" readonly>
        </li>
...
<script src="./admin/static/default/js/controllers/btinfo/btinfo_warn.js"></script>
<?php
