        ...
        <div id="manage-wrap" class="manage-wrap">
            <form id="manage-form" action="">
                <ul class="mod-form-rows base-form cf" id="base-form">
                    <li class="row-item ">
                        <div class="label-wrap"><label for="card_id"><em class="col-f30">*</em> <?= __('请选择卡号'); ?></label></div>
                        <div class="ctn-wrap">
                            <!--                            <span id="card_id" value="<?= __('请选择卡号'); ?>" name="card_id"></span>-->
                            <input type="text" class="ui-input" name="cardId" id="cardId">
                        </div>
                    </li>
                    <li class="row-item ">
                        <div class="label-wrap"><label for="card_sum"><em class="col-f30">*</em> <?= __('生成卡片数'); ?></label></div>
