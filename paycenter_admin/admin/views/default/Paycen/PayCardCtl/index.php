...
<div class="wrapper page">
  ...
  <div class="fixed-bar">
    <div class="item-title">
      <div class="subject">
        <h3><?= __('购物卡管理'); ?></h3>
        <h5><?= __('购物卡管理操作及相关信息'); ?></h5>
      </div>
      <ul class="tab-base nc-row">
          <li><a class="current"><span><?= __('购物卡管理'); ?></span></a></li>
          <li><a href="index.php?ctl=Paycen_PayCard&met=payCard"><?= __('管理与详情'); ?></a></li>
      </ul>
    </div>
  </div>
      ...
      <div class="mod-search cf">
        <div class="fl">
          <ul class="ul-inline">
            ...
            <li>
              <input type="text" id="cardName" class="ui-input ui-input-ph con" value="<?= __('请输入卡名称'); ?>">
            </li>
            <li>
              <label><?= __('日期'); ?>:</label>
        ...
        <div class="fr">
            <a href="#" class="ui-btn ui-btn-sp mrb" id="add"><?= __('新增'); ?><i class="iconfont icon-btn03"></i></a>
