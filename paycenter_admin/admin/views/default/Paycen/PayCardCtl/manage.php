    ...
    <div id="manage-wrap" class="manage-wrap">
    	 <form id="manage-form" action="">
    		<ul class="mod-form-rows base-form cf" id="base-form">
    		     <li class="row-item ">
    				<div class="label-wrap"><label for="card_id"><?= __('卡号'); ?></label></div>
    				<div class="ctn-wrap"><input type="text" class="ui-input" name="card_id" id="card_id"></div>
    			</li>
    			<li class="row-item ">
    				<div class="label-wrap"><label for="card_name"><?= __('卡名称'); ?></label></div>
    				<div class="ctn-wrap"><input type="text" class="ui-input" name="card_name" id="card_name"></div>
    			</li>
                <li class="row-item ">
                    <div class="label-wrap"><label for="cardnum"><?= __('数量'); ?></label></div>
                    <div class="ctn-wrap"><input type="text" class="ui-input" name="card_num" id="card_num"></div>
                </li>

    			<li class="row-item">
    				<div class="label-wrap"><label for="card_start_time"><?= __('开始时间'); ?></label></div>
    				<div class="ctn-wrap"><input id="card_start_time" autocomplete="off" type="text" class="ui-input ui-datepicker-input" name="card_start_time"></div>
    			</li>
    			<li class="row-item">
                    <div class="label-wrap"><label for="card_end_time"><?= __('结束时间'); ?></label></div>
                    <div class="ctn-wrap"><input id="card_end_time" autocomplete="off" type="text" class="ui-input ui-datepicker-input" name="card_end_time"></div>
                </li>
                <li class="row-item">
                    <div class="label-wrap"><label for="money"><?= __('金额'); ?></label></div>
    		...
    		<ul class="mod-form-rows remark contacters">
    			<li class="row-item">
					<div class="label-wrap"><label for="point"><?= __('描述'); ?></label></div>
