    ...
    <div class="item-title">
      <div class="subject">
       ...
       <ul class="tab-base nc-row">
          <li><a class="current"><span><?= __('资金明细'); ?></span></a></li>
      </ul>
    </div>
  </div>
      ...
      <div class="mod-search cf">
        <div class="fl">
          <ul class="ul-inline">
            ...
            <li>    
              <input type="text" id="userName" class="ui-input ui-input-ph con"  placeholder="<?= __('请输入用户帐号'); ?>">
            </li>
            <li>
              <input type="text" id="payOrder" class="ui-input ui-input-ph con"  placeholder="<?= __('请输入支付单号'); ?>">
            </li>
              <li>
                  <input type="text" id="payOrders" class="ui-input ui-input-ph con"  placeholder="<?= __('请输入订单号'); ?>">
              </li>
    <!--        <li>
              <label><?= __('注册时间'); ?>:</label>
