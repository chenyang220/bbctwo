  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
          <li><a href="index.php?ctl=Paycen_PayWithdraw&met=index"><span><?= __('提现申请'); ?></span></a></li>
          <li><a class="current"><span><?= __('服务费配置'); ?></span></a></li>
      </ul>
    </div>
  </div>
...
<!--    <div class="fl">
      <ul class="ul-inline">
        <li>
          <input type="text" id="userName" class="ui-input ui-input-ph con" value="<?= __('请输入会员名称'); ?>">
        </li>
        <li>
          <label><?= __('注册时间'); ?>:</label>
    ...
    <div class="fr">
        <a class="ui-btn ui-btn-sp mrb" id="btn-add"><?= __('新增'); ?><i class="iconfont icon-btn03"></i></a>
        <a href="javascript:void(0)" class="ui-btn" id="btn-refresh"><?= __('刷新'); ?><i class="iconfont icon-btn01"></i></a>
      </div>
</div> 
<div class="grid-wrap">
    <table id="grid">
