<?= __('﻿'); ?><?php if (!defined('ROOT_PATH')) exit('No Permission');?>
<?php
...
<div id="para-wrapper">
  <div class="ilodate"><?= __('支付设置（修改）'); ?></div>
    <div class="para-item">
		...
		<input type="hidden" name="payment_channel_id" id="payment_channel_id" value="<?php echo $payways['payment_channel_id']; ?>">
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_code"><?= __('名称'); ?>:</label>
				</div>
				<div class="ctn-wr6ap">
			...
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_name"><?= __('描述'); ?>:</label>
				</div>
				<div class="ctn-wrap">
			...
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_config_alipay_account"><?= __('微信公众号身份'); ?>:</label>
				</div>
				<div class="ctn-wrap">
			...
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_config_alipay_key"><?= __('受理商'); ?>ID:</label>
				</div>
				<div class="ctn-wrap">
			...
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_config_alipay_partner"><?= __('商户支付密钥'); ?>:</label>
				</div>
				<div class="ctn-wrap">
			...
			<li class="row-item">
				<div class="label-wrap">
					<label for="payment_channel_config_alipay_partner"><?= __('开发模式下的秘钥'); ?>:</label>
				</div>
				<div class="ctn-wrap">
	...
	<div class="btn-wrap"> <a name="submit" id="submit" class="ui-btn ui-btn-sp"><?= __('提交'); ?></a>
	</div>
</div>
