        ...
        <div class="item-title">
            <div class="subject">
               ...
               <ul class="tab-base nc-row">
                    <li><a class="current" href="index.php?ctl=Payment_Channel&met=index&typ=e"><span><?= __('分类管理'); ?></span></a></li>
                    <li><a href="index.php?ctl=Config&met=yunshan&typ=e&config_type%5B%5D=yunshan"><span><?= __('银联商务支付'); ?></span></a></li>
                </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
