...
class Yf_Data
{
    ...
    */
     ...
     * @access public
     */
    public function setError($msg, $data = [], $status = 250)
    {
        $item = ['cmd_id' => -1, 'status' => $status, 'msg' => $msg, 'data' => $data];
        //$this->dataRows[] = $item;
        $this->dataRows = $item;
    }
    ...
    {
        exit(encode_json(["result" => 0, "msg" => $msg]));
    }
    ...
    {
        $item = ['cmd_id' => $cmd_id, 'code' => $code, 'msg' => $msg];
        $this->dataRows[] = $item;
    }
    ...
    public function addBody($cmd_id, $data_rows = null, $msg = 'success', $status = 200)
    {
        ...
        if (is_array($data_rows)) {
            ...
            $pro_data_rows = ['cmd_id' => $cmd_id] + $body_data_rows;
    ...
    public static function encodeProtocolData($d, $typ = 'json')
    {
        if ('json' == $typ || 'msgpack' == $typ || 'json' == $typ) {
            ...
            var_dump($static_r_row);
            var_dump($static_s_row);
            die();
