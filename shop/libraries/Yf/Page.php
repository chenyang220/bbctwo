...
class Yf_Page
{
    ...
    function prompt()
    {
        ...
        if ($this->nowPage > 1) {
            ...
            $prePage = "<a class='prePage' href='" . $this->url . "?firstRow=$preRow&totalRows=$this->totalRows$this->parameter'>".__('上一页')."</a>";
        }
        if ($this->nowPage > 3)
        ...
        if ($this->nowPage < $this->totalPages) {
            ...
            $nextPage = " <a class='nextPage' href='" . $this->url . "?firstRow=$nextRow&totalRows=$this->totalRows$this->parameter'>".__('下一页')."</a>";
        ...
        if (false && $config['temp'] == 'wap') {
            $prePage = $prePage ? "<div class='pre'>" . $prePage . "</div>" : "<div class='pre grey'>".__('上一页')."</div>";
            $nextPage = $nextPage ? "<div class='next'>" . $nextPage . "</div>" : "<div class='next grey'>".__('下一页')."</div>";
    ...
    function ajaxprompt()
    {
        ...
        if ($this->nowPage > 1) {
            $preRow = ($this->nowPage - 2) * $this->listRows;
            $prePage = "<a class='prePage' url='" . $this->url . "?firstRow=$preRow&totalRows=$this->totalRows$this->parameter'>".__('上一页')."</a>";
        }
        if ($this->nowPage > 3) {
        ...
        if ($this->nowPage < $this->totalPages) {
            $nextRow = ($this->nowPage) * $this->listRows;
            $theEndRow = ($this->totalPages - 1) * $this->listRows;
            $nextPage = " <a class='nextPage' url='" . $this->url . "?firstRow=$nextRow&totalRows=$this->totalRows$this->parameter'>".__('下一页')."</a>";
            if ($this->totalPages > 7) {
