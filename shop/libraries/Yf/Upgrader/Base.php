...
class Base
{
	...
	public function generic_strings()
	{
		...
		$this->strings['fs_no_root_dir']    = __('Unable to locate BBC root directory.');
		$this->strings['fs_no_content_dir'] = __('Unable to locate BBC content directory (wp-content).');
		$this->strings['fs_no_plugins_dir'] = __('Unable to locate BBC plugin directory.');
		$this->strings['fs_no_themes_dir']  = __('Unable to locate BBC theme directory.');
