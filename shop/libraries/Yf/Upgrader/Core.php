...
class Core extends Base
{
	...
	{
		$this->strings['up_to_date']            = __('BBC is at the latest version.');
		...
		$this->strings['rollback_was_required'] = __('Due to an error during updating, BBC has rolled back to your previous version.');
	}
