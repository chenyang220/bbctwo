...
class Api_Erp_OrderCtl extends Api_Controller{
    ...
    public function downOrder()
    {
        ...
        $buyer_user_id = array_column($Order_Base, 'buyer_user_id');
        ...
        //用户查询优化
        $User_InfoModel = new User_InfoModel();
        $buyer_user_id_str = implode(',', array_unique($buyer_user_id));
        $sql = "select a.user_sex,a.user_mobile,a.user_email,a.user_qq,a.user_ww,a.user_id FROM yf_user_info as a WHERE user_id IN(" . $buyer_user_id_str . ")";
        $User_Info_Select = $User_InfoModel->sql->getAll($sql);
        $User_Info = array_column($User_Info_Select,NULL,"user_id");
