...
class Api_Goods_EvaluationCtl extends Api_Controller
{
    public $goodsEvaluationModel='';
...
//			return $this->data->addBody(-140, [$flag], __('无效参数'), 250);
    ...
    public function getEvaluationByOrderId()
    {
        ...
        $goods_evaluation_row = $Goods_EvaluationModel -> getByWhere(array('order_id' => $order_id, 'user_id' => $user_id));
