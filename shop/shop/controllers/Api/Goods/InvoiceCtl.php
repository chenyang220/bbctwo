...
class Api_Goods_InvoiceCtl extends Api_Controller
{
    public $invoiceModel='';
    ...
    {
        $add_row['user_id']              = request_int('user_id');                  //会员id
        ...
        $add_row['invoice_area_code']    = request_string('invoice_area_code')?:86;    //收票人手机号区号
    ...
    private function checkInvoiceData($data){
        ...
        if($data['invoice_state'] == 2 || $data['invoice_state'] == 3){
            if(!Yf_Utils_String::isMobile($data['invoice_rec_phone']) && $data['invoice_area_code'] == 86){
    ...
    public function editInvoice()
    {
        ...
        $edit_row['invoice_area_code']    = request_string('invoice_area_code')?:86;    //收票人手机号区号
