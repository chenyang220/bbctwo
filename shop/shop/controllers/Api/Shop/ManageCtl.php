...
class Api_Shop_ManageCtl extends Api_Controller
{
    ...
    public function editShopCategory()
    {
        ...
        $shop_class_bind_row['delivery'] = Web_ConfigModel::value('Plugin_Delivery');
    ...
    public function editShopCategoryRow()
    {
        ...
        $class_list["delivery_status"] = request_int("delivery_status");
        $class_list["delivery_price"] = request_string("delivery_price");
        $shopClassBindModel = new Shop_ClassBindModel();
