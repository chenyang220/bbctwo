 ...
 */
class Api_Supplier_CatImageCtl extends Api_Controller
{
    ...
    public function __construct(&$ctl, $met, $typ)
    {
        ...
        $this->mbCatImageModel = new Supplier_CatImageModel();
    }
    ...
    public function addCatImage()
    {
        ...
        $insert_data['app_cat_image']    = $param['mb_cat_image'];
    ...
    public function editCatImage()
    {
        ...
        $update_data['app_cat_image']    = $param['mb_cat_image'];
