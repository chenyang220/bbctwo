...
class Api_Shop_SelfsupportCtl extends Api_Controller
{
    ...
    public function AddShopRow()
    {
        ...
        $formvars['company_phone']  = request_string("shop_tel");
        $formvars['area_code']  = request_string("area_code");
        ...
        if (200 == $init_rs['status'])
        {
            ...
            $user_info_row['area_code']   = @$init_rs['data']['area_code'];
            $user_info_row['user_regtime'] = time();
            ...
            $datas['shop_status']       = "3";
            $datas['shop_tel'] = $user_info_row['user_mobile'];
...
//        $shop_base['area_code']    = request_string("area_code");
