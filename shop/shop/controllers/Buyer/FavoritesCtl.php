        ...
        public function footprint()
        {
            ...
            if ($data['items']) {
                ...
                foreach ($data['items'] as $key => $val) {
                    ...
                    $common_id = array();
                    $common_id['common_id:in'] = array_unique(array_column($foot, 'common_id'));

                    if ($classid) {
                        $goodsid['cat_id'] = $classid;
                    }
                    $goods = array();
                    $goods = $this -> goodsCommonModel -> getGoodsByCommonId($common_id, array(), false);
                    if ($foot) {
                        foreach ($foot as $k => $v) {
...
//                $data['items'] = $items;
        ...
        public function delFootprint()
        {
            ...
            $common_id = request_row('common_id');
            $common_id = is_string($common_id) ? explode(',',$common_id): $common_id;
            if($common_id) {
