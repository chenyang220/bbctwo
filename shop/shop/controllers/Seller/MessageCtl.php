...
//		}
    ...
    public function getSellerMsg(){
           ...
           $cond_row['message_type'] =request_string('id');
           $cond_row['message_user_id'] = request_string('u');
    ...
    return $this->data->addBody(-140, $data, $msg, $status);die;
        ...
        $shop_base_info = current($shopBaseModel->getByWhere(array("user_id"=>$user_id)));
