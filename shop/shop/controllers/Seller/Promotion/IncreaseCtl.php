<?php if (!defined('ROOT_PATH')) {
    ...
    class Seller_Promotion_IncreaseCtl extends Seller_Controller
    {
        ...
        public function getShopGoods()
        {
            ...
            //获取plus商品集合 @nsy 2019-04-01
            $plus_common_ids = $this->goodsPlusGoodsModel->getSellerShopPlusGoodsList();
            ...
            if ($increase_rows) {
                ...
                //店铺已加入加价购活动的商品ID
                $incerase_goods_id = $this->increaseGoodsModel->getIncreaseGoodsIdByWhere($cond_rows_join, array());
            }else{
                $incerase_goods_id = array();
            }
            $join_goods_id = array_merge($bargain_goods_ids, $incerase_goods_id);
