...
class Seller_Promotion_VoucherCtl extends Seller_Controller
{
	...
	public function addVoucherTemp()
    {
		...
		$field_row['voucher_t_start_date']       = request_string('voucher_t_start_date');                                 //開始時間
...
//		$field_row['voucher_t_eachlimit']        = request_int('voucher_t_eachlimit');
		$field_row['voucher_t_eachlimit']        = 1;          //限领数量，没人限领一张
