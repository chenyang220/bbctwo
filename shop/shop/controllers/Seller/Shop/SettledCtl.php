...
class Seller_Shop_SettledCtl extends Seller_Controller
{
	...
	public function index()
	{
		if (Perm::checkUserPerm())
		{
            ...
            //http://www.shop.com/index.php?ctl=Seller_Index&met=index&typ=e&is_from=Supplier
...
//			}
			...
			$shop_class = $this->shopClassModel->getByWhere(array(), $order);
    ...
    public function shopPayadd()
    {
        $shop_id                              = request_int('shop_id');
        // echo $shop_id;die;
        $shop_list['payment_voucher']         = "";
        $shop_list['payment_voucher_explain'] = "";
...
//                }
    ...
    public function getShopRequest($apply){
        ...
        if(!preg_match('/^1[3-9]\d{9}$/', $contacts_phone) && $area_code==86){
            $data['msg'] = '手机号码有误';
            $data['status'] = 250;
            return $data;
        }
...
//        }
        ...
        $shop_company['area_code']               = $area_code;
        ...
        $shop_company['legal_person'] = request_string('legal_person');
        $shop_company['business_sphere'] = request_string('business_sphere');
