...
class Seller_Trade_DeliverCtl extends Seller_Controller
{
	...
	public function delivering()
	{
		...
		foreach ($data['items'] as $key => $val)
		{
			...
			$data['items'][$key]['send_url'] = $val['send_url'] . '&style=edit';
		}
	...
	public function addAddress()
	{
        ...
        $field_row['area_code']                    = request_string('area_code');        //联系方式
    ...
    public function showInvoice()
    {
        ...
        //获取用户的发票信息
//        $order_invoice_model = new Order_InvoiceModel();
//        $data = current($order_invoice_model->getByWhere(array('order_id'=>$order_id)));

        $Order_BaseModel = new Order_BaseModel();$condi['order_id'] = $order_id;
