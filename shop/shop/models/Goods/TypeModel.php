...
//		$Goods_TypeModel      = new Goods_TypeModel();        //商品类型表
    ...
    {
        if($type_id){
            $sql = "SELECT type_id,type_name FROM " . TABEL_PREFIX . "goods_type where type_id = '".$type_id."' LIMIT 1000";
        }else{
            $sql = "SELECT type_id,type_name FROM " . TABEL_PREFIX . "goods_type LIMIT 1000";
        }
