 ...
 * @todo
 */
class Information extends Yf_Model
{
    public $_cacheKeyPrefix  = 'c|Information|';
    public $_cacheName       = 'information';
    public $_tableName       = 'information';
     ...
     * @access public
     */
    public function getInformation($information_id = null, $sort_key_row = null)
    {
        $rows = array();
     ...
     * @access public
     */
    public function addInformation($field_row, $return_insert_id = false)
    {
     ...
     * @access public
     */
    public function editInformation($information_id = null, $field_row = array(), $flag = true)
    {
