...
class Order_GoodsModel extends Order_Goods
{
    ...
    public function getGoodsFromOrder($cond_row)
    {
        ...
        $sql .= TABEL_PREFIX . "order_goods AS order_goods JOIN ";
        $sql .= TABEL_PREFIX . "order_base AS order_base ON ";
        $sql .= "order_goods.order_id = order_base.order_id JOIN ";
        $sql .= TABEL_PREFIX . "goods_common AS goods_common ON ";
    ...
    public function getOrderGoodsByIds($orderIds){
        ...
        $sql .= TABEL_PREFIX . "order_goods WHERE order_id IN (";
        $sql .= $condition.")";
