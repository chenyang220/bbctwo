			...
			if ($de)
			{
                ...
                foreach ($data['items'] as $key => $val) {
                    ...
                    if (in_array($val['goods_id'], $goods_id_rows)) {
                        $row['common_id'] = $de[$val['goods_id']]['common_id'];
                        $row['images_color_id'] = $de[$val['goods_id']]['color_id'];
                        $goods_image = $Goods_ImagesModel->getOneByWhere($row);
                        $data['items'][$key]['detail'] = $de[$val['goods_id']];
                        $data['items'][$key]['detail']['goods_images'] = $goods_image['images_image'];
                    } else {
