 ...
 * @todo
 */
class Ve_TxianFlowers extends Yf_Model
{
	public $_cacheKeyPrefix  = 'c|ylfenzhangflowers|';
	public $_cacheName       = 'ylfenzhangflowers';
	public $_tableName       = 'ylfenzhangflowers';
	 ...
	 * @access public
	 */
	public function getInfo($cart_id = null, $sort_key_row = null)
	{
		$rows = array();
	 ...
	 * @access public
	 */
	public function editInfo($cart_id = null, $field_row = array(), $flag = false)
	{
	 ...
	 * @access public
	 */
	public function editInfoSingleField($cart_id, $company)
	{
	 ...
	 * @access public
	 */
	public function removeInfo($cart_id)
	{
