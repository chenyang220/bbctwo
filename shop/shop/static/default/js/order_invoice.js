...
$(document).ready(function(){
    ...
    window.save_Invoice = function(e)
    {
        ...
        if(state_num == 2) //电子发票
        {
            ...
            invoice_area_code = index.find("#area_code").val();
        ...
        if(state_num == 3)	 //增值税发票
        {
            ...
            area_code2 = index.find("#area_code2").val();
            ...
            if (!cphone_reg.test(cphone) && area_code2==86)
            {
    ...
    window.check_Invoice =function(type, value) {
        ...
        if (type == "vat_companyName") {
            ...
            if (value == "") {
                ...
                var area_code1 = $('#vat_phone').data('area_code');
                if (!reg.test(value) && area_code1 == 86) {
                    errorFlag = true;
        ...
        // 验证手机号码
            ...
            if (true) {
                ...
                if (value == '') {
                    ...
                    var area_code2 = $("#"+generalTag+"consignee_mobile").data('area_code');
                    if (!mobile_reg.test(value) && area_code2==86) {
                        errorFlag = true;
                        errorMessage = "手机号码格式不正确";
                    }
                }
