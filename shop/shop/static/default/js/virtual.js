...
$(document).ready(function(){
	...
	$("#pay_btn").click(function(){
		...
		//1.获取手机号码
			buyer_phone = $("#re_user_mobile").val();
		...
		else
		{
			...
			if(flag)
			{
				...
				$.ajax({
					...
					data:{buyer_phone:buyer_phone,area_code:area_code,goods_id:goods_id,goods_num:goods_num,remarks:remarks,increase_arr:increase_arr,voucher_id:voucher_id,pay_way_id:1,rpt:rpt,from:'pc',is_discount:is_discount},
					dataType: "json",
