	...
	foreach($data['items'] as $key=>$val)
	{
		...
		foreach($directseller_member as $ks=>$vs)
		{
			...
			if($vs && $directseller_commission[$ks])
			{
				...
				$income_con['user_id'] = $vs;
				$income_con['settlement_order_id'] = $v['order_id'];
				$income_con['settlement_amount'] = $directseller_commission[$ks];
				$income_con['settlement_level'] = $ks+1;
				$income_con['order_amount'] = $val['order_payment_amount'];
				$income_con['income_type'] = 1;
