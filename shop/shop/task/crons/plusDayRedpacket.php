...
/**
 * plus会员超级会员日红包,系统下发会员权益红包
 *
 *///判断会员开关
$openFlag = Web_ConfigModel::value('plus_switch');
$red_packet_t_id = Web_ConfigModel::value('plus_day_redpacket_tpl_id');
...
foreach ($result as $item) {
	//下发红包
	$Plus_UserModel->publishRedpacket($item['user_id'],$red_packet_t_id,'plus_day');
}
return true;
?>
