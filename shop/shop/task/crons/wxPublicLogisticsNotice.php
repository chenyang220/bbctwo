...
//模板id
$tpl_id = "JXe4H4fB_VHTuPebo9vEimRkHSNVf06wdPbKj-Dnrg0";
//执行任务(推送物流通知)type:1下单；2：物流
$Model = new CommonModel();
$sql ="select * from yf_seller_wxpublic_tplmessage where status = 0 and type=2 limit 10";
