        ...
        <div class="ncc-receipt-info">
            ...
            <div id="invoice_list" class="ncc-candidate-items">
                <ul style="overflow: visible;">
                    <li><?=__('手机号码：')?>
                        <div class="parentCls">
                            <input name="buyer_phone" class="inputElem text" autocomplete="off" id="re_user_mobile" value="" maxlength="20" type="text" onblur="checkmobile()">
        ...
        <div class="cart_goods">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="goods_price goods_price_1 ">
                                ...
                                <p class="now_price"><?=($data['goods_base']['now_price'])?><?php if($data['is_plus']){ ?><b class="plus-logo align-middle"></b><?php } ?></p>
            ...
            <div class="goods_remark clearfix">
                ...
                <div class="order_total">
                    <?php if (!empty($data['mansong_info'])) { ?>
                        <?php if ($data['mansong_info']['rule_discount']) { ?>
                            <p class="clearfix">
                                <span><i class="iconfont icon-manjian fln mr4 f22 middle"></i><?= __('满') ?><?= ($data['mansong_info']['rule_price']) ?><?= __('立减') ?><?= ($data['mansong_info']['rule_discount']) ?></span>
                                <em></em>
                                <i class="fr msprice<?= ($key) ?>" msprice="<?= ($data['mansong_info']['rule_discount']) ?>">
                                    -<?= ($data['mansong_info']['rule_discount']) ?>
                                </i>
                            </p>
                        <?php } ?>
                        <?php if ($data['mansong_info']['gift_goods_id']) { ?>
                            <p class="clearfix">
                                <span><em class="c-333 top"><?= __('送') ?></em><em class="ml10 c-333 one-overflow iblock present-limit"><?= ($data['mansong_info']['goods_name']) ?></em></span>
                                <a class="fr" href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&gid=<?= ($data['mansong_info']['gift_goods_id']) ?>"><img title="<?= ($data['mansong_info']['goods_name']) ?>" alt="<?= ($data['mansong_info']['goods_name']) ?>" src="<?= image_thumb($data['mansong_info']['goods_image'], 40, 40) ?>"></a>
                            </p>
                        <?php } ?>
                    <?php } ?>
                </div>
