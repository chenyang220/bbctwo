...
<input type="hidden" id="hasBook" value="false"> <input type="hidden" id="hasCommon" value="true"> <input type="hidden" id="invokeInvoiceBasicService" value="true">
    ...
    <div id="noraml" class="tab-con form" style="display:none">
            ...
            <div class="fl">
              ...
              <b></b></span></div>
                  ...
                  <input type="hidden" value="4">
                      ...
                      <input type="text" style="cursor:pointer" class="itxt" title_type="2" value="<?php echo isset($data['normal'][0]['invoice_title']) ? $data['normal'][0]['invoice_title']:''; ?>" placeholder="<?= __('新增企业发票抬头'); ?>">
        ...
        <div class="tab-box js-company-tax-num" style="display: none">
            <div class="tab-con" style="display: block;">
                <div class="item">
                    <span class="label"><?= __('企业税号：'); ?></span> <input type="text" class="js-i-company-tax-num itxt" placeholder="<?= __('请输入企业税号'); ?>" value="<?php echo isset($data['normal'][0]['invoice_code']) ? $data['normal'][0]['invoice_code']:''; ?>" style="margin-top: 5px; width: 334px;height:32px;">
                </div>
            </div>
        </div>
            ...
            <div class="tab-con" id="fapiao" style="display:none">
                <div class="form">
                    ...
                    <div id="giftInvoicePart" class="hide">
                        ...
                        <input type="radio" style="display:none" id="invoiceSendType_0" value="0" name="invoiceSendType" checked="checked"> <input type="radio" style="display:none" id="invoiceSendType_3" value="3" name="invoiceSendType">
                        <div id="sendSeparateView" style="display:none">
                            <div class="item" id="generalInvoice_name_div"><span class="label"><em><?= __('*') ?></em><?= __('收票人姓名：') ?></span>
                                <div class="fl">
                                    <input type="text" class="itxt itxt04" id="generalInvoice_consignee_name" name="invoiceParam.consigneeName" value="" maxlength="20" onblur="check_InvoiceConsignee('generalInvoice_name_div',true)"> <span class="message" id="generalInvoice_name_div_error"></span></div>
                            </div>
                            <div class="item" id="generalInvoice_call_div"><span class="label"><em><?= __('*') ?></em><?= __('收票人手机：') ?></span>
                                <div class="fl">
                                    <input type="text" class="itxt itxt04" id="generalInvoice_consignee_mobile" name="invoiceParam.consigneePhone" value="" onblur="check_InvoiceConsignee('generalInvoice_call_phone_div',true)" maxlength="20" onfocus="if(value == defaultValue){value='';}"> <span class="message" id="generalInvoice_call_div_error"></span></div>
                            </div>
                            <div class="item" id="generalInvoice_area_div"><span class="label"><em><?= __('*') ?></em><?= __('收票人省份：') ?></span>
                                <div class="fl" id="generalInvoice_span_area" style="margin-top: 5px;"></div>
        ...
        <form id="eform">
            ...
            <div class="form">
                <div class="item"><span class="label"><?= __('发票抬头：') ?></span>
                  ...
                  <input type="text" class="itxt itxt04" title_type="2" placeholder="<?= __('请填写公司发票抬头') ?>" value="<?php if (isset($data['electron'])) {
                      echo $data['electron'][0]['invoice_title'];
                  } ?>">
                  <b></b></span></div>
                            </div>
                        </div>
                ...
                <div class="tab-box js-company-tax-num" style="display: none">
                    <div class="tab-con" style="display: block;">
                        <div class="item">
                            <span class="label"><?= __('企业税号：'); ?></span> <input type="text" class="js-i-company-tax-num itxt" placeholder="<?= __('请输入企业税号'); ?>" value="<?php if (isset($data['electron'])) {
                                echo $data['electron'][0]['invoice_code'];
                            } ?>" style="margin-top: 5px; width: 334px;height:32px;">
                        </div>
                    </div>
                </div>
                ...
                <div class="item"><span class="label"><em><?= __('*') ?></em><?= __('收票人手机：') ?></span>
                    <div class="fl">
                        <input type="text" class="itxt itxt03" id="re_user_mobile" name="invoice_rec_phone" onblur="check_electroInvoicePhone()" maxlength="20" onfocus="if(value == defaultValue){value='';}" value="<?php if (isset($data['electron'])) {
                            echo $data['electron'][0]['invoice_rec_phone'];
                        } ?>"> <input type="hidden" name="invoice_area_code" id="area_code" value="<?php if (isset($data['electron'])) {
                            echo $data['electron'][0]['invoice_area_code'];
                        } ?>"> <span class="message" id="e_consignee_mobile_error"></span>
                    </div>
                </div>
                <div class="item"><span class="label"><?= __('收票人邮箱：') ?></span>
                    <div class="fl">
                        <input type="text" class="itxt itxt03" id="e_consignee_email" name="invoice_rec_email" value="<?php if (isset($data['electron'])) {
                            echo $data['electron'][0]['invoice_rec_email'];
                        } ?>" onblur="check_electroInvoiceEmail(this)" onfocus="if(value == defaultValue){value='';}"> <span class="message" id="e_consignee_email_error"></span>
                    </div>
                </div>
                <div class="item"><span class="label">&nbsp;</span>
                    <div class="fl">
                ...
                <div class="steps">
                    <div class="step step1">
                        ...
                        <div class="item"><span class="label" id="vat_companyName_div"><em><?= __('*') ?></em><?= __('单位名称：') ?></span>
                            <div class="fl">
                                <input type="text" class="itxt itxt05 vat-step-1" name="invoice_company" id="vat_companyName" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_company'];
                                } ?>" onblur="check_Invoice('vat_companyName', this.value)"> <span class="message" id="vat_companyName_error"></span></div>
                        </div>
                        <div class="item" id="vat_code_div"><span class="label"><em><?= __('*') ?></em><?= __('纳税人识别码：') ?></span>
                            <div class="fl">
                                <input type="text" class="itxt itxt05 vat-step-1" name="invoice_code" id="vat_code" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_code'];
                                } ?>" onblur="check_Invoice('vat_code', this.value)"> <span class="message" id="vat_code_error"></span></div>
                        </div>
                        <div class="item" id="vat_address_div"><span class="label"><em><?= __('*') ?></em><?= __('注册地址：') ?></span>
                            <div class="fl">
                                <input type="text" class="itxt itxt05 vat-step-1" name="invoice_reg_addr" id="vat_address" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_reg_addr'];
                                } ?>" onblur="check_Invoice('vat_address', this.value)"> <span class="message" id="vat_address_error"></span></div>
                        </div>
                        <div class="item" id="vat_phone_div"><span class="label"><em><?= __('*') ?></em><?= __('注册电话：') ?></span>
                            <div class="fl">
                                <input type="text" maxlength="11" class="itxt itxt05 vat-step-1" name="invoice_reg_phone" id="vat_phone" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_reg_phone'];
                                } ?>" onblur="check_Invoice('vat_phone', this.value)"> <span class="message" id="vat_phone_error"></span></div>
                        </div>
                        <div class="item" id="vat_bankName_div"><span class="label"><em><?= __('*') ?></em><?= __('开户银行：') ?></span>
                            <div class="fl">
                                <input type="text" class="itxt itxt05 vat-step-1" name="invoice_reg_bname" id="vat_bankName" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_reg_bname'];
                                } ?>" onblur="check_Invoice('vat_bankName', this.value)"> <span class=" message" id="vat_bankName_error"></span></div>
                        </div>
                        <div class="item" id="vat_bankAccount_div"><span class="label"><em><?= __('*') ?></em><?= __('银行账户：') ?></span>
                            <div class="fl">
                                <input type="text" class="itxt itxt05 vat-step-1" name="invoice_reg_baccount" id="vat_bankAccount" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_reg_baccount'];
                                } ?>" onblur="check_Invoice('vat_bankAccount', this.value)"> <span class="message" id="vat_bankAccount_error"></span></div>
                        </div>
                        <div class="item"><span class="label">&nbsp;</span>
                            <div class="fl">
                                <div class="op-btns">
                                    <input id="vat-btn-save" type="button" class="btn-9" onclick="nextAvt()" value="<?= __('下一步') ?>"> <input id="vat-btn-cancel" type="button" class="btn-9" onclick="quxiao()" value="<?= __('取消') ?>">
                                </div>
                                <div class="ftx-03 mt10"> <?= __('温馨提示：发票的开票金额不包括代金券、积分支付部分') ?><br>
                    ...
                    <div class="step step2 hide">
                        ...
                        <div class="item" id="name_div"><span class="label"><em><?= __('*') ?></em><?= __('收票人姓名：') ?></span>
                            <div class="fl">
                                <input type="text" class="itxt itxt05 vat-step-2" id="consignee_name" name="invoiceParam.consigneeName" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_rec_name'];
                                } ?>" maxlength="20" onblur="check_InvoiceConsignee('name_div')"> <span class="message" id="name_div_error"></span></div>
                        </div>
                        <div class="item" id="call_div"><span class="label"><em><?= __('*') ?></em><?= __('收票人手机：') ?></span>
                            <div class="fl">
                                <input type="text" class="itxt itxt05 vat-step-2" id="consignee_mobile" name="invoiceParam.consigneePhone" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_rec_phone'];
                                } ?>" onblur="check_InvoiceConsignee('call_phone_div')" maxlength="11" onfocus="if(value == defaultValue){value='';}"> <input type="hidden" name="invoiceParam.invoice_area_code" id="area_code2" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_area_code'];
                        ...
                        <div class="item vat-step-2" id="area_div"><span class="label"><em><?= __('*') ?></em><?= __('收票人省份：') ?></span>
                            <div class="fl" id="span_area" style="margin-top: 5px;">
                                ...
                                <input type="hidden" name="address_area" id="t" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_rec_province'];
                                } ?>"/> <input type="hidden" name="province_id" id="id_1" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_province_id'];
                                } ?>"/> <input type="hidden" name="city_id" id="id_2" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_city_id'];
                                } ?>"/> <input type="hidden" name="area_id" id="id_3" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_area_id'];
                                } ?>"/>
                                ...
                                <div id="d_2" class="<?php if (@$data['addtax'][0]['invoice_rec_province']) {
                                    echo 'hidden';
                                } ?>">
                                    <select id="select_1" name="select_1" onChange="district(this);">
                                        ...
                                        <?php } ?>
                                    </select> <select id="select_2" name="select_2" onChange="district(this);" class="hidden">
                                        <option value=""><?= __('--请选择--') ?></option>
                                    </select> <select id="select_3" name="select_3" onChange="district(this);" class="hidden">
                                        <option value=""><?= __('--请选择--') ?></option>
                                    </select>
                                </div>
                        ...
                        <div class="item" id="address_div"><span class="label"><em><?= ('*') ?></em><?= __('详细地址：') ?></span>
                            <div class="fl">
                                <input type="text" class="itxt itxt05" id="consignee_address" name="invoiceParam.consigneeAddress" value="<?php if (isset($data['addtax'])) {
                                    echo $data['addtax'][0]['invoice_goto_addr'];
                                } ?>" maxlength="50" onblur="check_InvoiceConsignee('address_div')">
                            </div>
