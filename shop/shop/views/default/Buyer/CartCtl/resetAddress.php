	...
	<div class="reset-address" >
		...
		<div class="res-cont">
			...
			<div class="resAdd-inp">
                ...
                <input type="text"  name="user_address_phone" id="re_user_mobile" value="<?php if(isset($data) && !empty($data)){echo $data['user_address_phone'];}?>" >
                <input type="hidden"  name="area_code" id="area_code" value="<?php if(isset($data) && !empty($data)){echo $data['area_code'];}?>">
            </div>
			<div class="resAdd-inp">
