                  ...
                  <div class="favorite-goods-thumb">
                    <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=$val['detail']['goods_id']?>" target="_blank" title="<?=$val['detail']['goods_name']?>">
                      <div class="jqthumb posr" style="width: 150px; height: 150px; opacity: 1;">
                        ...
                        <?php } ?>
                        <div style="width: 100%; height: 100%; background-image: url(<?=$val['detail']['goods_images']?>); background-size: cover; background-position: 50% 50%; background-repeat: no-repeat;"></div>
                      </div>
                      <img src="<?=image_thumb($val['detail']['goods_images'],150,150)?>" style="display: none;"></a>
                  </div>
                  <div class="handle">
