          ...
          <div class="my_orders">
            ...
            <table >
			  ...
			  <?php if(!empty($val['goods_list'])){?>
                <tr>
                  <td class="my_orders_goods"><a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=$val['goods_list'][0]['goods_id']?>" target="_blank"><em class="img-box"><img class="cter" src="<?php if($val['goods_list'][0]['goods_image']){?><?=image_thumb($val['goods_list'][0]['goods_image'],50,50)?><?php }else{?><?=image_thumb($this->web['goods_image'],50,50)?><?php }?>"/></em></a></td>
            ...
            <div class="shop_cart_list_div" >
              <ul class="shop_cart_list_ul clearfix">
                ...
                <li>
                  <div class="clearfix">
				            <em class="img-box">
                      <img class="cter" src="<?php if(!empty($v['goods_base']['goods_image'])){?><?=image_thumb($v['goods_base']['goods_image'],50,50)?><?php }else{?><?= image_thumb($this->web['goods_image'],50,50)?><?php }?>"/>
                    </em>
                    <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=$v['goods_id']?>" target="_blank"><em class="iblock two-overflow"><?=$v['goods_base']['goods_name']?></em></a>
                  </div>
				...
				<?php if(!empty($val['detail'])){?>
                  <li>
                    <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=$val['detail']['goods_id']?>" target="_blank">
                      <em class="img-box"><img src="<?php if(!empty($val['detail']['goods_image'])){?><?=image_thumb($val['detail']['goods_image'],118,118)?><?php }else{?><?= image_thumb($this->web['goods_image'],118,118)?><?php }?>"/></em>
                ...
                <div class="my_track_div">
                  <ul class="goodsU buyer_goods_savelist buyer_goods_savelistw clearfix">
                    ...
                    <li>
                      <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?=$val['detail']['goods_id']?>" target="_blank">
                        <em class="img-box">
                          <img class="cter" src="<?php if(!empty($val['detail']['common_image'])){?><?=image_thumb($val['detail']['common_image'],50,50)?><?php }else{?><?= image_thumb($this->web['goods_image'],50,50)?><?php }?>"/>
                        </em>
