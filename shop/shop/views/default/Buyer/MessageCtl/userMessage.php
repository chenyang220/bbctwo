...
<div class="member_infor_content">
      ...
      <table class="ncm-default-table annoc_con" style="table-layout: fixed;">
          <thead>
            <tr>
             
              <th class="w100"><?php if($op=='receive'){?><?=__('发信人')?><?php }else{?><?=__('收件人')?><?php }?></th>
              <th class="opti w300"><?=__('内容')?></th>
		  ...
		  <tbody>
		   ...
		   <?php
            ...
            <tr class="bd-line">
              ...
              <td class="w300 one-overflow opti <?php if($op=='receive'){?> btn-bluejeans<?php }?> <?php if($value['message_islook']==0){;?>dark<?php }?>" data-id="<?= $value['user_message_id'] ?>"><?= $value['user_message_content'] ?></td>
