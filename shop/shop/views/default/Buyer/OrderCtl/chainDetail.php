        ...
        <div class="order_content">
          ...
          <?php if($data['order_status'] != Order_StateModel::ORDER_CANCEL):?>
            ...
            <dl class="long <?php if($data['order_status'] == Order_StateModel::ORDER_FINISH && $data['order_buyer_evaluation_status']):?>current<?php endif;?>">
              <dt><?=__('评价')?></dt>
              <dd class="bg"> </dd>
              <dd class="date" title="订单完成"><?=($data['order_buyer_evaluation_time'])?></dd>
            </dl>
            <?php endif;?>
          </div>
                            ...
                            <tr class="tr_con">
                                <td class="order_goods">
                                    ...
                                    <?php if ($ogval['spec_text']) { ?>
                                        <dd class="table-dd-set tl"><strong class="top">规格：</strong>&nbsp;&nbsp;<em class="one-overflow iblock order-props"><?= $ogval['spec_text'] ?></em></dd>
                                    <?php } ?>
          ...
          <?php endif; ?>
                ...
                <!--E  未付款订单 -->
                    ...
                    <?php if($data['order_status'] == Order_StateModel::ORDER_FINISH && $data['order_return_num'] <= 0 && $data['order_buyer_hidden'] != Order_BaseModel::IS_BUYER_HIDDEN): ?>
