    ...
    <div class="order_content">
        <div class="logistics_mes clearfix">
            <div class="logistics_mes_left">
                <img src="<?= $data['shop_base']['shop_logo']? $data['shop_base']['shop_logo']:$this->web['shop_logo']; ?>" />
                    ...
                    <div class="evaluation-timeline view_mes clearfix">
                        ...
                        <dl class="detail detail_dls">
                            ...
                            <div class="pingfen clearfix">
                                ...
                                <span class="align-middle"><?= __('评分') ?></span>
                                <p>
                        ...
                        success: function (a) {
                            ...
                            if (a.status == 200) {
                                ...
                                if (a.msg != 'failure') {
                                    ...
                                    evaluation = [];  //因为evaltation_goods一直push,所以返回结果之后要清空 
                                } else {
