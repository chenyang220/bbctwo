            ...
            <div class="evaluation-timeline logistics_mes clearfix" style="margin-bottom: 50px;">
                ...
                <div class="view_mes clearfix">
                    <div class="goods-thumb">
                        ...
                        <!-- 用户名称 -->
                        <p class="one-overflow"><?= ($data['user_info']['user_name']) ?></p>
                    </div>
                    <dl class="detail detail_dls">
                        <dt class="clearfix">
                            <span><?= __('评论时间：') ?><?= ($data['create_time']) ?></span>
                            <span class="ml30">&nbsp;&nbsp;&nbsp;<em class="iblock align-middle"><?= __('商品评分：') ?></em>
                                <em title="<?= __('很满意') ?>" class="raty iblock align-middle" data-score="5">
                                    <?php for ($i = 1; $i <= $data['scores']; $i++): ?>
                                        <i class="iconfont icon-xingxing fz18"></i>
                                    <?php endfor; ?>
                    ...
                    <div class="view_mes clearfix">
                        ...
                        <div class="detail detail_dls">
                            ...
                            <div class="clearfix show_goods_mar">
                                ...
                                <a id="filePicker" class="js-file-picker add_img add_box"><i class="iconfont icon-jia"></i><?= __('晒单') ?></a>
                            </div>
                        </div>
                        <!-- E 追加评论内容 -->
