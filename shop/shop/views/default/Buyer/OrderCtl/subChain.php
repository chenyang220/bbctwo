      ...
      <div class="order_content">
          ...
          <form method="get" id="search_form" action="index.php" >
            ...
            <p class="order_types">
				...
				<a <?php if($status == 'wait_pay'):?>class="currect"<?php endif;?> href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=subChain&status=wait_pay"><?=__('待付款')?></a>
				<a <?php if($status == 'order_chain'):?>class="currect"<?php endif;?> href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=subChain&status=order_chain"><?=__('待自提')?></a>
				<a <?php if($status == 'finish'):?>class="currect"<?php endif;?> href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=subChain&status=finish"><?=__('已完成')?></a>
			</p>
            ...
            <p class="order_types serc_p">
                <a <?php if($recycle):?>class="currect"<?php endif;?> href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=subChain&recycle=1"><i class="iconfont icon-lajitong icon_size20"></i><?=__('订单回收站')?></a>
            </p>
              ...
              <!-- 下单时间，订单号，店铺名称    -->
				...
				<td class="td_rborder">
                   ...
                   <p>
                      ...
                      <a href="<?= Yf_Registry::get('url') ?>?ctl=Buyer_Order&met=subChain&act=details&order_id=<?=($val['order_id'])?>"><?=__('订单详情')?>
                      </a>
                      <?php }?>
                   </p>
