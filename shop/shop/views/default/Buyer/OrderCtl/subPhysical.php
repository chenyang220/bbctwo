      ...
      <div class="order_content">
          ...
          <form method="get" id="search_form" action="index.php" >
            ...
            <p class="ser_p" style="margin-left: 10px;">
                <input  class="w100" type="text" name="orderkey" placeholder="<?=__('订单号')?>" value="<?=@$_GET['orderkey']?>">
                <input class="w100 ml10"  type="text" name="buyername" placeholder="<?=__('采购子账号')?>" value="<?=@$_GET['buyername']?>">
                <a class="btn_search_goods" href="javascript:void(0);"><i class="iconfont icon-icosearch icon_size18"></i><?=__('搜索')?></a>
            </p>
