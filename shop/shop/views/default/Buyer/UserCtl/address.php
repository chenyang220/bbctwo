    ...
    <div class="form-style-layout">
        ...
        <div class="form-style">
            <form id="form" name="form" action="" method="post">
                ...
                <dl>
                    <dt><em>*</em><?=__('联系电话：')?></dt>
                    <dd><input type="text" name="user_address_phone" id="re_user_mobile" class="text" value="">
                        <input type="hidden"  name="area_code" id="area_code" value=""></dd>
                </dl>
                <dl>
                    <dt></dt>
                    <dd><input type="checkbox" name="user_address_default" id="user_address_default" value="1" <?php if(!empty($data)){?> <?php if($data['user_address_default'] == '1'){?>checked <?php }?><?php }?>>&nbsp;<?=__('设置为默认收货地址')?></dd>
                </dl>
                <dl class="foot">
                    <dt>&nbsp;</dt>
        ...
        <script type="text/javascript">
            ...
            if(data !="")
            {
                ...
                $("#re_user_mobile").val(data.user_address_phone);
                ...
                $('#form').validator({
                    ...
                    rules: {
                        tel:function(){
                            ...
                            var user_address_phone = $('#re_user_mobile').val();
                            user_address_phone = user_address_phone.replace(/\s+/g,"");
                            var reg = /^1[3-9]\d{9}$/;
                            if(area_code==86 && !reg.test(user_address_phone)){
                    ...
                    fields: {
                        ...
                        'user_address_phone':'required;tel',
                    },
                    valid:function(form){
                        //表单验证通过，提交表单
                        var me = this;
