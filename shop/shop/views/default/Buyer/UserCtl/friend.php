                      ...
                      <div class="list" nctype="slider_div">
                        <ul class="F-center">
							<?php foreach($val['user']['items'] as $k=>$v){?>
                                <li>
                                <span class="thumb size40 thumbsv">
                            			<i></i>
                            			<a href="javascript:void(0);">
                            				<img title="<?= $v['detail']['user_name'] ?>" src="<?php if (!empty($v['detail']['user_logo'])) { ?><?= image_thumb($v['detail']['user_logo'], 40, 40) ?><?php } else { ?><?= image_thumb($userAvatar, 40, 40) ?><?php } ?>" width="40" height="40">
                            			</a>
                            		</span>
                                </li>
                            <?php }?>
