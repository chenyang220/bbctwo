        ...
        <table class="icos">
			...
			<tbody class="" id="<?= $value['sub_user_id'] ?>">
                ...
                ?>
                    ...
                    <tr class="tr_con" style="text-align:center;" id="<?= $value['sub_id']?>">
                        <td class="td_color"><?= $value['sub_id'] ?></td>
                        <td class="td_color"><?= $value['user_name'] ?></td>
                        <td class="td_color"><?= $value['active_state'] ?></td>
                        <td>
                            <span class="edit" onclick="addSubUser(<?= $value['sub_user_id']?>)"><i class="iconfont icon-chakan"></i><a  ><?=__('编辑')?></a></span>
                            <span class="unbund del_line" onclick="delSubUser(<?= $value['sub_id']?>)">
                            	<i class="iconfont icon-unbundling fz16"></i><a><?=__('解绑')?></a>
                            </span>
                        </td>
