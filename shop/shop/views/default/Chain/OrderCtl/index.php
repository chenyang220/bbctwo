    ...
    <div class="search mt0">
        <form id="search_form" class="search_form_reset" method="get" action="#">
            <div class="filter-groups">
                <dl>
                    <dt><?=__('订单状态：')?></dt>
                    <dd><select  name="search_state_type" class="wp100">
                ...
                <dl>
                    <dt><?=__('订单号：')?></dt>
                    <dd>
                        <select name="search_key_type" class="wp100">
                ...
                <dl>
                    <dt><?=__('关键词：')?></dt>
                    <dd><input type="text" class="text wp100 z-box2" name="keyword" id="search" value=""></dd>
                </dl>
            </div>
