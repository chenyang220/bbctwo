	...
	<div class="aright">
		...
		<div class="div_head tabmenu clearfix">
			<ul class="tab clearfix">
				...
				<li class="active"><a href="<?= Yf_Registry::get('url') ?>?ctl=Distribution_NewBuyer_Distribution&met=distributionCommission"><?=__('佣金记录')?></a></li>
			</ul>
		</div>
        <div class="order_content">
			<div class="order_content_title clearfix">
				<form method="get" id="search_form" action="index.php" >
					...
					<p class="order_types">
						<a <?php if($status == ''):?>class="currect"<?php endif;?> href="<?= Yf_Registry::get('url') ?>?ctl=Distribution_NewBuyer_Distribution&met=distributionCommission"><?=__('一级佣金')?></a>
						<a <?php if($status == 'second'):?>class="currect"<?php endif;?> href="<?= Yf_Registry::get('url') ?>?ctl=Distribution_NewBuyer_Distribution&met=distributionCommission&status=second"><?=__('二级佣金')?></a>
					</p>
