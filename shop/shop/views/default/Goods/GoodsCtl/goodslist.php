...
$css_url = "";
$css_url .= $base_uri.'/shop/static/default/css/goods-list.css,';
                ...
                <?php foreach ($hot_sale as $hkey => $hval): ?>
                    <li>
                        <a target="_blank" href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= ($hval['goods_id']) ?>" class="goods_list_href">
                            <div class="goodslist_img2"><img class='lazy' data-original="<?= cdn_image_url($hval['common_image'], 100, 100) ?>"/></div>
                        </a>
                        <p>
            ...
            <div class="cl_brand_name">
                <ul class="clearfix">
                    <?php foreach ($brand_property['brand_list'] as $key => $brand_data) { ?>
                        <li class="clearfix">
                            <a href="<?= url("Goods_Goods/goodslist", ["cat_id" => $cat_id, "brand_id" => $brand_data['brand_id']]) ?>&<?= $brand_property['search_string'] ?>">
                                <?php if ($brand_data['brand_show_type'] != 1) { ?>
                                    <img class='lazy' data-original="<?= $brand_data['brand_pic'] ?>" alt="<?= $brand_data['brand_name'] ?>">
                                <?php } else { ?>
                                    <b><?= $brand_data['brand_name'] ?></b>
                                <?php } ?>
                            </a>
                        </li>
                    <?php } ?>
                    ...
                    <?php foreach ($recommend_row as $rekey => $reval): ?>
                        <li>
                            ...
                            <a target="_blank" href="<?= url("Goods_Goods/goods", ["type" => "goods", "gid" => $reval['goods_id']]) ?>" class="cr_xie_lia1">
                                <div class="goodslist_img3"><img class='lazy' data-original="<?= cdn_image_url($reval['common_image'], 160, 160) ?>"/></div>
        ...
        <div class="cr_head">
            ...
            <div class="crhead2 clearfix">
                ...
                <div id="ncs-freight-selector" class="ncs-freight-select">
                    ...
                    <a href="javascript:" class="close js-address-close"><?= __('关闭') ?></a>
                </div>
                ...
                <li>
                    ...
                    <a target="_blank" href="<?= url("Goods_Goods/goods", ["type" => "goods"] + $urlArr) ?>" class="cr_xie_lia1">
                        <div class="goodslist_img1">
                            <img class='lazy' data-original="<?= cdn_image_url($val['common_image'], 220, 220) ?>" scr="<?= cdn_image_url($val['common_image'], 220, 220) ?>"/>
                        </div>
                        <span class="cr_xie_mon bbc_color"><?= format_money($val['g_price'] ? $val['g_price'] : $val['common_price']) ?></span> <span class="cr_xie_amon"></span>
                        <!-- 3.6.7-plus会员价 -->
                        <?php if($val['plus_status']){?><div class="plus-price"><em><?= format_money($val['plus_price'])?></em><b></b></div><?php }?>
