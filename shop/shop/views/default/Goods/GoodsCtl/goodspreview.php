            ...
            <div class="t_goods_ev clearfix">
                ...
                <div class="ev_center">
                    ...
                    <div class="goods_style_sel ">
                        ...
                        <?php } else { ?>
                            <div class="good_status lower-frame"><?= __('预览') ?></div>
                        <?php } ?>
    ...
    <div class="t_goods_bot clearfix ">
                        ...
                        foreach ($data_salle as $key_salle => $value_salle) {
                            ...
                            <li class="clearfix">
                                <a target="_blank" href="javascript:;"
                                   class="selling_goods_img"><img class='lazy w180'
        ...
        <div class="t_goods_bot_right ">
            ...
            <ul class="goods_det_about_cont">
                ...
                <!-- 详细-->
                <li class="xq_1 clearfix" style="display:block;text-align: left;padding: 0 20px;position: relative;">
...
<div class="footer">
    <div class="wrapper">
        ...
        <ul class="services clearfix">
            ...
            ?>
            <li>
                <h5><i class="iconfont icon-weibu<?= $i ?>"></i><span><?= __($value['group_name']); ?></span></h5>
                <?php
            ...
            success: function (data) {
                ...
                if (data.data.common_property_row) {
                    for (var i in data.data.common_property_row) {
                        html += '<span style="margin-right:5%; width:auto;float:left">' + i + '：' + data.data.common_property_row[i] + '</span>';
                    }
                }
