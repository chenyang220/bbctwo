...
?>
    ...
    <link rel="stylesheet" type="text/css" href="<?=$base_uri?>/shop/static/default/css/tips.css" rel="stylesheet">
    ...
    <div class="wrap">
                ...
                <p>
                    ...
                    if ($data['cat']['physical']) {
                        foreach ($data['cat']['physical'] as $key => $phy_cat) {
                            ?>
                            <a href="<?= Yf_Registry::get('url') ?>?ctl=GroupBuy&met=groupBuyList&cat_id=<?= $phy_cat['groupbuy_cat_id'] ?>"><?= __($phy_cat['groupbuy_cat_name']); ?></a>
                            <?php
                        }
                    }
                    ?>
                ...
                <p>
                    ...
                    if ($data['cat']['virtual']) {
                        foreach ($data['cat']['virtual'] as $key => $vir_cat) {
                            ?>
                            <a href="<?= Yf_Registry::get('url') ?>?ctl=GroupBuy&met=vrGroupBuyList&cat_id=<?= $vir_cat['groupbuy_cat_id'] ?>"><?= __($vir_cat['groupbuy_cat_name']); ?></a>
                            <?php
                        }
                    }
                    ?>
            ...
            <div class="tg_center" id="slides">
                <div class="banner swiper-container">
                    <ul class="items swiper-wrapper">
                        <?php if (Web_ConfigModel::value('subsite_is_open') && isset($_COOKIE['sub_site_id']) && $_COOKIE['sub_site_id'] > 0) {
                            $groupbuy_subsite_id = '_' . $_COOKIE['sub_site_id'];
                        } else {
                            $groupbuy_subsite_id = '';
                        } ?>
        ...
        <div class="groups">
            <h3>
                <a href="<?= Yf_Registry::get('url') ?>?ctl=GroupBuy&met=groupBuyList"><?= __('线上团') ?></a><i><?= __('每天整点开抢') ?></i> <span class="more"> <a href="<?= Yf_Registry::get('url') ?>?ctl=GroupBuy&met=groupBuyList"><?= __('更多') ?><i class="iconfont icon-iconjiantouyou"></i></a></span>
            </h3>
            <?php
                    ...
                    <div class="gr_goods_imfor">
                        <div class="gr_goods_div">
                            ...
                            <div class="gr_good_price clearfix">
                                <span class="bbc_color"><?= format_money($data['goods']['physical']['highly_recommend']['groupbuy_price']) ?><em><?= format_money($data['goods']['physical']['highly_recommend']['goods_price']) ?></em></span> <a class="bbc_btns" href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $data['goods']['physical']['highly_recommend']['goods_id'] ?>"><?= __('立即购买') ?><i class="iconfont icon-iconjiantouyou"></i></a>
                            </div>
                            <?php if ($data['goods']['physical']['highly_recommend']['groupbuy_state'] == 2) { ?>
                                ...
                                </span> <em><strong class="bbc_color"><?= $data['goods']['physical']['highly_recommend']['groupbuy_virtual_quantity'] ?></strong> <?= __('人已付款') ?></em>
                                </div>
                            <?php } ?>
                        </div>
                        <p class="hotbg"></p>
                ...
                <ul class="gr_goods_list clearfix">
                    <?php foreach ($data['goods']['physical']['recommend']['items'] as $key => $value) { ?>
                        <li>
                            ...
                            <h5>
                                <a href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $value['goods_id'] ?>"><?= __($value['groupbuy_name']); ?></a>
                            </h5>
                            
                            <p class="gr_sold_hav clearfix"><span><?= __('已售') ?><i class="num-color ml4"><?= $value['groupbuy_buy_quantity'] ?></i></span> <em class="fnTimeCountDown" data-end="<?= $value['groupbuy_endtime'] ?>"> <span class="day">00</span><strong><?= __('天') ?></strong> <span class="hour">00</span><strong><?= __('小时') ?></strong> <span class="mini">00</span><strong><?= __('分') ?></strong> <span class="sec">00</span><strong><?= __('秒') ?></strong> </em>
                            </p>
                        </li>
                        <?php
                    }
        ...
        <div class="groups">
            <h3>
                <a href="<?= Yf_Registry::get('url') ?>?ctl=GroupBuy&met=vrGroupBuyList"><?= __('虚拟团') ?></a><i><?= __('每天整点开抢') ?></i> <span class="more"> <a href="<?= Yf_Registry::get('url') ?>?ctl=GroupBuy&met=vrGroupBuyList"><?= __('更多') ?><i class="iconfont icon-iconjiantouyou"></i></a></span>
            </h3>
            <?php
                ...
                <div class="gr_goods clearfix">
                    ...
                    <div class="gr_goods_imfor">
                        <div class="gr_goods_div">
                            ...
                            <div class="gr_good_price clearfix">
                                <span class="bbc_color"><?= format_money($data['goods']['virtual']['highly_recommend']['groupbuy_price']) ?><em><?= format_money($data['goods']['virtual']['highly_recommend']['goods_price']) ?></em></span> <a class="bbc_btns" href="<?= Yf_Registry::get('url') ?>?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $data['goods']['virtual']['highly_recommend']['goods_id'] ?>"><?= __('立即购买') ?><i class="iconfont icon-iconjiantouyou"></i></a>
                            </div>
                            <div class="gr_good_lastime clearfix fnTimeCountDown" data-end="<?= $data['goods']['virtual']['highly_recommend']['groupbuy_endtime'] ?>">
                                <span><i class="iconfont icon-shijian2"></i><?= __('还剩') ?>
                                    ...
                                    <span class="mini">00</span><strong><?= __('分') ?></strong>
                                    <span class="sec">00</span><strong><?= __('秒') ?></strong>
                                </span> <em><strong class="bbc_color"><?= $data['goods']['virtual']['highly_recommend']['groupbuy_virtual_quantity'] ?></strong> <?= __('人已付款') ?></em>
                            </div>
                        </div>
                        <p class="hotbg"></p>
                    </div>
            ...
            <ul class="gr_goods_list clearfix">
                <?php foreach ($data['goods']['virtual']['recommend']['items'] as $key => $value) {
                    ...
                    <li>
                        ...
                        <p class="gr_goods_ev clearfix">
                            <span>
                                <strong class="bbc_color"><?= $value['groupbuy_price'] ?></strong>
                            </span> <em class="bbc_color">
                                <?= __('立省') ?><?= $value['reduce'] ?>
                            </em>
                        </p>
                        <h5>
                        ...
                        <p class="gr_sold_hav clearfix">
                            <span><?= __('已售') ?><i class="num-color ml4"><?= $value['groupbuy_buy_quantity'] ?></i></span> <em class="fnTimeCountDown" data-end="<?= $value['groupbuy_endtime'] ?>"> <span class="day">00</span><strong><?= __('天') ?></strong> <span class="hour">00</span><strong><?= __('小时') ?></strong> <span class="mini">00</span><strong><?= __('分') ?></strong> <span class="sec">00</span><strong><?= __('秒') ?></strong> </em>
                        </p>
                    </li>
                    <?php
                }
