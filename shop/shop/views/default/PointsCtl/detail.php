		...
		<div class="bbc-gift-summary">
			...
			<div class="bbc-key">
				<dl style="display:none">
					<dt class='bbc_color'>每人限兑：</dt>
					<dd class='bbc_color'>3</dd>
				</dl>
				<dl>
					<dt><?=__('兑换数量')?>：</dt>
					<dd class="bbc-figure-input">
						<div class="goods_num need_num clearfix iblock">
							<a class="no_reduce" style="display:none">-</a>
							<input name="exnum" class="text w30" id="exnum" value="1" size="4" type="text" disabled>
