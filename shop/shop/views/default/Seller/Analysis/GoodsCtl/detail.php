                    ...
                    echo '<tr>
								...
								<td>
									<div class="padding10fl">
										...
										<div class="padding10fl">
											<h4 class="pro_title tl"><a href="'.$v["apb_url"].'">'.$v["goods_name"].'</a><p  class="one-overflow w280" align="left">'.__('规格').'：'.$v["spec"].'</p></h4>
								...
								<td>'.$v["nums"].'</td>
								<td>'.$v["amount"].'</td>
								<td><a href="javascript:;" onclick="getAjax('.$v['goods_id'].')">'.__('单品分析').'</a></td>
							</tr>';
                }
            }
            ?>
...
<script>
    function getAjax(a){
        ...
        var url = "?ctl=Seller_Analysis_Goods&met=" + analysis + "&shop_id=" + <?php echo $shop_id?> +"&product_id=" + product_id;
        var pars = {};
