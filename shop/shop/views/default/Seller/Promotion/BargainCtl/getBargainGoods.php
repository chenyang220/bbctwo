        ...
        ?>
            <li style="height:280px">
                ...
                <div class="goods-btn">
                    ...
                    <?php }else{?>
                    <a class="button button_green had" onclick="add_goods_tips()" data-id="<?=$goods['goods_id']?>" data-goods-id="<?=Yf_Registry::get('url')?>?ctl=Goods&met=detail&id=<?=$goods['goods_price']?>"  href="javascript:void(0);"><?=__('选择为砍价商品')?></a>
                        <i class="icon-had"></i>
                    <?php } ?>
                </div> 
            </li>
