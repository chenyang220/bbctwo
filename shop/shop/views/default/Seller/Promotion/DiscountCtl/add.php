...
<div class="form-style">
    <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_Discount&met=add&typ=e">
        ...
        <dl>
            <dt><i>*</i><?=__('开始时间')?>：</dt>
            <dd>
                <input type="text" readonly="readonly" autocomplete="off" style="width:130px" name="discount_start_time" id="start_time" class="text w120 hasDatepicker"/><em><i class="iconfont icon-rili"></i></em>
                <?php if(!$shop_type){ ?>
        ...
        <dl>
            <dt><i>*</i><?=__('结束时间')?>：</dt>
            <dd>
                <input type="text" readonly="readonly" autocomplete="off"style="width:130px"  name="discount_end_time" id="end_time" class="text w120"/><em><i class="iconfont icon-rili"></i></em>
                <?php if(!$shop_type){ ?>
