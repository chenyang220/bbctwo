...
<div class="form-style">
    <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_GroupBuy&met=addVr&typ=e">
        ...
        <dl>
            <dt><i>*</i><?=__('开始时间')?>：</dt>
            <dd>
                <input type="text" readonly="readonly" autocomplete="off" name="groupbuy_starttime" id="start_time" class="text w120" value="<?=$group_info['groupbuy_starttime']?>"/><em><i class="iconfont icon-rili"></i></em>
        ...
        <dl>
            <dt><i>*</i><?=__('结束时间')?>：</dt>
            <dd>
                <input type="text" readonly="readonly" autocomplete="off" name="groupbuy_endtime" id="end_time" class="text w120 hasDatepicker" value="<?=$group_info['groupbuy_endtime']?>"/><em><i class="iconfont icon-rili"></i></em>
        ...
        <dl>
            ...
            <dd>
                <div class="selected-goods fn-hide" <?php if(!$group_info['goods']){echo 'hidden';} ?>>
                    ...
                    <input type="hidden" name="voucher_goods_name">
        ...
        <dl class="goods_price" style="display:<?=$goods_price_status?>;">
            <dt><?=__('店铺价格')?>：</dt>
            <dd><span><?=$group_info['goods']['goods_price']?></span><input type="hidden" id="goods_price" name="goods_price" value="<?=$group_info['goods']['goods_price']?>"></dd>
        </dl>
        <dl>
            <dt><i>*</i><?=__('团购价格')?>：</dt>
            <dd>
...
$(document).ready(function(){
   ...
   /* 结束时间限制*/
    ...
    $('.search-goods-list-bd').on('click', '[data-type="btn_add_goods"]', function() {
        ...
        $("input[name='voucher_goods_name']").val(goods_name);
