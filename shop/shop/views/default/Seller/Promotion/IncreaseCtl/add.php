...
<div class="form-style">
    <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_Increase&met=add&typ=e">
        ...
        <dl>
            <dt><i>*</i><?=__('开始时间')?>：</dt>
            <dd>
                <input type="text" autocomplete="off" readonly="readonly" name="increase_start_time" id="start_time" class="text w120"/><em><i class="iconfont icon-rili"></i></em>
                <p class="hint">
                    <?=__('开始时间发布之后不能修改')?></br>
                    <?php if(!$shop_type){ ?>
        ...
        <dl>
            <dt><i>*</i><?=__('结束时间')?>：</dt>
            <dd>
                <input type="text" autocomplete="off" readonly="readonly" name="increase_end_time" id="end_time" class="text w120"/><em><i class="iconfont icon-rili"></i></em>
