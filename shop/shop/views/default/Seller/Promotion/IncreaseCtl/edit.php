                    ...
                    <div data-cou-level-item="<?=$key+1?>" class="inc-rule bbc-cou-rule mb10">
                        <div class="rule-note mb10">
                            ...
                            <span><?=__('购买同一加价购活动商品消费满')?>
                                ...
                                <?=__('件（0为不限）优惠商品，每样商品最多换购一件，默认数量为1，换购商品如下')?>：<a btn-choose-rule-ex-goods="<?=$key+1?>" href="javascript:;" class="button bbc_seller_btns"><i class="iconfont icon-jia"></i><?=__('添加换购商品')?></a>
                            </span>
                        </div>
