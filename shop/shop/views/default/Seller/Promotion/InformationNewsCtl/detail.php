...
<div class="form-style">
    <?php if($data['auditing'] == 1|| $data['auditing'] == 2){?>
        ...
        <span class="del" style="float: right">
            <a class=" button button_red bbc_seller_submit_btns btn-news-del"  id="delnews" data-id="<?= $data['id'] ?>"/><i class="iconfont icon-lajitong fz20 colf middle"></i><em class="colf fz12 middle lh20"><?= __('删除') ?></em></a>
        </span>
        </div>
    <?php }?>
