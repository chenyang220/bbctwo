    ...
    <div class="form-style">
        <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_MeetConditionGift&met=add&typ=e">
            ...
            <dl>
                <dt><i>*</i><?=__('开始时间')?>：</dt>
                <dd>
                    <input type="text" readonly="readonly" autocomplete="off" name="mansong_start_time" id="start_time" class="text w150"/><em><i class="iconfont icon-rili"></i></em>
            ...
            <dl>
                <dt><i>*</i><?=__('结束时间')?>：</dt>
                <dd>
                    <input type="text" readonly="readonly" autocomplete="off" name="mansong_end_time" id="end_time" class="text w150"/><em><i class="iconfont icon-rili"></i></em>
                ...
                <dd>
                    ...
                    <div id="add_rule_box" style="display:none;">
                        ...
                        <div class="ncsc-mansong-rule">
                            ...
                            <span><?=__('送礼品')?>&nbsp;<a href="javascript:void(0);" id="btn_show_search_goods" class="button button_orange bbc_seller_btns"><i class="iconfont icon-gift"></i><?=__('选择礼品')?></a></span>
    ...
    $(document).ready(function() {
        ...
        $('#btn_save_rule').on('click', function() {
            ...
            if(isNaN(mansong.price) || mansong.price <= 0) {
                ...
                Public.tips.error("规则金额不能为空且必须为数字");
                return false;
            } else {
                $('#mansong_price_error').hide();
            }
            ...
            if(isNaN(mansong.discount) || mansong.discount < 0 || mansong.discount >= mansong.price) {
                ...
                Public.tips.error("满减金额必须小于规则金额");
                return false;
            } else {
