...
<div class="form-style">
    <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_PinTuan&met=add&typ=e">
        ...
        <dl>
            <dt><i>*</i><?=__('开始时间')?>：</dt>
            <dd>
                <input type="text" autocomplete="off" readonly="readonly" name="start_time" id="start_time" class="text w120"/><em><i class="iconfont icon-rili"></i></em>
                <p class="hint">
                    <?=__('开始时间发布之后不能修改')?></br>
                    <?php if(!$shop_type){ ?>
    ...
    <!-- 平台关闭功能提示 -->
    <!-- <div class="notic_close">平台关闭了拼团活动</div> -->
</div>
