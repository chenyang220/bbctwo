...
<div class="content">
	<div class="form-style">
        <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_Presale&met=add&typ=e">
		
		<dl>
			<dt><i>*</i>预售名称：</dt>
			<dd><input name="presale_name" type="text" class="text w300"></dd>
		</dl>
		
		 <dl>
            <dt><i>*</i><?=__('预售定金开始时间')?>：</dt>
            <dd>
                <input type="text" readonly="readonly" autocomplete="off" name="presale_start_time" id="start_time" class="text w150 hasDatepicker"/><em><i class="iconfont icon-rili"></i></em>
        ...
        <dl>
            ...
            <dd>
                <input type="text" readonly="readonly" autocomplete="off" name="presale_end_time" id="end_time" class="text w150"/><em><i class="iconfont icon-rili"></i></em>起 72小时后结束
		...
		<dl>
            <dt><i>*</i><?=__('预售尾款时间')?>：</dt>
            <dd>
                <input type="text" readonly="readonly" autocomplete="off" name="presale_final_time" id="final_time" class="text w150"/><em><i class="iconfont icon-rili"></i></em>
        ...
        <dl>
			<dt><i>*</i>预售定金：</dt>
			<dd>
				<input name="presale_deposit" type="text" value="" class="text w150 ml4 mr4"><span>元</span>
		...
		<dl>
			<dt><i>*</i>购买上限：</dt>
			<dd>
				<input name="presale_lower_limit" type="text" value="0" class="text w150 ml4 mr4">
		</dl>
		<dl>
			<dt></dt>
	...
	$(document).ready(function(){
        ...
        $('#form').validator({
			...
			valid: function(form){
                ...
                $.ajax({
                    url: "index.php?ctl=Seller_Promotion_Presale&met=addPresale&typ=json",
                    data: $(form).serialize(),
                    type: "POST",
                    success:function(e){
                        if(e.status == 200)
                        {
                            ...
                            location.href="index.php?ctl=Seller_Promotion_Presale&met=index&op=manage&typ=e&id="+data.presale_id;//成功后跳转
                        }
                        else
                        {
