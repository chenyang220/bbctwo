...
<div id="dialog_add_presale_goods" style="display:none;">
    ...
    <div class="eject_con">
        <div id="dialog_add_presale_goods_error" class="alert alert-error">
        ...
        <dl>
            <dt><?=__('预售价格')?>：</dt>
            <dd>
                <input id="dialog_presale_price" type="number" class="text w70"><em class="rmb">￥</em>
