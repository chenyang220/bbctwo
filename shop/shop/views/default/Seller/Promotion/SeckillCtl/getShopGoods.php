...
<div id="dialog_add_seckill_goods" style="display:none;">
    ...
    <div class="eject_con">
        <div id="dialog_add_seckill_goods_error" class="alert alert-error">
        ...
        <dl>
            <dt><?=__('秒杀库存')?>：</dt>
            <dd>
                <input id="dialog_seckill_stock" type="text" class="text w70"><em class="rmb">￥</em>
                <p class="hint"><?=__('秒杀库存应低于正常商品库存')?>。</p>
            </dd>
        </dl>
        <dl>
            <dt><?=__('秒杀价格')?>：</dt>
            <dd>
                <input id="dialog_seckill_price" type="text" class="text w70"><em class="rmb">￥</em>
                <p class="hint"><?=__('秒杀价应低于正常商品售价，活动开始时，系统将自动转换销售价为促销价')?>。</p>
            </dd>
        </dl>
        <div class="eject_con">
            <div class="bottom">
