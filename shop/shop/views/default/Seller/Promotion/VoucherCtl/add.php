...
<div class="form-style">
    <form method="post" id="form" action="<?=Yf_Registry::get('url')?>?ctl=Seller_Promotion_Voucher&met=addVoucherTemp">
        ...
        <dl>
            <dt><i>*</i><?=__('有效期')?>：</dt>
            <dd>
                <input type="text" autocomplete="off" name="voucher_t_start_date" id="start_date" class="text w80"/><em><i class="iconfont icon-rili"></i></em> <?=__('至')?> <input type="text" autocomplete="off" name="voucher_t_end_date" id="end_date" class="text w80"/><em><i class="iconfont icon-rili"></i></em>
            </dd>
        </dl>
        <dl>
            <dt><?=__('面额')?>：</dt>
    ...
    $(document).ready(function(){
        ...
        $('#form').validator({
            ...
            fields: {
                ...
                'voucher_t_start_date': 'required;greaterThanStartDate["<?=date('Y-m-d H:i:s')?>"];',
