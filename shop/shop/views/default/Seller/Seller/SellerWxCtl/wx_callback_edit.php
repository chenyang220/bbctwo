...
<form method="post" enctype="multipart/form-data" id="publicmsg_add" name="form1">
    <input type="hidden" name="wxpublic_message_id" value="<?=$msg_list['wxpublic_message_id']?>">
    <div class="ncap-form-default">
        <dl class="row">
            ...
            <dd class="opt">
                <input  id="words" name="words"  class="w400 ui-input " type="text" value="<?=$msg_list['words']?>" />
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <select class="ui-input" id="match_type" name ="match_type" style="width: 130px;height:30px;">
                    <option value="1" <?=($msg_list['match_type']==1 ? 'selected' : '')?>>精准匹配</option>
                    <option value="2" <?=($msg_list['match_type']==2 ? 'selected' : '')?>>模糊匹配</option>
                </select>
                <p class="notic"></p>
            </dd>
        </dl>
        ...
        <dl class="row" id="content_dl">
            ...
            <dd class="opt">
                 <textarea id="content" name="content"  class="w400 ui-input " style="height: 120px;" type="text"><?=$msg_list['content']?></textarea>
                <p class="notic"></p>
            </dd>
        </dl>
