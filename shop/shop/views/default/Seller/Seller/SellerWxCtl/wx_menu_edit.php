...
<form method="post" enctype="multipart/form-data" id="publicmsg_add" name="form1">
	<input type="hidden" name="wxpublic_menu_id" value="<?=$menu_list['wxpublic_menu_id']?>"/>
    <div class="ncap-form-default">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input  id="menu_name" name="menu_name"  class="w400 ui-input " type="text" value="<?=$menu_list['menu_name']?>"/>
            </dd>
        </dl>
        <dl class="row">
            <dt class="tit">
            ...
            <dd class="opt">
                <select class="ui-input" id="menu_type" name ="menu_type" style="width: 130px;height:30px;"onchange="change_show(this.value);">
                    <option value="1" <?=($menu_list['menu_type']==1 ? 'selected' : '')?>>发送消息</option>
                    <option value="2" <?=($menu_list['menu_type']==2 ? 'selected' : '')?>>跳转网页</option>
                </select>
                <p class="notic"></p>
            </dd>
        </dl>
        <dl class="row" id="content_dl">
            ...
            <dd class="opt">
                <input  id="content" name="content"  class="w400 ui-input " type="text" value="<?=$menu_list['menu_msg']?>" />
                <p class="notic"></p>
            </dd>
        </dl>
        <dl class="row" id="redirect_url_dl">
            ...
            <dd class="opt">
                <input  id="redirect_url" name="redirect_url"  class="w400 ui-input " type="text" value="<?=$menu_list['menu_url']?>"/>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <input   id="sort_num" name="sort_num" class="w400 ui-input " type="text" value="<?=$menu_list['sort_num']?>" />
                <p class="notic"></p>
            </dd>
        </dl>
        <div class="bot">
...
<script>
	change_show(<?=$menu_list['menu_type']?>);
