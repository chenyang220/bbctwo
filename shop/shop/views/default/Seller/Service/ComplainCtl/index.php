        ...
        <form id="search_form" method="get">
            ...
            <div class="filter-groups">
                <dl>
                    <dt><?=__('投诉内容：')?></dt>
                    <dd>
                        <input type="text" name="keys" class="text wp100" placeholder="<?=__('请输入投诉内容')?>" value="<?=$data['keys']?>"/>
                    </dd>
                </dl>
                <dl>
                    <dt><?=__('状态：')?></dt>
                ...
                <dl>
                    ...
                    <dd style="width: 250px;">
                        <input placeholder="开始时间" type="text" autocomplete="off" name="start_date" id="start_date" class="text w85" value="<?=$data['start_date']?>"/><em class="add-on"><i class="iconfont icon-rili"></i></em>
                        <span class="rili_ge">–</span>
                        <input placeholder="结束时间" type="text" autocomplete="off" name="end_date" id="end_date" class="text w85" value="<?=$data['end_date']?>"/><em class="add-on"><i class="iconfont icon-rili"></i></em>
                    </dd>
                </dl>
            </div>
            <div class="control-group">
                <a class="button btn_search_goods"  href="javascript:void(0);"><?=__('筛选')?></a>
                <a class="button refresh" href="index.php?ctl=Seller_Service_Complain&met=index&typ=e"><?=__('重新刷新')?></a>
            </div>
        </form>
