        ...
        <form id="search_form" method="get">
            ...
            <div class="filter-groups">
                ...
                <dl>
                    <dt><?= __('处理状态：') ?></dt>
                    <dd>
                         <select name="status" class="wp100">
                ...
                <dl>
                    ...
                    <dd style="width: 250px;">
                        <input type="text" autocomplete="off" placeholder="开始时间" name="start_date" id="start_date" class="text w85" value="<?= $data['start_date'] ?>"/><em class="add-on"><i class="iconfont icon-rili"></i></em>
                       <span class="rili_ge">–</span>
                        <input type="text" autocomplete="off" placeholder="结束时间" name="end_date" id="end_date" class="text w85" value="<?= $data['end_date'] ?>"/><em class="add-on"><i class="iconfont icon-rili"></i></em>
                    </dd>
                </dl>
            </div>
            <div class="control-group">
                 <a class="button refresh" href="index.php?ctl=Seller_Service_Return&met=goodsReturn&typ=e"><?= __('重新刷新') ?></a>
