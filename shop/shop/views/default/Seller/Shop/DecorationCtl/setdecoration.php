...
<div>
    ...
    <div class="ncsc-decoration-layout">
        <div class="ncsc-decoration-menu" id="waypoints">
            ...
            <div class="faq fr"><?=__('下方区域为1200像素宽度即时编辑区域；“添加布局块”后选择模块类型进行详细设置；内容将实时保存，设置完成后直接选择“完成退出”。')?></div>
        </div>
            ...
            <script type="text/javascript">
                ...
                $(document).ready(function(){
                    ...
                    $("#waypoints").waypoint(function(event, direction) {
                        $("#store_decoration_content").toggleClass("seat");
                    ...
                    //dialog中uedior编辑头部滑动固定
                    $("#dialog_module_html .custom-box").scroll(function(){
                          if($(".module-seat").position().top<=0){
                              $(".module-seat").css("marginTop","-94px");
                              $("#edui1_toolbarbox").css({"position":"fixed","zIndex":"1000"});
                          }else{
                               $(".module-seat").css("marginTop","0");
