...
<form id="form_company_info" method="post">
    ...
    <div class="next"><a href="<?= Yf_Registry::get('base_url')?>/index.php?ctl=Seller_Shop_Settled&met=index&op=pstep2&rp=pstep2&apply=1" class="btn bbc_btns"><?=__('上一步')?></a>&nbsp;&nbsp;&nbsp;<a class="btn bbc_btns button" id="btn_apply_company_next" href="javascript:;"><?=__('下一步，填写入驻预经营信息')?></a></div>
