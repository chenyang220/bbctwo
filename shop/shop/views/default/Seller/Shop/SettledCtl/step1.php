        ...
        <div class="content">
            <dl show_id="99">
                ...
                <dd style="display: none;">
                    <ul>
                        <li><i></i> <a href="" target="_blank"><?= __('签署入驻协议') ?></a>
                        </li>
                        <li><i></i> <a href="" target="_blank"><?= __($apply_tips['1']) ?></a>
                        </li>
                        <li><i></i> <a href="" target="_blank"><?= __('平台审核资质') ?></a>
                        </li>
                        <li><i></i> <a href="" target="_blank"><?= __($apply_tips['2']) ?></a>
                        </li>
                        <li><i></i> <a href="" target="_blank"><?= __('店铺开通') ?></a>
                        </li>
                    </ul>
                </dd>
            </dl>
        ...
        <div class="joinin-concrete">
            ...
            <div id="apply_agreement" class="apply-agreement">
                ...
                <div class="apple-agreement">
                    <input id="input_apply_agreement" name="input_apply_agreement" checked="checked" type="checkbox"> <label for="input_apply_agreement"><?= __('我已阅读并同意以上协议') ?></label>
                </div>
                <div class="bottom">
