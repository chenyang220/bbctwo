                ...
                <form id="form_company_info"  method="post">
                    ...
                    <table class="all" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td><input name="contacts_phone" id="re_user_mobile" class="w150 bor1" type="tel" maxlength="11" value="<?php echo isset($shop_company['contacts_phone']) ? $shop_company['contacts_phone'] : '';?>">
                                <input name="area_code" id="area_code"  type="hidden"  value="<?php echo isset($shop_company['area_code']) ? $shop_company['area_code'] : '';?>">
                    ...
                    <table class="all" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <th><i>*</i><?= __('法人代表姓名') ?>：</th>
                            <td><input name="legal_person" class="w200" type="text" value="<?php echo isset($shop_company['legal_person']) ? $shop_company['legal_person'] : ''; ?>"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th><i>*</i><?= __('营业执照经营范围') ?>：</th>
                            <td>
                                <textarea name="business_sphere"><?php echo isset($shop_company['business_sphere']) ? $shop_company['business_sphere'] : ''; ?></textarea>
                            </td>
                        </tr>
                        <tr>
                            <th><i>*</i><?=__('营业执照电子版')?>：</th>
                            <td><input class="iblock align-top" id="business_logo" readonly="readonly"  name="business_license_electronic" type="text" class="mr10" value="<?php echo isset($shop_company['business_license_electronic']) ? $shop_company['business_license_electronic'] : '';?>">   <p class="iblock align-top" id="business_upload" ><?=__('上传图片')?></p>
                                <span class="block"><?=__('请确保图片清晰，文字可辨并有清晰的红色公章。建议图片大小：750x450')?></span>
                            </td>
                        </tr>
