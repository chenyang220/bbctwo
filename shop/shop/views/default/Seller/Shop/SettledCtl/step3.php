...
<form id="form_company_info" method="post">
    ...
    <fieldset>
        ...
        <dl>
            <dt><i>*</i><?=__('公司银行账号')?>：</dt>
            <dd><input class="text w250" name="bank_account_number" type="number"" value="<?php echo isset($shop_company['bank_account_number']) ? $shop_company['bank_account_number'] : '';?>"></dd>
        </dl>
        <dl>
    ...
    <div class="next"><a href="<?= Yf_Registry::get('base_url')?>/index.php?ctl=Seller_Shop_Settled&met=index&op=step2&rp=step2&apply=2" class="btn bbc_btns"><?=__('上一步')?></a>&nbsp;&nbsp;&nbsp;<a class="btn bbc_btns button" id="btn_apply_company_next" href="javascript:;"><?=__('下一步，填写入驻预经营信息')?></a></div>
</form>  
...
$(document).ready(function(){
        ...
        $('#form_company_info').validator({
            ...
            stopOnError: false,
            rules: {
              yh:[/^(\d{16}|\d{17}|\d{19})$/,"<?=__('请填写正确的银行账号')?>"],
            },
