  ...
  <div class="right-layout">
    <div class="w fn-clear">
      ...
      <div class="joinin-concrete form-style">
       ...
       <br/>
       <span style="color:red;font-size: 13px;"><?php echo isset($shop_company['shop_verify_reason']) && $shop_company['shop_status'] == 5 || $shop_company['shop_status'] == 6 ? "拒绝原因：" . $shop_company['shop_verify_reason'] : '';?></span>
      </div>
    ...
    <div class="next"><a href="<?= Yf_Registry::get('base_url')?>/index.php?ctl=Seller_Shop_Settled&met=index&op=step3&rp=step3&apply=<?=$apply?>" class="btn bbc_btns"><?=__('上一步')?></a>&nbsp;&nbsp;&nbsp;<a id="btn_apply_company_next" class="btn bbc_btns button" href="javascript:void(0);"><?=__('提交申请')?></a></div>
</form>    
