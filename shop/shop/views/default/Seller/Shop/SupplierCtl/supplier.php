                   ...
                   <form id="form" action="./index.php?ctl=Seller_Shop_Supplier&met=supplier" method="post">
                    <div class="filter-groups">
                        <dl>
                            <dt><?=__('供应商名称：')?></dt>
                            <dd>
                                <input type="text" value="" placeholder="<?=__('供货商名称')?>" class="text wp100" name="supplier_name">
                            </dd>
                        </dl>
                    </div>
                    <div class="control-group">
                       <a href="javascript:void(0);" class="button btn_search_goods"><?=__('筛选')?></a>
                        <a class="button refresh" href="<?=Yf_Registry::get('url')?>?ctl=Seller_Shop_Supplier&met=supplier&typ=e&"><?=__('重新刷新')?></a>
                    </div>
                </form>
