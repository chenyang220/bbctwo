...
<div class="search">
    <form id="search_form" class="search_form_reset" method="get" action="<?= Yf_Registry::get('url') ?>">
        <div class="filter-groups">
            <dl>
                <dt><?=__('分销商名称：')?></dt>
                <dd><input class="text wp100" type="text" name="shop_name" value="" placeholder="<?=__('请输入分销商名称')?>"/></dd>
            </dl>
            <dl>
                <dt><?=__('商品名称名称：')?></dt>
                <dd><input class="text wp100" type="text" name="goods_key" value="" placeholder="<?=__('请输入商品名称')?>"/></dd>
            </dl>
        </div>
        <div class="control-group">
            <a class="button btn_search_goods" href="javascript:void(0);"><?= __('搜索') ?></a>
        </div>
                    ...
                    <td class="tl">
                        <dl class="fn-clear fn_dl">
                            <dt>
                                ...
                                <a href="index.php?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $item['goods_id'][0]['goods_id'] ?>"  target="_blank"><img width="60" src="<?= $item['common_image'] ?>"></a>
                            </dt>
                            <dd>
                                <h3><a href="index.php?ctl=Goods_Goods&met=goods&type=goods&gid=<?= $item['goods_id'][0]['goods_id'] ?>" target="_blank"><?= $item['common_name'] ?></a></h3>
                                <p><?= $item['cat_name'] ?></p>
