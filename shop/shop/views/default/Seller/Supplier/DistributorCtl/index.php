	    ...
	    <div class="search">
	        <form method="get" id="search_form" action="index.php" >
				...
				<div class="filter-groups">
					<dl>
						...
						<dd style="width: 250px;">
							<input type="text" autocomplete="off" name="start_date" id="start_date" class="text w85" value="<?=request_string('start_date')?>" placeholder="<?=__('开始时间')?>"/><label class="add-on"><i class="iconfont icon-rili"></i></label>
	            			<span class="rili_ge">–</span>
	            			<input type="text" autocomplete="off" name="end_date" id="end_date" class="text w85" value="<?=request_string('end_date')?>" placeholder="<?=__('结束时间')?>"/><label class="add-on"><i class="iconfont icon-rili"></i></label>
						</dd>
					</dl>
					<dl>
						<dt><?=__('状态：')?></dt>
				...
				<div class="control-group">
					 ...
					 <a class="button refresh" href="<?=Yf_Registry::get('url')?>?ctl=Seller_Supplier_Distributor&met=index&typ=e"><?=__('重新刷新')?></a>
				</div> 
