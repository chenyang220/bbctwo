        ...
        <form id="search_form" class="list-filter" method="get" action="<?= Yf_Registry::get('url') ?>">
            <div class="filter-groups">
                <dl>
                    <dt>商品名称：</dt>
                    <dd>
                        <input class="text wp100" type="text" name="goods_key" value="<?= ($goods_key ? $goods_key : ''); ?>"/>
            ...
            <div class="control-group">
                ...
                <a class="button refresh" href="index.php?ctl=Seller_Supplier_Goods&met=<?= $met ? $met : 'dist_online'; ?>&typ=e">重新刷新</a>
            </div>
        </form>
    </div>
    <script type="text/javascript">
