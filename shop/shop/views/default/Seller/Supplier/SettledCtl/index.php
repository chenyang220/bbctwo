...
<div class="banner">
    <div class="user-box">
        <div class="user-joinin">
            ...
            <div class="bottom">
                <?php if ((($shop_info && $shop_info['shop_status'] == 3) && $shop_info['shop_type'] == 1) || $chain_rows) { ?>
...
<div class="indextip">
    <div class="container">
        <span class="title"> <i class="iconfont icon-laba"></i></span>
        <span class="content"><em class="iblock two-overflow"><?= Web_ConfigModel::value('supplier_slider_tip') ?></em> </span>
    </div>
</div>
