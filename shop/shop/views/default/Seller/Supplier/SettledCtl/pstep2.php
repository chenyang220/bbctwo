            ...
            <div id="apply_company_info" class="apply-company-info">
                ...
                <form id="form_company_info"  method="post">
                    <table class="all" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <th><i>*</i><?=__('手机号码')?>：</th>
                            <td><input name="contacts_phone" class="w200 bor1" type="tel" maxlength="20" id="re_user_mobile" value="<?php echo isset($shop_company['contacts_phone']) ? $shop_company['contacts_phone'] : '';?>" />
