...
<div class="main">
  ...
  <div class="right-layout">
    ...
    <div class="next"><a href="<?= Yf_Registry::get('base_url')?>/index.php?ctl=Seller_Supplier_Settled&met=index&op=step4&rp=step4&apply=<?=$apply?>" style='display: none;' class="btn bbc_btns"><?=__('上一步')?></a>&nbsp;&nbsp;&nbsp;<a id="btn_apply_company_next" class="button button_black btn bbc_btns" href="javascript:void(0);"><?=__('提交')?></a></div>
    </form>
</div>
</div>
     <?php } ?>
