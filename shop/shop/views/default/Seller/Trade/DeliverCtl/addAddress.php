	...
	<form id="form" method="post" name="form">
        <div class="form-style">
			...
			<dl>
                <dt><i>*</i><?=__('电话')?>：</dt>
                <dd>
                    <input class="text w200" maxlength="20" name="shipping_address_phone" type="text" id="re_user_mobile" value="<?=@$data['shipping_address_phone']?>" />
                </dd>
            </dl>
			...
			<dl>
                <dt><?=__('公司')?>：</dt>
                <dd>
                    <input class="text w200" maxlength="20" name="shipping_address_company" type="text" value="<?=@$data['shipping_address_company']?>" />
            ...
            $('#form').validator({
                ...
                rules: {
                    phone:function(){
                        ...
                        var shipping_address_phone = $('#re_user_mobile').val();
                        var reg = /^1[3-9]\d{9}$/;
                        if(area_code==86 && !reg.test(shipping_address_phone)){
