...
<script type='text/jade' id='address_opt'>
    <a class="button bbc_seller_btns" href="<?=Yf_Registry::get('url')?>?ctl=Seller_Trade_Deliver&met=deliverSetting&typ=e&act=addAddress"><i class="iconfont icon-jia"></i><?=__('新增地址')?></a>
</script>
	<!---  BEGIN 地址列表 -->
    ...
    <script>
		//更改默认发货地址
        $(function (){
        	$(".tabmenu").append($("#address_opt").html());
