...
<div id="mainContent">
    ...
    <div class="ncsc-oredr-show">
        <div class="ncsc-order-info">
            ...
            <div class="ncsc-order-details chain-absolute-center">
            ...
            <div class="ncsc-order-condition chain-absolute-right">
                <dl>
                    ...
                    <td colspan="20" class="pt-10 pb-10 tfoot-pad">
                        <div class="fl">
                            ...
                            <?php if($data['order_user_discount'] > 0):?>
                                <dl>
                                    <dd><!-- <?=__('会员折扣：')?><?=__('减￥')?><?=$data['order_user_discount']?> --><?=$data['order_shop_benefit']?> </dd>
                                </dl>
                            <?php endif;?>
                        </div>
                        <div class="fr">
