			...
			<div class="res-cont">
				<table class="ncsc-default-table order">
					...
					<tr class="bd-line resAdd-inp">
						...
						<td>&nbsp;</td>
						<td>
							<input name="shipping" type="text" value="<?=$order_base['order_shipping_fee']?>" disabled onKeyUp="amount(this)">
							<input type="hidden" name="shipping" value="<?=$order_base['order_shipping_fee']?>"> 
						</td>
					</tr>
					<!-- E 运费 -->
