...
<body>
    <div class="waybill_back"> <img src="<?php echo $waybill_data['waybill_tpl_image']; ?>" alt="" style="max-height:100%;max-width:800px;"> <div>
        ...
        <div class="waybill_item waybill_design" style="left:<?= $val['left']; ?>px; top:<?= $val['top']; ?>px; width:<?= $val['width']; ?>px; height:<?= $val['height']; ?>px;"><?php if ( empty($val['value']) ) { echo $val['name']; } else { echo $val['value']; } ?></div>
        <?php } ?>
        <?php } ?>
    </div></div>
