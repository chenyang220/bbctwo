...
?>
    ...
    <div class="freight">
        <div class="tabmenu">
            ...
            <a class="button bbc_seller_btns" href="<?= Yf_Registry::get('url') ?>?ctl=Seller_Transport&met=transport&act=transport_default"><i class="iconfont icon-jia"></i><?= __('添加运费模版') ?></a>
        </div>
