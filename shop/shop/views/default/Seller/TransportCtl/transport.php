...
<div class="freight">
    ...
    <form id="transport_form">
        <div class="form-style">
            ...
            <dl class="dl">
                <dt style="width:80px"><i><?= __('*') ?></i><?= __('模板名称：') ?></dt>
            ...
            <dl class="dl">
                <dt style="width:80px"><i><?= __('*') ?></i><?= __('模板状态：') ?></dt>
                <dd style="width:25%">
            ...
            <dl class="dl">
                <dt style="width:80px"><i><?= __('*') ?></i><?= __('计费规则：') ?></dt>
                <dd style="width:25%">
                    <label><input type="radio" class="rules" name="rule_type" value="1" <?php if ((isset($data['template']['rule_type']) && $data['template']['rule_type'] == 1) || empty($data['template']['rule_type'])){ ?>checked="checked"<?php } ?> /><?= __('按重量') ?></label>
                    <label><input type="radio" class="rules" name="rule_type" value="3" <?php if (isset($data['template']['rule_type']) && $data['template']['rule_type'] == 3){ ?>checked="checked"<?php } ?> /><?= __('按体积') ?></label>

                </dd>
            </dl>
            <dl>
                <dt style="width:80px"><i><?= __('*') ?></i><?= __('详细设置') ?>：</dt>
                <dd class="trans-line">
                            ...
                            <div class="tbl-except">
                                <table cellspacing="0" class="district-table-style" style="width:100%" cellpadding="0" border="0">
                                    ...
                                    <tr style='border-bottom: 1px solid #ddd'>
                                        ...
                                        <th class="w110" id="rule_1">
                                            <?php if (isset($data['template']['rule_type']) && $data['template']['rule_type'] == 1) { ?>
                                                <?= __('首重') ?>(KG)
                                            <?php }elseif(isset($data['template']['rule_type']) && $data['template']['rule_type'] == 3) { ?>
                                                <?= __('首体积') ?>(m³)
                                            <?php } else {?>
                                                <?= __('首重') ?>(KG)
                                            <?php } ?>    
                                ...
                                <dd class="district-province-list">
                                    ...
                                    <?php $n = 0; foreach ($value as $k => $val) { $n++; ?>
                                        <div class="district-province">
                                            <span class="district-province-tab">
                                                ...
                                                <i class="iconfont icon-iconjiantouxia trigger"></i>
