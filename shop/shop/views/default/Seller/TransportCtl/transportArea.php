...
<div class="freight">
	<div class="tabmenu">
        ...
        <a class="button add bbc_seller_btns" href="<?=Yf_Registry::get('url')?>?ctl=Seller_Transport&met=tplarea&act=area"><i class="iconfont icon-jia"></i><?=__('添加区域模板')?></a>
    ...
    <tr>
        ...
        <th class="tl" width="80"><?=__('售卖区域ID')?> </th>
        <th><?=__('售卖区域')?></th>
