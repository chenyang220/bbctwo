            ...
            <div class="wrap clearfix">
                <div class="bbc-main-container">
                    ...
                    <div class="bbc-goodslist-bar">
                        <ul class="bbc-array">
                            ...
                            <li class="<?php if($order == 'common_sell_time'){?> sele <?php }?>"><a class="<?php if($sort == 'desc'){ echo 'down';}else{echo 'up'; }?>"
                                    href="index.php?ctl=Shop&met=goodsList&id=<?=$shop_id?>&order=common_sell_time&sort=<?=$new_sort ? $new_sort:'desc';?><?php if($_GET['shop_cat_id']){?>&shop_cat_id=<?php echo $_GET['shop_cat_id'];  }?>"><?=__('新品')?></a></li>
                            <li class="<?php if($order == 'common_price'){?> sele <?php }?>"><a class="<?php if($sort == 'desc'){ echo 'down';}else{echo 'up'; }?>"
                                    href="index.php?ctl=Shop&met=goodsList&id=<?=$shop_id?>&order=common_price&sort=<?=$new_sort ? $new_sort:'desc';?><?php if($_GET['shop_cat_id']){?>&shop_cat_id=<?php echo $_GET['shop_cat_id'];  }?>"><?=__('价格')?></a></li>
                            <li class="<?php if($order == 'common_salenum'){?> sele <?php }?>"><a class="<?php if($sort == 'desc'){ echo 'down';}else{echo 'up'; }?>"
                                    href="index.php?ctl=Shop&met=goodsList&id=<?=$shop_id?>&order=common_salenum&sort=<?=$new_sort ? $new_sort:'desc';?><?php if($_GET['shop_cat_id']){?>&shop_cat_id=<?php echo $_GET['shop_cat_id'];  }?>"><?=__('销量')?></a></li>
                            <li class="<?php if($order == 'common_collect'){?> sele <?php }?>"><a class="<?php if($sort == 'desc'){ echo 'down';}else{echo 'up'; }?>"
                                    href="index.php?ctl=Shop&met=goodsList&id=<?=$shop_id?>&order=common_collect&sort=<?=$new_sort ? $new_sort:'desc';?><?php if($_GET['shop_cat_id']){?>&shop_cat_id=<?php echo $_GET['shop_cat_id'];  }?>"><?=__('收藏')?></a></li>
                            <!--<li class=""><a
                    ...
                    <div class="content_s bbc-goods-list_2">
                       <ul>
                            <?php if(!empty($data)&&$shop_base['shop_type']==2) {
                                foreach($data as $key=>$value){
                                    ?>
                                    <li>
                                        <dl>
                                            <dt><a href="index.php?ctl=Supplier_Goods&met=goods&gid=<?=$value['goods_id'] ?>"
                                            ...
                                            <dd class="goods-name"><a
                                                        href="index.php?ctl=Supplier_Goods&met=goods&gid=<?=$value['goods_id'] ?>"
