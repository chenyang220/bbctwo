            ...
            <div class="t_goods_detail">
                ...
                <div class="t_goods_ev clearfix">
                    <div class="ev_left">
                        <div class="ev_left_img">
                            ...
                            <?php } else{ ?>
                                ...
                                <img id="jqzoomImg" class="jqzoom lazy" width=366 rel="<?= image_thumb($goods_image, 900, 976) ?>" data-original="<?= image_thumb($goods_image, 366, 340) ?>"/>
                            <?php } ?>
                        </div>
                        <div class="retw">
                  ...
                  <?php echo number_format(($goods_detail['goods_base']['goods_recommended_min_price'] - $goods_detail['goods_base']['goods_price']) / $goods_detail['goods_base']['goods_price'] * 100, 2, '.', ''); ?>
                            ...
                            <?php } ?>
                            <p class="clearfix">
                                <span class="mar-r _letter-spacing"><?= __('供货价') ?>：</span>
                                <span class="mar-b-2">
                        ...
                        <div class="goods_style_sel ">
                            ...
                            <?php } ?>
                            <?php if ($goods_status) { ?>
                                <p class="need_num clearfix detail_num">
                                ...
                                <?php if ($goods_detail['goods_base']['goods_stock']){ ?>
                                  <?php if (isset($suppliers) && !in_array($goods_detail['goods_base']['shop_id'], $suppliers)){ ?>
                                      <a class="apply_dist" data-id=<?= $goods_detail['goods_base']['shop_id'] ?> style="margin-top:10px;display:inline-block;padding:10px 50px;background-color: #e45050;color: white;"><?= __('申请经销商') ?></a>
                                ...
                                <?php }else{ ?>
                                  <?php if (isset($suppliers) && !in_array($goods_detail['goods_base']['shop_id'], $suppliers)){ ?>
                                    <a data-id=<?= $goods_detail['goods_base']['shop_id'] ?> style="margin-top:10px;display:inline-block;padding:10px 50px;background-color: #9a908d;color: white;"><?= __('申请经销商') ?></a>
                                  <?php } elseif (isset($suppliers) && in_array($goods_detail['goods_base']['shop_id'], $suppliers) && $goods_detail['common_base']['product_is_behalf_delivery'] != 1) { ?>
                                    <?php if ($goods_detail['common_base']['common_is_virtual']){ ?>
                            ...
                            foreach ($data_salle as $key_salle => $value_salle) {
                                ...
                                <li class="clearfix">
                                    <a target="_blank"
                                       ...
                                       class="selling_goods_img iblock wp100"><img class="wp100" src="<?= $value_salle['common_image'] ?>"></a>
                            ...
                            foreach ($data_collect as $key_collect => $value_collect) {
                                ...
                                <li class="clearfix">
                                    <a target="_blank"
                                       ...
                                       class="selling_goods_img iblock wp100"><img class="wp100" src="<?= $value_collect['common_image'] ?>"></a>
