	...
	public function addLog()
	{
		...
		if (true || isset($ccmd_rows[$_REQUEST['ctl']][$_REQUEST['met']]['log']))
		{
			...
			if (Perm::$login)
			{
                ...
                if($ctl == 'Log_Action' ||  $this->is_ajax() || $_REQUEST['type_number']=='user' || $ctl == 'Rights_Group'){
				...
				$data['log_param']      = $arr; // 请求的参数，|| 详细数据，可以通过controller结束赋值全部变量来或获取
				$data['log_ip'] = get_ip(); //
