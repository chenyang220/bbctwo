...
class Bargain_BaseModel extends Bargain_Base
{
    ...
    public function getBargainList($cond_row = array(), $order_row = array(), $page = 1, $rows = 100)
    {
        ...
        $sql .= Yf_GeneralOperator::getInstance()->shopTablePerfix() . "bargain_base AS bargain_base JOIN ";
        ...
        if ($cond_row['user_id']) {
            $sql .= "JOIN " . Yf_GeneralOperator::getInstance()->shopTablePerfix() . "bargain_buy_user AS bargain_buy_user ON ";
