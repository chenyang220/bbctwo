...
class Goods_CatNav extends Yf_Model
{
	...
	public $jsonKey = array('goods_cat_nav_recommend_display','goods_cat_nav_recommend_up_display');
	...
	{
		$add_flag = $this->add($field_row, $return_insert_id,false);
	...
	{
		$update_flag = $this->edit($goods_cat_nav_id, $field_row,null,false);
