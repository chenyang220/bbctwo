...
class Goods_SpecValueModel extends Goods_SpecValue
{
     ...
     * @access public
     */
    public function spec_value($shop_id, $spec_id)
    {
        $sql = "select * from " . yf_GeneralOperator::getInstance()->shopTablePerfix() . "goods_spec_value where shop_id=" . $shop_id . ' and spec_id=' . $spec_id;
