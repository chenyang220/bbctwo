...
class Goods_Type extends Yf_Model
{
	...
	public function addType($field_row, $return_insert_id = false)
	{
		...
		//添加对应表
		$table_name = sprintf('%sgoods_property_map_%d', yf_GeneralOperator::getInstance()->shopTablePerfix(), $add_flag);
	...
	public function editType($type_id = null, $field_row, $brand_row = array(), $spec_row = array(), $property_rows = array())
	{
		...
		$table_name = sprintf('%sgoods_property_map_%d', yf_GeneralOperator::getInstance()->shopTablePerfix(), $type_id);
