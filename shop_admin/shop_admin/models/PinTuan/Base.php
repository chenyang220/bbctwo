...
//        }
    ...
    public function getPinTuanGoodsIds()
    {
        ...
        $sql .= Yf_GeneralOperator::getInstance()->shopTablePerfix() . "pintuan AS pintuan JOIN ";
        $sql .= Yf_GeneralOperator::getInstance()->shopTablePerfix() . "pintuan_detail AS pintuan_detail ON ";
