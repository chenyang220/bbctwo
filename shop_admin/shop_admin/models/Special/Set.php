 ...
 * Time: 15:43
 */
class Special_Set extends Yf_Model
{
    public $_cacheKeyPrefix  = 'c|special_set|';
    public $_cacheName       = 'set';
    public $_tableName       = 'special_set';
    public $_tablePrimaryKey = 'column_set_id';
    public $jsonKey = array('column_set_image');
