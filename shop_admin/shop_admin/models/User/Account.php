 ...
 * @todo
 */
class User_Account extends Yf_Model
{
	public $_cacheKeyPrefix  = 'c|user_account|';
	public $_cacheName       = 'user';
	public $_tableName       = 'user_account';
	 ...
	 * @access public
	 */
	public function getAccount($user_id = null, $sort_key_row = null)
	{
		$rows = array();
	 ...
	 * @access public
	 */
	public function addAccount($field_row, $return_insert_id = false)
	{
	 ...
	 * @access public
	 */
	public function editAccount($user_id = null, $field_row)
	{
	 ...
	 * @access public
	 */
	public function editAccountSingleField($user_id, $field_name, $field_value_new, $field_value_old)
	{
