...
function initGrid()
{
    ...
    var t = ["操作", "wx_cat_image_id", "关联分类", "分类图片"], e = [{
        name: "operate",
        width: 60,
        fixed: !0,
        align: "center",
        ...
        {name: "wx_cat_image_id", index: "wx_cat_image_id", hidden: true},
        {name: "cat_name", index: "cat_name", align: "center",width: 150},
        {name: "wx_cat_image", index: "wx_cat_image",  align: "center",width: 100, formatter: imageFmatter}
    ];
    $("#grid").jqGrid({
        url: SITE_URL + '?ctl=Wx_CatImage&met=catImageList&typ=json',
        datatype: "json",
...
var handle = {
    operate: function (t, e)
    {
        ...
        $.dialog({
            title: i,
            content: "url:"+ SITE_URL + "?ctl=Wx_CatImage&met=manage&typ=e",
            data: a,
            width: 635,
            height: 520,
            max: !1,
    ...
    }, callback: function (t, e, i)
    {
        ...
        if ("edit" == e)
        {
            $("#grid").jqGrid("setRowData", t.wx_cat_image_id, t);
            i && i.api.close();
           
        }
        else
        {
            $("#grid").jqGrid("addRowData", t.wx_cat_image_id, t, "last");
            i && i.api.close();
        }
    ...
    }, del: function (t)
    {
        ...
        {
            Public.ajaxPost(SITE_URL + "?ctl=Wx_CatImage&met=removeCatImage&typ=json", {wx_cat_image_id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
...
function operFmatterCIMG(val, opt, row) {
    var html_con = '<div class="operating" data-id="' + row.wx_cat_image_id + '"><span class="ui-icon ui-icon-pencil" title="修改"></span><span class="ui-icon ui-icon-trash" title="删除"></span></div>';
    return html_con;
};
