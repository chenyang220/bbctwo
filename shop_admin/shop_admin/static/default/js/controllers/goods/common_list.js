$(function() {
    ...
    var handle = {
        ...
        goodsNameFmatter: function (val, opt, row)
        {
          return '<a style="text-decoration:none;" href="' + SHOP_URL + '/' + INDEX_PAGE + '?ctl=Goods_Goods&met=goodspreview&typ=e&au=ad&gid='  + row.goods_id[0].goods_id + '" target="_blank">' + val + '</a>';
        },
    };
    ...
    function initGrid() {
        ...
        var colModel = [{
            ...
            "title": false,
            "width":200,
            "formatter": handle.goodsNameFmatter
        }, {
            "name": "common_price",
            "index": "common_price",
            "label": "商品价格",
