...
function initValidator()
{
    $_form.validator({
        ...
        rules:{
            validLenth:function(element, params, field){
                var brand_name  = $('input[name="brand_name"]').val();
                 var cnt = 0;  
                  for( i=0; i<brand_name.length; i++)  
                  {  
                      var value = brand_name.charCodeAt(i);  
                      if( value < 0x080)  
                      {  
                          cnt += 1;  
                      }  
        ...
        fields: {
            brand_name: "required;validLenth;"
        },
        display: function (a)
        {
