...
function initGrid()
{
    var t = ['操作', '品牌ID', '品牌名称', '首字母', '品牌图片', '品牌排序', '品牌推荐', '展现形式'], e = [{
        ...
        {name: "brand_recommend", index: "brand_recommend", align: "center", width: 120,formatter:brand_recommend},
        {name: "brand_show_type", index: "brand_show_type", align: "center", width: 140,formatter:brand_show_type},];
