...
var THISPAGE = {
    ...
    loadGrid: function(){
        ...
        var colModel = [
            ...
            {name:'payshopname', label:'商户名称',  width:200, align:"center"},
            {name:'payshopnumer', label:'APP支付商户号',  width:200, align:"center"},
            {name:'cbpayshopnumer', label:'C扫B支付商户号',  width:200, align:"center"},
            {name:'xcxpayshopnumer', label:'小程序支付商户号',  width:200, align:"center"}
        ];
