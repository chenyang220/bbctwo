...
function init() {
    Public.ajaxPost(SITE_URL + "?ctl=Special_Column&typ=json&met=getColumnInfo&special=1&is_from=1", {}, function (rs) {
...
var handle = {
    ...
    image: function (t) {
        $.dialog({
            title: '上传图片',
            content: "url:./index.php?ctl=Special_Column&met=columnWapImage",
