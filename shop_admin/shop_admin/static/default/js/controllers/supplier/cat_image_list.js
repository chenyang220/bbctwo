...
function initGrid()
{
    ...
    var t = ["操作", "mb_cat_image_id", "关联分类", "分类图片"], e = [{
        ...
        {name: "app_cat_image", index: "app_cat_image",  align: "center",width: 100, formatter: imageFmatter}
    ];
    $("#grid").jqGrid({
        url: SITE_URL + '?ctl=Supplier_CatImage&met=catImageList&typ=json',
        datatype: "json",
...
var handle = {
    operate: function (t, e)
    {
        ...
        $.dialog({
            title: i,
            content: "url:"+ SITE_URL + "?ctl=Supplier_CatImage&met=manage&typ=e",
            data: a,
            width: 635,
            height: 520,
            max: !1,
    ...
    }, del: function (t)
    {
        ...
        {
            Public.ajaxPost(SITE_URL + "?ctl=Supplier_CatImage&met=removeCatImage&typ=json", {mb_cat_image_id: t}, function (e)
            {
                if (e && 200 == e.status)
                {
