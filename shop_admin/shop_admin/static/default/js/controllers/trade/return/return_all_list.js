...
function operFmatter (val, opt, row) {
	...
	var html_con = '<div class="operating" data-id="' + row.id + '"><a data-right="BU_QUERY" parentOpen="true" href="'+SITE_URL+'?ctl=Trade_Return&met=detail&id='+row.id+'" rel="pageTab" tabid="return-detail" tabtxt="'+ tabtxt +'"><span class="ui-icon ui-icon-pencil" title="处理"></span></a></div>';
	return html_con;
};
	var THISPAGE = {
		init: function(data){
