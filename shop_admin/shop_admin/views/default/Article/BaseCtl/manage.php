...
<form id="article_form" method="post">
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="article_title"><em>*</em><?= __('标题'); ?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit">
          <label for="article_url"><?= __('链接'); ?></label>
        </dt>
        <dd class="opt">
          <input type="text" value="" name="article_url" id="article_url" class="ui-input">
          <span class="err"></span>
          <p class="notic"><?= __('当填写'); ?>&quot;<?= __('链接'); ?>&quot;<?= __('后点击文章标题将直接跳转至链接地址，不显示文章内容。链接格式请以http://开头'); ?></p>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
        ...
        <dd class="opt">
          <div class="onoff">
            <label for="article_status1" class="cb-enable  "><?= __('启用'); ?></label>
            <label for="article_status2" class="cb-disable  selected"><?= __('关闭'); ?></label>
	  ...
	  <dl class="row">
        <dt class="tit">
          <label for="if_show"><?= __('是否公告'); ?>:</label>
        </dt>
        <dd class="opt">
          <div class="onoff">
            <label for="article_type1" class="cb-enable  "><?= __('是'); ?></label>
            <label for="article_type2" class="cb-disable  selected"><?= __('否'); ?></label>
