...
<div id="manage-wrap" class="manage-wrap">
	<form id="manage-form" action="#">
		<ul class="mod-form-rows">
			<li class="row-item">
				<div class="label-wrap"><label for="article_group_sort"><?= __('排序'); ?>:</label></div>
				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="article_group_sort" id="article_group_sort"></div>
			</li>
			<li class="row-item">
				<div class="label-wrap"><label for="article_group_title"><?= __('分类名称'); ?>:</label></div>
				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="article_group_title" id="article_group_title"></div>
			</li>
			<!--
			<li class="row-item">
				<div class="label-wrap"><label for="parent_group"><?= __('上级分类'); ?>:</label></div>
				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="parent_name" id="parent_name" readonly="true" placeholder="<?= __('没有上级分类'); ?>"></div>
