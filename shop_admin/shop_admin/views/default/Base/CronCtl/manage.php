...
<div style="margin:auto;width:500px;">
		<ul class="mod-form-rows mod-form-rows-reset" style="width: 500px;">
			<li class="row-item" style="float: left;width:50%;">
				<div class="label-wrap"><label for="cron_name"><?= __('任务名称'); ?>:</label></div>
			...
			<li class="row-item" style="margin-left: 50%;">
				<div class="label-wrap"><label for="cron_script"><?= __('任务脚本'); ?>:</label></div>
				<div class="ctn-wrap">
			...
			<li class="row-item" style="margin-left: 50%;">
				...
				<div class="onoff">
                    ...
                    <label for="enable0" class="cb-disable"><?= __('否'); ?></label>
