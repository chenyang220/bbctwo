...
<div id="manage-wrap" class="manage-wrap">
        ...
        <div class="ncap-form-default">
              ...
              <dl class="row">
                <dt class="tit">
                    <label for="search_keyword"><em>*</em><?= __('搜索词'); ?>: </label>
                </dt>
                <dd class="opt">
                    <input id="search_keyword" name="search_keyword" value="" class="ui-input w200" type="text"/>
					<p class="notic"> <?= __('搜索词参于搜索，例：童装。'); ?></p>
                </dd>
              </dl>
             <dl class="row">
                <dt class="tit">
                    <label for="search_char_index"><em>*</em><?= __('显示词'); ?> : </label>
                </dt>
                <dd class="opt">
                    <input id="search_char_index" name="search_char_index" value="" class="ui-input w200" type="text"/>
                     <span class="err"></span>
                     <p class="notic"><?= __('显示词不参于搜索，只起显示作用，例：'); ?>61<?= __('儿童节'); ?></p>
                </dd>
              </dl>
        </div>
    </form>
