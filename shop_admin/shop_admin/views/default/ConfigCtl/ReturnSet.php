...
<div class="wrapper page">
    ...
    <form method="post" id="plat-setting-form" name="settingForm">
        <input type="hidden" name="config_type[]" value="plat"/>
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <input id="plat_is_open1" name="plat[plat_is_open]" value="1" type="radio" <?= ($data['plat_is_open']['config_value'] == 1 ? 'checked' : '') ?> >
                        <label title="<?= __('开启'); ?>" class="cb-enable <?= ($data['plat_is_open']['config_value'] == 1 ? 'selected' : '') ?> " for="plat_is_open1"><?= __('开启'); ?></label>

                        <input id="plat_is_open0" name="plat[plat_is_open]" value="0" type="radio" <?= ($data['plat_is_open']['config_value'] == 0 ? 'checked' : '') ?> >
