  ...
  ?>
    ...
    <form method="post" id="shop_api-setting-form" name="settingForm">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="site_name"><?= __('PC版前台URL'); ?></label>
                </dt>
                <dd class="opt">
