...
?>
    ...
    <div class="wrapper page">
        ...
        <form method="post" enctype="multipart/form-data" id="bargain-setting-form" name="form1">
            <input type="hidden" name="config_type[]" value="bargain_buy"/>
            ...
            <div class="ncap-form-default">
                <dl class="row">
                    ...
                    <dd class="opt">
                        <input id="bargain_buy_price" name="bargain_buy[bargain_buy_price]" value="<?= ($data['bargain_buy_price']['config_value']) ?>" class="input-txt ui-input" type="text">

                        <p class="notic"><?= __('购买砍价活动所需费用，购买后商家可以在所购买周期内发布砍价促销活动'); ?></p>
