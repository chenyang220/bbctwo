...
<div class="wrapper page">
    ...
    <form method="post" enctype="multipart/form-data" id="discount-form" name="form1">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label><?= __('咨询头部文字提示'); ?></label>
                </dt>
                <dd class="opt">
                    <!-- 加载编辑器的容器 -->
                    <script id="container" style="width:600px;height:500px;" name="consult[consult_header_text]" type="text/plain"></script>
                </dd>
            </dl>
            <div class="bot">
                    <a href="javascript:void(0);" class="ui-btn ui-btn-sp submit-btn">
                    <?= __('确认提交'); ?></a>
                    </div>
        </div>
    </form>
