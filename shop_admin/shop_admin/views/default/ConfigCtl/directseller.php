...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            ?>
				<!-- <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=distribution&config_type%5B%5D=distribution"><span><?= __('分销员设置'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
						...
						<label title="<?= __('开启'); ?>" class="cb-enable <?=($data['directseller_is_open']['config_value']==1 ? 'selected' : '')?> " for="directseller_is_open1"><?= __('开启'); ?></label>
						...
						<label title="<?= __('关闭'); ?>" class="cb-disable <?=($data['directseller_is_open']['config_value']==0 ? 'selected' : '')?>" for="directseller_is_open0"><?= __('关闭'); ?></label>
                    </div>
