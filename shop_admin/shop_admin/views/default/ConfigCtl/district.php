...
<div class="wrapper page">
    ...
    <div class="mod-search cf">
        <div class="fr">
            <a href="#" class="ui-btn ui-btn-sp mrb" id="btn-refresh"><?= __('一键恢复'); ?><i class="iconfont icon-btn01"></i></a> <a href="#" class="ui-btn ui-btn-sp" id="btn-add"><?= __('新增'); ?><i class="iconfont icon-btn03"></i></a>
        </div>
    </div>
