...
<div id="manage-wrap" class="manage-wrap">
	<form id="manage-form" action="#">
		<ul class="mod-form-rows">
			<li class="row-item">
				<div class="label-wrap"><label for="district_name"><?= __('地区名称'); ?>:</label></div>
				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="district_name" id="district_name"></div>
			</li>
			<li class="row-item">
				<div class="label-wrap"><label for="parent_district"><?= __('上级地区'); ?>:</label></div>
				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="parent_district" id="parent_district" readonly="true" placeholder="<?= __('没有上级地区'); ?>"></div>
				<div class="ctn-wrap"><input type="text" hidden="true" value="" class="ui-input" name="parent_id" id="parent_id" style="display:none;"></div>
			</li>
			<li class="row-item">
				<div class="label-wrap"><label for="district_region"><?= __('区域名称'); ?>:</label></div>
