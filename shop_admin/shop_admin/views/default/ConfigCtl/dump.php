    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=site&config_type%5B%5D=site"><span><?= __('站点设置'); ?></span></a></li>
                ...
                <dd class="opt">
                    <ul class="nofloat">
                        <li>
                            ...
                            <label for="captcha_status1"><?= __('前台登录'); ?></label>
                        </li>
                        <li>
                            ...
                            <label for="captcha_status2"><?= __('前台注册'); ?></label>
                        </li>
                    </ul>
                    <p class="notic"><?= __('选择是否开启登录、注册页面验证码功能。'); ?></p>
                </dd>
            </dl>
