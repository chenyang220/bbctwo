...
<script>
    ...
    var url_item_list = SITE_URL + "?ctl=Mb_TplLayout&met=tplLayoutList&typ=json&tpl_layout_style=3";
    var url_item_add = SITE_URL + "?ctl=Mb_TplLayout&met=addTplLayout&typ=json&tpl_layout_style=3";
    var url_item_del = SITE_URL + "?ctl=Mb_TplLayout&met=removeTplLayout&typ=json&tpl_layout_style=3";
    var url_item_usable = SITE_URL + "?ctl=Mb_TplLayout&met=editUsableTplLayout&typ=json&tpl_layout_style=3";
    var url_item_edit = SITE_URL + "?ctl=Mb_TplLayout&met=getEditPage&typ=e&tpl_layout_style=3";
    var url_item_edit_sort = SITE_URL + "?ctl=Mb_TplLayout&met=editSortTplLayout&typ=json&tpl_layout_style=3";
            ...
            switch (item_data.mb_tpl_layout_type) {
                case 'adv_list':
                    ...
                    html = '<div nctype="special_item" class="special-item adv_list '+ (item_data.mb_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.mb_tpl_layout_id + '">' +
                                ...
                                ( item_data.mb_tpl_layout_data ? '<div nctype="item_image" class="item"> <img nctype="image" src="' + img + '" alt=""></div>' : '<div nctype="item_image" class="item"> <img nctype="image" src="' + '<?= $this->view->img_com ?>' + '/sx/Bitmap@2x.png' + '" alt=""></div>' ) +
                                '</div></div></div>' +
                    ...
                    break;
                case 'home1':
                    var img = item_data.mb_tpl_layout_data ?　item_data.mb_tpl_layout_data.image : '<?= $this->view->img_com ?>' + '/sx/Bitmap@2x(1).png';
                    html = '<div nctype="special_item" class="special-item adv_list '+ (item_data.mb_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.mb_tpl_layout_id + '">' +
                ...
                case 'enterance' :
                    ...
                    if(item_data.mb_tpl_layout_data) {
                        ...
                        for( var i=0; i<layout_data.length; i++) {
                         ...
                         enterance_html = 
                            '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Group 4@2x.png' +'"></em><p>'+"时令水果"+'</p></li>'
                         +  '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Bitmap@2x(7).png' +'"></em><p>'+"新鲜蔬菜"+'</p></li>'
                         +  '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Group 5@2x.png' +'"></em><p>'+"肉禽蛋"+'</p></li>'
                         +  '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Bitmap@2x(8).png' +'"></em><p>'+"水产海鲜"+'</p></li>'
                         +  '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Bitmap Copy@2x.png' +'"></em><p>'+"乳品烘焙"+'</p></li>'
                         +  '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Group 4 Copy 2@2x.png' +'"></em><p>'+"米面粮油"+'</p></li>'
                         +  '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Bitmap Copy 4@2x.png' +'"></em><p>'+"方便速食"+'</p></li>'
                         +  '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Group 5 Copy 2@2x.png' +'"></em><p>'+"酒饮零食"+'</p></li>'
                         +  '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Bitmap Copy 2@2x.png' +'"></em><p>'+"快手菜"+'</p></li>'
                         +  '<li><em><img src="'+ '<?= $this->view->img_com ?>' + '/sx/Bitmap Copy 3@2x.png' +'"></em><p>'+"日用百货"+'</p></li>';
                    }
				...
				case 'newGoods' :
				    var goosd_html = new String();
                     // if(item_data.mb_tpl_layout_data) {
                        var t1_img = '<?= $this->view->img_com ?>' + '/sx/Bitmap@2x(6).png',t2_img = '<?= $this->view->img_com ?>' + '/sx/Bitmap@2x(5).png',t3_img = '<?= $this->view->img_com ?>' + '/sx/Bitmap@2x(3).png',t4_img = '<?= $this->view->img_com ?>' + '/sx/Bitmap@2x(4).png';

                        var  goods_title_1 =  '新品尝鲜',goods_title_2 = '平价菜场',goods_describe_1 = '荔枝|这口鲜 抢先尝',goods_describe_2 = '春天的蔬菜 新鲜的蔬菜买1送1';
                        if (item_data.mb_tpl_layout_data) {
                        ...
                        if (item_data.mb_tpl_layout_data) {
                             goods_title_1 = item_data.mb_tpl_layout_data.classify1.goods_title != "" ? item_data.mb_tpl_layout_data.classify1.goods_title : '新品尝鲜',goods_title_2 = item_data.mb_tpl_layout_data.classify2.goods_title != "" ? item_data.mb_tpl_layout_data.classify2.goods_title : '平价菜场',goods_describe_1 = item_data.mb_tpl_layout_data.classify1.goods_describe != '' ? item_data.mb_tpl_layout_data.classify1.goods_describe : '荔枝|这口鲜 抢先尝',goods_describe_2 = item_data.mb_tpl_layout_data.classify2.goods_describe != '' ? item_data.mb_tpl_layout_data.classify2.goods_describe : '春天的蔬菜 新鲜的蔬菜买1送1';
                             if(item_data.mb_tpl_layout_data.goods_ids) {
                                var layout_data = item_data.mb_tpl_layout_data.goods_ids;
                                for( var i=0; i<layout_data.length; i++) {
                                    goosd += '<li><a href=""><em class="img-box"><img class="wp100" src="'+layout_data[i].goods_image+'" alt=""></em><span class="iblock fz12 one-overflow wp100">'+  layout_data[i].goods_name +'</span></a></li>';
                                }
                            }
                        }
                        
                       
                        goosd_html +='<div class="industry-module clearfix fresh-module-new">'+
                        '<dl><dt><strong class="block">'+goods_title_1+'</strong><span>'+goods_describe_1+'</span></dt><dd class="clearfix"><a href=""><em class="img-box">' +
                        '<img src="'+t1_img+'" alt="img"></em></a>'+
                        '<a href="">'+'<em class="img-box"><img src="'+t2_img+'" alt="img"></em></a>'+
                        '</dd></dl>'+
                        '<dl><dt><strong>'+goods_title_2+'</strong><span>'+goods_describe_2+'</span></dt><dd class="clearfix"><a href=""><em class="img-box">' +
                        '<img src="'+t3_img+'" alt="img"></em></a>'+
                        '<a href="">'+'<em class="img-box"><img class="wp100" src="'+t4_img+'" alt="img"></em></a>'+
                        '</dd></dl>'+
                        '<div class="xs-discount"><ul class="clearfix">' + goosd + '</ul></div>' +
                        '</div>';
                    // }
                    html = '<div nctype="special_item" class="special-item goods '+ (item_data.mb_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.mb_tpl_layout_id + '">' +
                        '<div class="item_type">新品速递</div>' +
                        '<div id="item_edit_content">' +
                            '<style type="text/css">' +
                                '.mb-item-edit-content { background: #EFFAFE url(/default/images/cms_edit_bg_line.png) repeat-y scroll 0 0; }' +
                            '</style>' +
