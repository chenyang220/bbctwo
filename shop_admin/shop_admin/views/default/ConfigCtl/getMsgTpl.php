    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
				<!-- <li><a id="2" href="<?= Yf_Registry::get('url') ?>?ctl=News_Message&met=template&type=2"><span><?= __('商家消息模板'); ?></span></a></li>
				<li><a id="1" href="<?= Yf_Registry::get('url') ?>?ctl=News_Message&met=template&type=1"><span><?= __('用户消息模板'); ?></span></a></li>
				<li><a   class="current"><span><?= __('系统消息模板'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
