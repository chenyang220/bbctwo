...
?>
    ...
    <div class="wrapper page">
            ...
            <div class="item-title">
                ...
                <ul class="tab-base nc-row">
                    ...
                    <?php if (isset($config['index_slider']) && $config['index_slider']): ?>
                        <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=index_slider&config_type%5B%5D=index_slider"><span><?= __('首页幻灯片'); ?></span></a></li>
                    <?php endif; ?>
        ...
        <div class="explanation" id="explanation">
            ...
            <ul>
                <li><?= __('该组幻灯片滚动图片应用于首页使用，最多可上传'); ?>5<?= __('张图片。'); ?></li>
            ...
            <div class="ncap-form-default">
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="div-image">
                            <img id="index_slider1_review" src="<?php if (isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']) {
                                ...
                                echo @$data['index_slider_image1']['config_value'];
                                 ...
                                 height="200"/> <a href="javascript:void(0)" id="del_btn1" class="del" onclick="delImage('index_slider1_review')" title="<?= __('移除'); ?>"><i class="iconfont icon-cancel"></i></a>
                        </div>
                        ...
                        <div id='index_slider1_upload' class="image-line upload-image"><?= __('图片上传'); ?></div>
                        
                        <label title="<?= __('请输入图片要跳转的链接地址'); ?>"><i class="fa fa-link"></i> <input class="ui-input w400" style="margin:5px 0" type="text" name="index_slider[<?php if (isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']) {
                            ...
                            } ?>" placeholder="<?= __('请输入图片要跳转的链接地址'); ?>"> </label> <span class="err"><label for="index_live_link1" class="error valid"></label></span>
                        <p class="notic"><?= __('请使用宽度'); ?>1900<?= __('像素，高度'); ?>500<?= __('像素的'); ?>jpg/gif/png<?= __('格式图片作为幻灯片'); ?>banner<?= __('上传，'); ?><br> <?= __('如需跳转请在后方添加以http://开头的链接地址。'); ?></p>
                    </dd>
                </dl>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="div-image">
                            ...
                            } ?>"  height="200"/> <a href="javascript:void(0)" id="del_btn2" class="del" onclick="delImage('index_slider2_review')" title="<?= __('移除'); ?>"><i class="iconfont icon-cancel"></i></a>
                        </div>
                        ...
                        <div id='index_slider2_upload' class="image-line upload-image"><?= __('图片上传'); ?></div>
                        ...
                        <label title="<?= __('请输入图片要跳转的链接地址'); ?>"><i class="fa fa-link"></i> <input class="ui-input w400" style="margin:5px 0" type="text" name="index_slider[<?php if (isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']) {
                            ...
                            } ?>" placeholder="<?= __('请输入图片要跳转的链接地址'); ?>"> </label> <span class="err"><label for="index_live_link2" class="error valid"></label></span>
                        <p class="notic"><?= __('请使用宽度'); ?>1900<?= __('像素，高度'); ?>500<?= __('像素的'); ?>jpg/gif/png<?= __('格式图片作为幻灯片'); ?>banner<?= __('上传，'); ?><br> <?= __('如需跳转请在后方添加以http://开头的链接地址。'); ?></p>
                    </dd>
                </dl>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="div-image">
                            ...
                            } ?>" height="200"/> <a href="javascript:void(0)" id="del_btn3" class="del" onclick="delImage('index_slider3_review')" title="<?= __('移除'); ?>"><i class="iconfont icon-cancel"></i></a>
                        </div>
                        ...
                        <div id='index_slider3_upload' class="image-line upload-image"><?= __('图片上传'); ?></div>
                        ...
                        <label title="<?= __('请输入图片要跳转的链接地址'); ?>"><i class="fa fa-link"></i> <input class="ui-input w400" style="margin:5px 0" type="text" name="index_slider[<?php if (isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']) {
                            ...
                            } ?>" placeholder="<?= __('请输入图片要跳转的链接地址'); ?>"> </label> <span class="err"><label for="index_live_link3" class="error valid"></label></span>
                        <p class="notic"><?= __('请使用宽度'); ?>1900<?= __('像素，高度'); ?>500<?= __('像素的'); ?>jpg/gif/png<?= __('格式图片作为幻灯片'); ?>banner<?= __('上传，'); ?><br> <?= __('如需跳转请在后方添加以http://开头的链接地址。'); ?></p>
                    </dd>
                </dl>
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="div-image">
                            ...
                            } ?>" height="200"/> <a href="javascript:void(0)" id="del_btn4" class="del" onclick="delImage('index_slider4_review')" title="<?= __('移除'); ?>"><i class="iconfont icon-cancel"></i></a>
                        </div>
                        ...
                        <div id='index_slider4_upload' class="image-line upload-image"><?= __('图片上传'); ?></div>
                        ...
                        <label title="<?= __('请输入图片要跳转的链接地址'); ?>"><i class="fa fa-link"></i> <input class="ui-input w400" style="margin:5px 0" type="text" name="index_slider[<?php if (isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']) {
                            ...
                            } ?>" placeholder="<?= __('请输入图片要跳转的链接地址'); ?>"> </label> <span class="err"><label for="index_live_link4" class="error valid"></label></span>
                        <p class="notic"><?= __('请使用宽度'); ?>1900<?= __('像素，高度'); ?>500<?= __('像素的'); ?>jpg/gif/png<?= __('格式图片作为幻灯片'); ?>banner<?= __('上传，'); ?><br> <?= __('如需跳转请在后方添加以http://开头的链接地址。'); ?></p>
                    </dd>
                </dl>
                <dl class="row">
                    ...
                    <dd class="opt">
                        <div class="div-image">
                            ...
                            } ?>"  height="200"/> <a href="javascript:void(0)" id="del_btn5" class="del" onclick="delImage('index_slider5_review')" title="<?= __('移除'); ?>"><i class="iconfont icon-cancel"></i></a>
                        </div>
                        ...
                        <div id='index_slider5_upload' class="image-line upload-image"><?= __('图片上传'); ?></div>
                        ...
                        <label title="<?= __('请输入图片要跳转的链接地址'); ?>"><i class="fa fa-link"></i> <input class="ui-input w400" style="margin:5px 0" type="text" name="index_slider[<?php if (isset(Perm::$row['sub_site_id']) && Perm::$row['sub_site_id']) {
                            ...
                            } ?>" placeholder="<?= __('请输入图片要跳转的链接地址'); ?>"> </label> <span class="err"><label for="index_live_link5" class="error valid"></label></span>
                        <p class="notic"><?= __('请使用宽度'); ?>1900<?= __('像素，高度'); ?>500<?= __('像素的'); ?>jpg/gif/png<?= __('格式图片作为幻灯片'); ?>banner<?= __('上传，'); ?><br> <?= __('如需跳转请在后方添加以http://开头的链接地址。'); ?></p>
                    </dd>
                </dl>
