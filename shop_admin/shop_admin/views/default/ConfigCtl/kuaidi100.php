    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
              ...
              ?>
                <!-- <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=logistics&config_type%5B%5D=logistics&typ=e"><span><?= __('物流查询选用设置'); ?></span></a></li>
                <li><a class="current"><span><?= __('快递'); ?>100</span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=kuaidiniao&config_type%5B%5D=kuaidiniao"><span><?= __('快递鸟'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic"><?= __('尚无'); ?>App Id,<a href="https://www.kuaidi100.com/openapi/applypoll.shtml" target="_blank"><?= __('申请'); ?></a></p>
                </dd>
            </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
						...
						<label title="<?= __('开启'); ?>" class="cb-enable <?=($data['kuaidi100_status']['config_value']==1 ? 'selected' : '')?> " for="kuaidi100_status1"><?= __('开启'); ?></label>
						...
						<label title="<?= __('关闭'); ?>" class="cb-disable <?=($data['kuaidi100_status']['config_value']==0 ? 'selected' : '')?>" for="kuaidi100_status0"><?= __('关闭'); ?></label>
                    </div>
                    <p class="notic"></p>
                </dd>
            </dl>
