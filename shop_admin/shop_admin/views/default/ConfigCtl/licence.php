...
<div class="wrapper page">
    ...
    <form id="licence-setting-form" method="post" enctype="multipart/form-data" name="settingForm">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="company_name"><?= __('授权名称'); ?></label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="licence_domain"><?= __('授权域名'); ?></label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="licence_effective_enddate"><?= __('有效日期'); ?></label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="licence_key"><?= __('证书信息'); ?></label>
                </dt>
                <dd class="opt">
                    <textarea name="licence[licence_key]" class="ui-input w600" id="licence_key"><?=($data['licence']['licence_key'])?></textarea>

                    <p class="notic"><a href="//www.yuanfeng021.com" target="_blank"><?= __('联系获取证书'); ?></a></p>
                </dd>
            </dl>

            <div class="bot"><a href="javascript:void(0);" class="ui-btn ui-btn-sp submit-btn"><?= __('更新证书'); ?></a></div>
        </div>
    </form>
</div>
