        ...
        <form method="post" id="email_msg-setting-form" name="settingForm">
            ...
            <div class="ncap-form-default">
                ...
                <dl class="row">
                    ...
                    <dd class="opt">
                        <input type="text" value="" name="email[email_test]" id="email_test" class="ui-input w400"> <input type="button" value="<?= __('测试'); ?>" name="send_test_email" class="input-btn" id="send_test_email">
                    </dd>
                </dl>
