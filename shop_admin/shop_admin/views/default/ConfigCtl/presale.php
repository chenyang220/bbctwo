...
<div class="wrapper page">
    ...
    <form method="post" enctype="multipart/form-data" id="presale-form" name="form1">
        <input type="hidden" name="config_type[]" value="presale"/>
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="promotion_presale_price" name="presale[promotion_presale_price]" value="<?=($data['promotion_presale_price']['config_value'])?>" class="input-txt ui-input" type="text">

                    <p class="notic"><?= __('购买预售活动所需费用，购买后商家可以在所购买周期内发布预售促销活动'); ?></p>
