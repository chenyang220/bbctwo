            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
						...
						<label title="<?= __('开启'); ?>" class="cb-enable <?=($data['self_shop_show'.$sub_site_suffix]['config_value']==1 ? 'selected' : '')?> " for="self_shop_show1"><?= __('开启'); ?></label>
						...
						<label title="<?= __('关闭'); ?>" class="cb-disable <?=($data['self_shop_show'.$sub_site_suffix]['config_value']==0 ? 'selected' : '')?>" for="self_shop_show0"><?= __('关闭'); ?></label>
                    </div>

                    <p class="notic"><?= __('开启后，自营店铺和自营商品将在商城显示，如果开启分站，该设置仅对当前分站有效'); ?></p>
                </dd>
            </dl>
