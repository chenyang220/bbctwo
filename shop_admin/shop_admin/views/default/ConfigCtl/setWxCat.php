            ...
            <dl class="row">
                ...
                <dd class="opt">
					<div class="iblock tc">
						...
						<input type="radio" name="setCat[setWxCat]" value="1" <?php if($setCat != 2){ ?>checked <?php } ?>><span>原分类列表</span>
					</div>
					<div class="iblock tc">
						<img class="w200" src="<?=$this->view->img?>/new-module.png" alt="">
						<input type="radio" name="setCat[setWxCat]" value="2" <?php if ($setCat == 2){ ?>checked <?php } ?>><span>新分类列表</span>
					</div>
