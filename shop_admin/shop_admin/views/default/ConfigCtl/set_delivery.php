...
<div class="wrapper page">
    ...
    <form method="post" enctype="multipart/form-data" id="sdelivery-setting-form" name="form">
        <input type="hidden" name="config_type[]" value="set_delivery"/>

        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label><?= __('买家配送费设置'); ?></label>
                </dt>
                <dd class="opt">
					<input id="delivery" name="set_delivery[delivery]" value="<?=($data['delivery']['config_value'])?>" class="ui-input w40" type="text"/>
                    <span><?= __('元'); ?></span>
                    <p class="notic"><?= __('设置平台收取买家每单的配送费'); ?></p>
                </dd>
            </dl>
