	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
				<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=plugin"><span><?= __('插件管理'); ?></span></a></li>
				<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=cacheManage"><span><?= __('清理缓存'); ?></span></a></li>
				<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=validator"><span><?= __('程序检测'); ?></span></a></li>
				<li><a class="current" ><span><?= __('更新管理中心'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=updateShop"><span><?= __('更新商城'); ?></span></a></li>
			</ul>
		</div>
	</div>
