        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic"><?= __('购买代金劵活动所需费用，购买后商家可以在所购买周期内发布代金劵促销活动'); ?></p>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic"><?= __('每月最多可以发布的代金劵促销活动数量'); ?></p>
                </dd>
            </dl>
           <!--  <dl class="row">
                <dt class="tit">
                    <label><em>*</em><?= __('买家最大领取数量'); ?></label>
                </dt>
                <dd class="opt">
                    ...
                    <p class="notic"><?= __('买家最多只能拥有同一个店铺尚未消费抵用的店铺代金券最大数量，该值最大为'); ?>20</p>
                </dd>
            </dl> -->
