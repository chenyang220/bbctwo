...
?>
<link href="<?= $this->view->css ?>/mb.css?v=855" rel="stylesheet" type="text/css">
<link href="<?= $this->view->css ?>/add.css?v=881" rel="stylesheet" type="text/css">
...
<script>
    ...
    var url_item_list = SITE_URL + "?ctl=Wx_TplLayout&met=tplLayoutList&typ=json";
    var url_item_add = SITE_URL + "?ctl=Wx_TplLayout&met=addTplLayout&typ=json";
    var url_item_del = SITE_URL + "?ctl=Wx_TplLayout&met=removeTplLayout&typ=json";
    var url_item_usable = SITE_URL + "?ctl=Wx_TplLayout&met=editUsableTplLayout&typ=json";
    var url_item_edit = SITE_URL + "?ctl=Wx_TplLayout&met=getEditPage&typ=e";
    var url_item_edit_sort = SITE_URL + "?ctl=Wx_TplLayout&met=editSortTplLayout&typ=json";
    ...
    $(document).ready(function(){
            ...
            if ( data.status == 200 ) {
                if ( data.data.items && data.data.items.length > 0 ) {
                    ...
                    for(var i=0; i<item_list.length; i++) {
                        ...
                        item_data[item_list[i].wx_tpl_layout_id] = item_list[i];
                    }
        ...
        function createLayoutHtml(item_data) {
            ...
            switch (item_data.wx_tpl_layout_type) {
                case 'adv_list':
                    var img = (item_data.wx_tpl_layout_data && item_data.wx_tpl_layout_data.length > 0) ? item_data.wx_tpl_layout_data[0].image : default_img;
                    html = '<div nctype="special_item" class="special-item adv_list '+ (item_data.wx_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.wx_tpl_layout_id + '">' +
                        '<div class="item_type">广告条版块</div>' +
                        '<div id="item_edit_content"><div class="adv_list"><div nctype="item_content" class="content">' +
                        ( item_data.wx_tpl_layout_data ? '<div nctype="item_image" class="item"> <img nctype="image" src="' + img + '" alt=""></div>' : '' ) +
                        '</div></div></div>' +
                        ...
                        '<i class="fa fa-arrow-down"></i>下移</a> <a nctype="btn_usable" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-toggle-on"></i>启用</a> <a nctype="btn_edit_item" data-item-type="' + item_data.wx_tpl_layout_type + '" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-pencil-square-o"></i>编辑</a> <a nctype="btn_del_item" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;"><i class="fa fa-trash-o"></i>删除</a></div></div>';
                    break;
                case 'home1':
                    var img = item_data.wx_tpl_layout_data ?　item_data.wx_tpl_layout_data.image : default_img;
                    html = '<div nctype="special_item" class="special-item adv_list '+ (item_data.wx_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.wx_tpl_layout_id + '">' +
                ...
                case 'home2':
                    ...
                    if ( item_data.wx_tpl_layout_data ) {
                        f_img = item_data.wx_tpl_layout_data.square ? item_data.wx_tpl_layout_data.square.image : default_img,
                            s_img = item_data.wx_tpl_layout_data.rectangle1 ? item_data.wx_tpl_layout_data.rectangle1.image : default_img,
                            t_img = item_data.wx_tpl_layout_data.rectangle2 ? item_data.wx_tpl_layout_data.rectangle2.image : default_img;
                    }

                    html = '<div nctype="special_item" class="special-item home2 '+ (item_data.wx_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.wx_tpl_layout_id + '">' +
                        ...
                        '<i class="fa fa-arrow-down"></i>下移</a> <a nctype="btn_usable" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-toggle-on"></i>启用</a> <a nctype="btn_edit_item" data-item-type="' + item_data.wx_tpl_layout_type + '" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-pencil-square-o"></i>编辑</a> <a nctype="btn_del_item" data-item-type="' + item_data.wx_tpl_layout_type + '" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;"><i class="fa fa-trash-o"></i>删除</a></div></div>';
                    break;
                case 'home3' :
                    var layout_html = new String();
                    if (item_data.wx_tpl_layout_data && item_data.wx_tpl_layout_data.length>0) {
                        var layout_data = item_data.wx_tpl_layout_data;
                    ...
                    html = '<div nctype="special_item" class="special-item home3 '+ (item_data.wx_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.wx_tpl_layout_id + '">' +
                        ...
                        '<i class="fa fa-arrow-down"></i>下移</a> <a nctype="btn_usable" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-toggle-on"></i>启用</a> <a nctype="btn_edit_item" data-item-type="' + item_data.wx_tpl_layout_type + '" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-pencil-square-o"></i>编辑</a> <a nctype="btn_del_item" data-item-type="' + item_data.wx_tpl_layout_type + '" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                ...
                case 'home4' :
                    ...
                    html = '<div nctype="special_item" class="special-item home4 '+ (item_data.wx_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.wx_tpl_layout_id + '">' +
                ...
                case 'goods' :
                    ...
                    html = '<div nctype="special_item" class="special-item goods '+ (item_data.wx_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.wx_tpl_layout_id + '">' +
                ...
                case 'activityA' :
                    ...
                    if(item_data.wx_tpl_layout_data) {
                        if(item_data.wx_tpl_layout_data["0"]){
                            var layout_data = item_data.wx_tpl_layout_data["0"].content_info;
                            switch(item_data.wx_tpl_layout_data["0"].type){
                                case "groupbuy":
                                    for( var i=0; i<layout_data.length; i++) {
                    ...
                    html = '<div nctype="special_item" class="special-item goods '+ (item_data.wx_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.wx_tpl_layout_id + '">' +
                        ...
                        '<i class="fa fa-arrow-up"></i>上移</a> <a nctype="btn_move_down" href="javascript:;">' +
                        '<i class="fa fa-arrow-down"></i>下移</a> <a nctype="btn_usable" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-toggle-on"></i>启用</a> <a nctype="btn_edit_item" data-item-module="A"  data-item-type="' + item_data.wx_tpl_layout_type + '" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-pencil-square-o"></i>编辑</a> <a nctype="btn_del_item" data-item-type="' + item_data.wx_tpl_layout_type + '" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-trash-o"></i>删除</a></div></div>';
                    break;
                case 'activityB' :
                    ...
                    for(var a=0;a<item_data.wx_tpl_layout_data.length;a++){
                        // if(item_data.wx_tpl_layout_data[a].content_info){
                        var actList=item_data.wx_tpl_layout_data[a].content_info;
                        switch(item_data.wx_tpl_layout_data[a].type){
                            case "groupbuy":
                                var str_groupbuy=" ";
                    ...
                    html = '<div nctype="special_item" class="special-item goods '+ (item_data.wx_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.wx_tpl_layout_id + '">' +
                        ...
                        '<i class="fa fa-arrow-up"></i>上移</a> <a nctype="btn_move_down" href="javascript:;">' +
                        '<i class="fa fa-arrow-down"></i>下移</a> <a nctype="btn_usable" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-toggle-on"></i>启用</a> <a nctype="btn_edit_item" data-item-module="B" data-item-type="' + item_data.wx_tpl_layout_type + '" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-pencil-square-o"></i>编辑</a> <a nctype="btn_del_item" data-item-type="' + item_data.wx_tpl_layout_type + '" data-item-id="' + item_data.wx_tpl_layout_id + '" href="javascript:;">' +
                        '<i class="fa fa-trash-o"></i>删除</a></div></div>';
                    break;
                case 'goodsB' :
                ...
                case 'advA' :
                    ...
                    if(item_data.wx_tpl_layout_data) {
                        ...
                        if ( item_data.wx_tpl_layout_data ) {
                            f_img = item_data.wx_tpl_layout_data.square ? item_data.wx_tpl_layout_data.square.image : default_img,
                                s1_img = item_data.wx_tpl_layout_data.rectangle1 ? item_data.wx_tpl_layout_data.rectangle1.image : default_img,
                                s2_img = item_data.wx_tpl_layout_data.rectangle2 ? item_data.wx_tpl_layout_data.rectangle2.image : default_img,
                                t1_img = item_data.wx_tpl_layout_data.rectangle3 ? item_data.wx_tpl_layout_data.rectangle3.image : default_img,
                                t2_img = item_data.wx_tpl_layout_data.rectangle4 ? item_data.wx_tpl_layout_data.rectangle4.image : default_img,
                                t3_img = item_data.wx_tpl_layout_data.rectangle5 ? item_data.wx_tpl_layout_data.rectangle5.image : default_img,
                                t4_img = item_data.wx_tpl_layout_data.rectangle6 ? item_data.wx_tpl_layout_data.rectangle6.image : default_img;
                ...
                case 'advB' :
                    ...
                    if(item_data.wx_tpl_layout_data) {
                        ...
                        if ( item_data.wx_tpl_layout_data ) {
                            t1_img = item_data.wx_tpl_layout_data.rectangle1 ? item_data.wx_tpl_layout_data.rectangle1.image : default_img,
                                t2_img = item_data.wx_tpl_layout_data.rectangle2 ? item_data.wx_tpl_layout_data.rectangle2.image : default_img,
                                t3_img = item_data.wx_tpl_layout_data.rectangle3 ? item_data.wx_tpl_layout_data.rectangle3.image : default_img,
                                t4_img = item_data.wx_tpl_layout_data.rectangle4 ? item_data.wx_tpl_layout_data.rectangle4.image : default_img,
                                t5_img = item_data.wx_tpl_layout_data.rectangle5 ? item_data.wx_tpl_layout_data.rectangle5.image : default_img;
				...
				case 'class' :
				    var class_html = new String();
				     if(item_data.wx_tpl_layout_data) {
				        ...
				        class_html +='<div class="industry-module clearfix">'+
					...
					html = '<div nctype="special_item" class="special-item goods '+ (item_data.mb_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.mb_tpl_layout_id + '">' +
						...
						'<div id="item_edit_content">' +
							'<style type="text/css">' +
								'.mb-item-edit-content { background: #EFFAFE url(/default/images/cms_edit_bg_line.png) repeat-y scroll 0 0; }' +
							'</style>' +
						'<div class="goods-list"><div class="title"><span></span></div><div nctype="item_content" class="content">' + class_html + '</div></div></div>' +
						'<div class="handle"><a nctype="btn_move_up" href="javascript:;">' +
							'<i class="fa fa-arrow-up"></i>上移</a> <a nctype="btn_move_down" href="javascript:;">' +
				...
				case 'home5' :
				    ...
				    if(item_data.wx_tpl_layout_data) {
				        ...
				        goosd_html +='<div class="index-industry-module2"><div class="">'+
									'<em class="iblock img-box wp100"><img class="wp100" src="https://www.yuanfengtest.com/image.php/shop/data/upload/media/plantform/6fc0625bf097e245fa1c1007bf528b2d/image/20200324/158503813431197865054318871259.jpg" alt="img"></em>'+
									'<ul><li><a href=""><em class="img-box"><img src="https://www.yuanfengtest.com/image.php/shop/data/upload/media/6fc0625bf097e245fa1c1007bf528b2d/10011/9/image/20181126/1543234654592148.jpg!360x64.jpg" alt=""></em><span>鑫瑞 SRUNV </span></a></li>'+
									'<li><a href=""><em class="img-box"><img src="https://www.yuanfengtest.com/image.php/shop/data/upload/media/6fc0625bf097e245fa1c1007bf528b2d/10011/9/image/20181126/1543234654592148.jpg!360x64.jpg" alt=""></em><span>东成电锤</span></a></li>'+
									'<li><a href=""><em class="img-box"><img src="https://www.yuanfengtest.com/image.php/shop/data/upload/media/6fc0625bf097e245fa1c1007bf528b2d/10011/9/image/20181126/1543234654592148.jpg!360x64.jpg" alt=""></em><span>舒蔻 压水车</span></a></li>'+
									'<li><a href=""><em class="img-box"><img src="https://www.yuanfengtest.com/image.php/shop/data/upload/media/6fc0625bf097e245fa1c1007bf528b2d/10011/9/image/20181126/1543234654592148.jpg!360x64.jpg" alt=""></em><span>科力邦 垃圾桶</span></a></li></ul></div></div>';
				    }
					html = '<div nctype="special_item" class="special-item goods '+ (item_data.mb_tpl_layout_enable == 1 ? 'usable' : 'unusable') +'" data-item-id="' + item_data.mb_tpl_layout_id + '">' +
...
<script type="text/javascript">
    $(document).ready(function(){
        $('#btn_mb_special_goods_search').on('click', function() {
            var url = '<?= Yf_Registry::get('url') ?>?act=wx_special&op=goods_list';
