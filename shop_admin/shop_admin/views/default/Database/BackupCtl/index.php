...
<div class="wrapper page">
    ...
    <div class="cf mod-search">
		<div class="fr"><a href="javascript:void(0)" class="ui-btn ui-btn-sp mrb" id="btn-backup"><?= __('一键备份'); ?><i class="iconfont icon-beifen"></i></a><a href="javascript:void(0)" class="ui-btn ui-btn-sp" id="btn-refresh"><?= __('刷新'); ?><i class="iconfont icon-btn01"></i></a></div>
    </div>
    <div class="grid-wrap">
            <table id="grid">
            </table>
