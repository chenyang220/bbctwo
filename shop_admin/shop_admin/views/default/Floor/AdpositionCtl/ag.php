...
<form id="form" method="post">
    ...
    <div class="tips"><i class="iconfont">&#xe65e;</i><?= __('请上传宽度'); ?><?php echo $data["width"] ?><?= __('像素、高度'); ?><?php echo $data["height"] ?><?= __('像素的图片，过大或过小的图像都将影响显示效果正常'); ?></div>
        <?php
    ...
    <table class="form-table-style">
        ...
        <tr>
            <th colspan="2"><em>*</em><?= __('广告图片上传：'); ?></th>
        </tr>
        ...
        <tr>
            ...
            <td colspan="4">
                        ...
                        <div id="filePicker" class="image-line iblock"><?= __('选择文件'); ?></div>
        ...
        <tr>    
            <td class="foot" colspan="2"><input type="submit" value="<?= __('保存'); ?>" /></td>
        </tr>
    </table>
    ...
    <table class="form-table-style">
        ...
        <tr>
            ...
            <td colspan="4">
                        ...
                        <div id="filePicker" class="image-line upload-image"><?= __('选择文件'); ?></div>
...
$('#form').validate({
	...
	messages : {
		pic_url : {
			required : icon + '<?= __('请上传广告图片'); ?>'
		}
	},
    fields: {
        'item_img_url':'required;' ,
