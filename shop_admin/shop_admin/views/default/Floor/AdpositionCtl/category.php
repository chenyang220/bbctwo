...
<form id="form" method="post">
    ...
    <table class="form-table-style frame-table-style">
       ...
       <?php    
        ...
        <tr>
            <td><input type="text" class="text" name="item_name[]" value="" maxlength="4"/></td>
         ...
         <tr>
            <td><input type="text" class="text" name="item_name[]" value="<?php echo $vals['item_name'] ?>" maxlength="4"/></td>
