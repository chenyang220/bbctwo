...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a href="index.php?ctl=Goods_Brand&met=brand" class="current"><?= __('管理'); ?></a></li>
                <li><a href="index.php?ctl=Goods_Brand&met=brands"><?= __('待审核'); ?></a></li> -->
            </ul>
        </div>
    </div>
	...
	<div class="mod-search cf">
		...
		<div class="fr">
<!--            <a href="#" class="ui-btn mrb" id="btn-batchDel"><?= __('删除'); ?><i class="iconfont icon-btn02"></i></a>-->
            <a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add"><?= __('新增'); ?><i class="iconfont icon-btn03"></i></a>
            <!--<a href="#" class="ui-btn mrb" id="btn-print"><?= __('打印'); ?></a>-->
