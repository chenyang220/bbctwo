...
<div class="container fix p20">
	<div class="mod-search m0 cf">
		<div class="fl">
			<ul class="ul-inline">
				<!--<li>
					<input type="text" id="matchCon" class="ui-input ui-input-ph" value="<?= __('输入编号'); ?> / <?= __('名称'); ?> / <?= __('联系人'); ?> / <?= __('电话查询'); ?>">
				</li>
				<li> <a class="ui-btn" id="search"><?= __('查询'); ?><i class="iconfont icon-btn02"></i></a><a class="ui-btn" id="refresh"><?= __('刷新'); ?></a></li>-->
			</ul>
		</div>
	</div>
