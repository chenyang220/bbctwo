    	...
    	<form id="manage-form" action="">
    		<ul class="mod-form-rows base-form cf" id="base-form">
    			<li class="row-item odd">
    				<div class="label-wrap"><label for="brand_name"><?= __('品牌名称'); ?></label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="brand_name" id="brand_name"></div>
    			</li>
    			<!--<li class="row-item">
    				<div class="label-wrap"><label for="brand_initial"><?= __('品牌首字母'); ?></label></div>
    				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="brand_initial" id="brand_initial"></div>
    			</li>-->

<!--    			<li class="row-item">-->
<!--    				<div class="label-wrap"><label for="cat_name">--><?//= __('所属分类'); ?><!--</label></div>-->
<!--    				<div class="ctn-wrap"><input style='height: 50px;' type="text" value="" class="ui-input" name="cat_name" id="cat_name"></div>-->
<!--    			</li>-->

    			<li class="row-item odd">
    			    <div class="label-wrap"><label for="brand_show_type"><?= __('展现形式'); ?></label></div>
    				<dd class="opt">
                        <div class="onoff">
                            <label for="brand_show_type1" class="cb-enable  "><?= __('文字'); ?></label>
                            <label for="brand_show_type0" class="cb-disable  selected"><?= __('图片'); ?></label>
    			...
    			<li class="row-item ">
    			    <div class="label-wrap"><label for="brand_recommend"><?= __('是否推荐'); ?></label></div>
    				<dd class="opt">
                        <div class="onoff">
                            <label for="brand_recommend1" class="cb-enable  "><?= __('是'); ?></label>
                            <label for="brand_recommend0" class="cb-disable  selected"><?= __('否'); ?></label>
    			...
    			<li class="row-item wp100">
    				<div class="label-wrap"><label for="brand_displayorder"><?= __('排序'); ?></label></div>
    			...
    			<li class="row-item wp100">
    				<div class="label-wrap"><label for="brand_image"><?= __('图片标识'); ?></label></div>
    				<div class="ctn-wrap" >
                        <img id="brand_image" name="setting[brand_logo]" alt="<?= __('选择图片'); ?>" src="./shop_admin/static/common/images/image.png" class="image-line w200" />
                        <div class="image-line" style="margin-left: 80px;" id="brand_upload"><?= __('上传图片'); ?><i class="iconfont icon-tupianshangchuan"></i></div>
