    ...
    <div class="wrapper">
        <div class="mod-search cf">
            <div class="fl">
                <ul class="ul-inline">
                    <li>
                        <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" placeholder="<?= __('按品牌名称'); ?>" value="">
                    </li>
                    <li>
            ...
            <div class="fr"><a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add"><?= __('新增'); ?><i class="iconfont icon-btn03"></i></a><!--<a href="#" class="ui-btn mrb" id="btn-print"><?= __('打印'); ?></a>--><a href="javascript:void(0)" class="ui-btn mrb" id="export"><?= __('导出'); ?><i class="iconfont icon-btn04"></i></a><!--<a href="#" class="ui-btn" id="btn-batchDel"><?= __('删除'); ?></a>--><a class="ui-btn" id="audit"><?= __('审核'); ?><i class="iconfont icon-shenhe"></i></a></div>
        </div>
        <div class="grid-wrap">
            <table id="grid">
            </table>
