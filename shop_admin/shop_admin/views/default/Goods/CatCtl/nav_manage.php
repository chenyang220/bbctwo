...
?>
        ...
        <dl class="row">
			...
			<dd class="opt">
                ...
                <div class="image-line" style="margin-left: 10px;" id="adv_upload"><?= __('上传图片'); ?><i class="iconfont icon-tupianshangchuan"></i></div>
        ...
        <dl class="row">
			...
			<dd class="opt">
                ...
                <div class="image-line" style="margin-left: 10px;" id="advs_upload"><?= __('上传图片'); ?><i class="iconfont icon-tupianshangchuan"></i></div>
