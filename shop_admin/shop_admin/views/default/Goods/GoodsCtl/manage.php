...
<body class="<?=$skin?>">
                ...
                <form method="post" name="manage-form" id="manage-form" action="<?= Yf_Registry::get('url') ?>?act=goods&amp;op=goods_lockup">
                    ...
                    <div class="ncap-form-default">
                        <dl class="row">
                            <dt class="tit"><?= __('违规商品货号'); ?></dt>
                            <dd class="opt" id="common_id"></dd>
                        </dl>
                        <dl class="row">
                            <dt class="tit"><?= __('违规商品名称'); ?></dt>
                            <dd class="opt" id="common_name"></dd>
                        </dl>
                        <dl class="row">
                            <dt class="tit">
                                <label for="close_reason"><?= __('违规下架理由'); ?></label>
                            </dt>
                            <dd class="opt">
                                <textarea rows="6" class="ui-input"  name="common_state_remark" id="common_state_remark"></textarea>
                            </dd>
                        </dl>
                    </div>
                </form>
