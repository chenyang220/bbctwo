...
<form method="post" name="manage-form" id="manage-form" action="">
    <div class="ncap-form-default">
        <dl class="row">
            <dt class="tit">
                <label class="property_name" for="property_name"><em>*</em><?= __('属性名称'); ?></label>
            </dt>
            <dd class="opt">
        ...
        <dl class="row">
            <dt class="tit">
                <label><?= __('是否被搜索'); ?></label>
            </dt>
            <dd class="opt">
                <div class="onoff">
                    <label for="property_is_search1" class="cb-enable  "><?= __('是'); ?></label>
                    <label for="property_is_search0" class="cb-disable  selected"><?= __('否'); ?></label>
