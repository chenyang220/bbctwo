	...
	<div class="js-main-region">
  	...
  	<div class="modal-body" id="image-list">
		    ...
		    <div class="attachment-list-region js-attachment-list-region">
	            ...
	            <a href="javascript:;" class="ui-btn ui-btn-success js-show-upload-view" style="position: absolute; left: 180px; bottom: 16px;"><?= __('上传图片'); ?><i class="iconfont icon-tupianshangchuan"></i></a>
            </div>
    ...
    <div class="local-image-region">
        ...
        <div class="content">
            ...
            <div class="c-gray" style="clear: both; padding-top: 20px;">
               	 <?= __('支持'); ?>jpg<?= __('、'); ?>gif<?= __('、'); ?>png<?= __('、'); ?>jpeg<?= __('、'); ?>bmp<?= __('五种格式'); ?>, <?= __('大小不超过'); ?>2 MB
            </div>
        </div>
    </div>
</div>
