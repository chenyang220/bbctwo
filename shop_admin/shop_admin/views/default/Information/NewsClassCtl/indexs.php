...
?>
        ...
        <div class="fixed-bar">
            <div class="item-title">
                ...
                <ul class="tab-base nc-row">
                    ...
                    ?>
                    <!-- <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Class&met=indexs" class="current" ><span><?= __('分类管理'); ?></span></a></li> -->
                </ul>
            </div>
        </div>
        <!-- <?= __('操作说明'); ?> -->
    ...
    <script type="text/javascript" src="<?= $this->view->js ?>/controllers/Information/newsclass/newsclass_list.js" charset="utf-8"></script>
