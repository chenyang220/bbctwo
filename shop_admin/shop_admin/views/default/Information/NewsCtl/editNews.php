...
<form id="article_form" method="post">
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="" name="title" id="title" class="ui-input" value="<?= $value["title"] ?>" maxlength="30">
      ...
      <dl class="row">
        ...
        <dd class="opt">
            <input type="text" value="" name="subtitle" id="subtitle" class="ui-input" value="<?= $value["subtitle"] ?>" maxlength="30"> <span class="err"><?= __('最多30个字数'); ?></span>
            <p class="notic"></p>
        </dd>
      </dl>
      <dl class="row">
