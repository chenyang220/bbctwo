...
?>
        ...
        <div class="mod-toolbar-top cf">
            <div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        <li>
                            <input type="text" id="matchCon" class="ui-input ui-input-ph matchCon" placeholder="<?= __('输入咨询名称'); ?>" value="">
                        </li>
                        <li>
                            <span id="source"></span>
                        </li>
            ...
            <div class="fr">
                <a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add"><?= __('新增平台资讯'); ?><i class="iconfont icon-btn03"></i></a><a class="ui-btn" id="btn-refresh"><?= __('刷新'); ?><i class="iconfont icon-btn01"></i></a>
    ...
    <script type="text/javascript" src="<?= $this->view->js ?>/controllers/Information/news/information_list.js" charset="utf-8"></script>
<?php
