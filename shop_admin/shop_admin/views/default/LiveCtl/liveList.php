    ...
    <div class="mod-search cf" id="report-search">
        <div class="l" id="filter-menu">
            <ul class="ul-inline fix">
                <li>
                    <select id="shop_state" class="head-select-box">
                      <option value="1"><?= __('店主账号'); ?></option>
                      <option value="2"><?= __('店铺名称'); ?></option>
                    </select>
                </li>
                <li>
                    <input type="text" id="shop_info" name="shop_info" class="ui-input ui-input-ph" placeholder="<?= __('请输入'); ?>" autocomplete="off">
                </li>
                <li>
                    <select id="live_status" class="head-select-box">
                      <option value=""><?= __('请选择审核状态'); ?></option>
                      <option value="1"><?= __('待审核'); ?></option>
                      <option value="2"><?= __('已通过'); ?></option>
                      <option value="3"><?= __('未通过'); ?></option>
                    </select>
                </li>
                <li>
                    <span><?= __('申请时间'); ?></span>
                    <input id="live_start" class="ui-input ui-datepicker-input" type="text" readonly placeholder="<?= __('开始日期'); ?>"/>
                    <?= __('至'); ?>
                    <input id="live_end" class="ui-input  ui-datepicker-input" type="text" readonly placeholder="<?= __('结束日期'); ?>"/>
                </li>
...
<script src="<?= Yf_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/liveList.js"></script>
<?php
