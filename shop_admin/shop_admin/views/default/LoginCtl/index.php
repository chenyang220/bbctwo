...
<body style="width:100%;height:100%;">
	...
	<div class="center-content">
		<div class="login-area">
			<div class="top">
				<!--<h5 class="shadow"><?= __('线下下单系统'); ?><em></em></h5>-->
				<h2 class="shadow"><?= __('商城系统'); ?></h2>
				<!-- <h6><?= __('请立即注册'); ?> <?= __('或是'); ?> <?= __('找回密码？'); ?></h6>-->
			</div>
			<div class="box">
				<form id="form1">
								<span>
								...
								<span class="cf">
									<input type="text" name="yzm" class="input-code text3" autocomplete="off" title="<?= __('验证码为'); ?>4<?= __('个字符'); ?>"
										   maxlength="4" placeholder="<?= __('输入验证码'); ?>" id="captcha-input" tabindex="3">
								...
								<span>
									<input type="submit" value="<?= __('登录'); ?>" class="input-button" name="">
								</span>
				<!-- <span>
					<a class="ml15 shadow" href="/forget-password/"><?= __('忘记密码？'); ?></a>
					<a class="ml5 shadow" href="/register/"><?= __('新用户注册'); ?></a>
				</span> -->
					</form>
				<div class="tip" style="display: none;">
					<div class="relative">
						<div class="tip-area">
							<h5><span class="icon"></span><?= __('提示'); ?></h5>
							<div class="tip-cont"></div>
							<div class="clearfix"><a href="javascript:;" class="btn-sure"><?= __('确定'); ?></a></div>
