    ...
    <form method="post" enctype="multipart/form-data" id="tpl-edit-form" name="form">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <img id="waybill_tpl_image_image" name="waybill_tpl_image_image" alt="<?= __('选择图片'); ?>" src="<?=$data['waybill_tpl_image']?>" width="120px" height="60px" />
                ...
                <dd class="opt">
                    <ul class="nofloat">
						...
						<div class="onoff" id="waybill_tpl_enable">
								<label title="<?= __('开启'); ?>" class="cb-enable <?=($data['waybill_tpl_enable']==1 ? 'selected' : '')?>" for="waybill_tpl_enable_enable"><?= __('开启'); ?></label>
								<label title="<?= __('关闭'); ?>" class="cb-disable <?=($data['waybill_tpl_enable']==0 ? 'selected' : '')?>" for="waybill_tpl_enable_disabled"><?= __('关闭'); ?></label>
