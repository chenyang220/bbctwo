...
<div class="wrapper page">
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <div class="mod-toolbar-top cf">
			<div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        ...
                        <li>
                            <input type="text" id="waybill_tpl_name" class="ui-input ui-input-ph con" placeholder="<?= __('请输入模板名称'); ?>">
                        </li>
            ...
            <div class="fr">
				<a class="ui-btn ui-btn-sp" id="btn-add" style="margin-right:10px;"><?= __('新增'); ?><i class="iconfont icon-btn03"></i></a><a class="ui-btn ui-btn-sp" id="btn-refresh"><?= __('刷新'); ?><i class="iconfont icon-btn01"></i></a>
