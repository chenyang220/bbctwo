  ...
  <div class="mod-search cf" id="report-search">
    <div class="l" id="filter-menu">
      <ul class="ul-inline fix">
        <li>
          <input type="text" id="user_name" name="user_name" class="ui-input ui-input-ph" placeholder="<?= __('输入用户名'); ?>"   autocomplete="off" >
        </li>
        <li>
          <span id="sns_verify">
            <select id="explore_verify" style="padding: 5px;width: 120px;height: 30px;">
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/Mb/community/explore_list.js" charset="utf-8"></script>
<?php
