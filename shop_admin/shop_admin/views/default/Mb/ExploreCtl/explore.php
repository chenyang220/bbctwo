        ...
        <div class="mod-toolbar-top cf">
            <div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        <li>
                            <input type="text" id="exploreName" class="ui-input ui-input-ph con" value="<?= __('举报人'); ?>...">
                        </li>
                        <li>
                            <input type="text" id="exploreTitle" class="ui-input ui-input-ph con" value="<?= __('被举报心得标题'); ?>...">
                        </li>
                        <li>
                            <span id="reason"></span>
                        </li>
...
<script src="<?=$this->view->js?>/controllers/Mb/explore/explore_list.js"></script>
<?php
