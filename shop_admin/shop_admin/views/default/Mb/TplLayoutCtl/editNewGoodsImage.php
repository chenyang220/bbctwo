            ...
            <form id="form_image" action="">
                <div class="ncap-form-default">
                    <dl class="row">
                        ...
                        <dd class="opt">
                             <input id="goods_title" type="text" class="txt w200 marginright marginbot vatop" > 
                        </dd>
                    </dl>
                    <dl class="row">
                        <dt class="tit"><?= __('商品描述：'); ?></dt>
                        <dd class="opt">
                             <input id="goods_describe" type="text" class="txt w200 marginright marginbot vatop" > 
                        </dd>
                    </dl>
                    <dl class="row">
...
<script>
    $(function() {
        ...
        if ( dialog_type ) {
            if ( layout_data ) {
                $("#goods_title").val(layout_data.goods_title);
                $("#goods_describe").val(layout_data.goods_describe);
        ...
        api.button({
            ...
            {
                img_data.goods_title = $('#goods_title').val();
                img_data.goods_describe = $('#goods_describe').val();
