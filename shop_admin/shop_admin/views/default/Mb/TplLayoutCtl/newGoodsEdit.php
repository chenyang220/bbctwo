...
?>
<link href="<?= $this->view->css ?>/mb.css?v=9" rel="stylesheet" type="text/css">
<link href="<?= $this->view->css ?>/add.css?v=71" rel="stylesheet" type="text/css">

<div class="mb-item-edit-content">
    <div class="index_block goods-list">
        <div class="title">
            <h5><?= __('标题：'); ?></h5>
            <input id="new_goods_title" type="text" class="txt w200" maxlength="8" name="item_data[title]" value="">
        </div>
        <div class="industry-module clearfix fresh-module-new">
		   <dl>
			   <dt>
				<strong id="classify1_goods_title" class="block"><?= __('品牌'); ?></strong><span id="classify1_goods_describe"><?= __('品牌'); ?></span>
				<a class="btn-fresh-edit" nctype="btn_edit_item_image" data-name="classify1" data-desc="320*130" href="javascript:;"><i class="fa fa-pencil-square-o"></i><?= __('编辑'); ?></a>
			   </dt>
			   <dd>
				   <div nctype="item_image" class="img-box w100">
						   <img nctype="image" name="item_data[classify1_image_1]" src="<?= $this->view->img_com ?>/image.png" alt="" class="img">
				   </div>
				   <div nctype="item_image" class="img-box w100"> 
						   <img nctype="image" name="item_data[classify1_image_2]" src="<?= $this->view->img_com ?>/image.png" alt="" class="img">
				   </div>
			   </dd>
		   ...
		   <dl>
			   <dt>
				   <strong id="classify2_goods_title" class="block"><?= __('品牌'); ?></strong><span id="classify2_goods_describee"><?= __('品牌'); ?></span>
				   <a class="btn-fresh-edit" nctype="btn_edit_item_image" data-name="classify2" data-desc="320*130" href="javascript:;"><i class="fa fa-pencil-square-o"></i><?= __('编辑'); ?></a>
			   </dt>
			   <dd>
				   <div nctype="item_image" class="img-box w100">
						   <img nctype="image" name="item_data[classify2_image_1]" src="<?= $this->view->img_com ?>/image.png" alt="" class="img">
				   </div>
				   <div nctype="item_image" class="img-box w100"> 
						   <img nctype="image" name="item_data[classify2_image_2]" src="<?= $this->view->img_com ?>/image.png" alt="" class="img">
				   </div>
			   </dd>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (typeof layout_data == "undefined" || layout_data == null || layout_data.length == 0) {
            ...
            $('#new_goods_title').val(item_data.mb_tpl_layout_title);
            var goods_html = new String();
            if (layout_data.goods_ids) {
        ...
        $('[nctype="btn_edit_item_image"]').on('click', function () {
            ...
            $.dialog({
                title: '<?= __('编辑'); ?>',
                content: 'url:' + SITE_URL + '?ctl=Mb_TplLayout&met=editNewGoodsImage&typ=e',
                max: true,
                min: false,
                cache: false,
                lock: true,
                ...
                data: {
                    ...
                    image_name: name,
                    dialog_type: 'newGoods',
                    layout_data: layout_data[name],
        ...
        function render (img_data, name) {
            var img_group = {};
            img_group.goods_title = img_data.goods_title;
            img_group.goods_describe = img_data.goods_describe;
            ...
            $("#" + name + "_goods_title").html(img_data.goods_title);
            $("#" + name + "_goods_describe").html(img_data.goods_describe);
        ...
        function postData() {
            var layout_title = $('#new_goods_title').val();
            if(!layout_title){
                parent.Public.tips({
                    type: 1,
                    content: '标题不能为空'
