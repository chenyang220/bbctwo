...
<div class="wrapper page">
    ...
    <form method="post" enctype="multipart/form-data" id="setting-mobile_wx" name="form" class="nice-validator n-yellow" novalidate="novalidate">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label><?= __('微信二维码图片'); ?></label>
                </dt>
                <dd class="opt">
                    <img id="mobile_wx" name="mobile_wx" alt="<?= __('选择图片'); ?>" src="http://127.0.0.1/yf_shop_admin/shop_admin/static/default/images/default_user_portrait.gif">

                    <div class="image-line upload-image" style="height: 32px !important;" id="mobile_wx_upload"><?= __('上传图片'); ?></div>
