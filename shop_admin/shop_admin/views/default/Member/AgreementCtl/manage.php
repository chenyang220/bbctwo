...
<form id="article_form" method="post">
    <div class="ncap-form-default">
      <dl class="row">
        <dt class="tit">
          <label for="member_agreement_title"><em>*</em><?= __('标题'); ?></label>
        </dt>
        <dd class="opt">
      ...
      <dl class="row">
        <dt class="tit"><?= __('图片上传'); ?></dt>
        <dd class="opt">
            <img id="member_agreement_image" name="setting[member_agreement_logo]" alt="<?= __('选择图片'); ?>" src="" class="image-line" />
            <div class="image-line"  id="member_agreement_upload"><?= __('上传图片'); ?><i class="iconfont icon-tupianshangchuan"></i></div>
