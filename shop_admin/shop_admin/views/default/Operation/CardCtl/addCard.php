...
<body class="<?=$skin?>">
    <form method="post" id="manage-form" name="settingForm">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit"><?= __('相关内容'); ?></dt>
                <dd class="opt">
                    <ul class="nofloat">
                        <li>
							<span>
								<?= __('总数：'); ?><input id="card_num" name="card_num" class="ui-input w20"/>
								<?= __('前缀：'); ?><input id="card_id" name="card_id" class="ui-input w100"/>
							</span>
                        </li>
                    </ul>
                </dd>
	    ...
	    <dl class="row">
			...
			<dl class="row">
                <dt class="tit"><?= __('图片'); ?></dt>
                <dd class="opt">
                    <ul class="nofloat">
                        <li>
								<img id="setting_card_image" alt="<?= __('选择图片'); ?>" src="" class="image-line" />
								<div class="image-line" style="margin-left: 10px;" id="setting_image_upload"><?= __('上传图片'); ?><i class="iconfont icon-tupianshangchuan"></i></div>
