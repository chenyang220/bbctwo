	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
                ...
                ?>
				<!-- <li><a <?php if($data['tab']=="join"){ echo "class='current'";}else{?> href="<?= Yf_Registry::get('url') ?>/?ctl=Operation_Contract&met=log&log=join" <?php } ?>><span><?= __('服务加入申请'); ?></span></a></li>
				<li><a <?php if($data['tab']=="quit"){ echo "class='current'";}else{?> href="<?= Yf_Registry::get('url') ?>/?ctl=Operation_Contract&met=log&log=quit" <?php } ?>><span><?= __('服务退出申请'); ?></span></a></li>
				<li><a href="<?= Yf_Registry::get('url') ?>/?ctl=Operation_Contract&met=service"><span><?= __('店铺保障服务'); ?></span></a></li>
				<li><a href="<?= Yf_Registry::get('url') ?>/?ctl=Operation_Contract&met=type"><span><?= __('保障服务管理'); ?></span></a></li> -->
			</ul>
		</div>
	</div>
	<!-- <?= __('操作说明'); ?> -->
        ...
        <div class="mod-toolbar-top cf">
			<div class="left">
				<div id="assisting-category-select" class="ui-tab-select">
					<ul class="ul-inline">
						<li>
							<input type="text" id="shopName" class="ui-input ui-input-ph con" placeholder="<?= __('店铺名称'); ?>">
						</li>
