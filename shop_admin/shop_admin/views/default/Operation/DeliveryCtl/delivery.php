	...
	<div class="fixed-bar">
		<div class="item-title">
			...
			<ul class="tab-base nc-row">
                ...
                ?>
				<!-- <li><a <?php if($data['tab']=="manage"){ echo "class='current'";}else{?> href="<?= Yf_Registry::get('url') ?>/?ctl=Operation_Delivery&met=delivery" <?php } ?>><span><?= __('管理'); ?></span></a></li>
				<li><a <?php if($data['tab']=="check"){ echo "class='current'";}else{?> href="<?= Yf_Registry::get('url') ?>/?ctl=Operation_Delivery&met=delivery&dtyp=check" <?php } ?>><span><?= __('等待审核'); ?></span></a></li> -->
			</ul>
		</div>
	</div>
	<!-- <?= __('操作说明'); ?> -->
        ...
        <div class="mod-toolbar-top cf">
			<div class="left">
				<div id="assisting-category-select" class="ui-tab-select">
					<ul class="ul-inline">
						<li>
							<input type="text" id="user_account" class="ui-input ui-input-ph con" placeholder="<?= __('用户名'); ?>">
						</li>
						<li>
							<input type="text" id="delivery_real_name" class="ui-input ui-input-ph con" placeholder="<?= __('真实姓名'); ?>">
						</li>
						<li>
							<input type="text" id="delivery_name" class="ui-input ui-input-ph con" placeholder="<?= __('服务站名称'); ?>">
						</li>
