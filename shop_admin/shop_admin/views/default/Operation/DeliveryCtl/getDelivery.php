	    ...
	    <dl class="row">
					...
					<ul class="nofloat">
						<li>
							<div class="onoff" id="contract_type_state">
								<label title="<?= __('开启'); ?>" class="cb-enable <?=($data['delivery_state_etext']=='open' ? 'selected' : '')?> " for="contract_state_enable"><?= __('开启'); ?></label>
								<label title="<?= __('关闭'); ?>" class="cb-disable <?=($data['delivery_state_etext']=='close' ? 'selected' : '')?>" for="contract_state_disabled"><?= __('关闭'); ?></label>
			...
			<dl class="row">
				...
				<dd class="opt">
					<ul class="nofloat">
						<li>
								<input type="radio" name="delivery_check_state" value="1" <?php if($data['delivery_check_state_etext']=='passin'){ echo 'checked="true"';}?>> <?= __('审核中'); ?>
								<input type="radio" name="delivery_check_state" value="2" <?php if($data['delivery_check_state_etext']=='pass'){ echo 'checked="true"';}?>> <?= __('审核通过'); ?>
								<input type="radio" name="delivery_check_state" value="3" <?php if($data['delivery_check_state_etext']=='unpass'){ echo 'checked="true"';}?>> <?= __('审核不通过'); ?>
						</li>
					</ul>
				</dd>
			</dl>
