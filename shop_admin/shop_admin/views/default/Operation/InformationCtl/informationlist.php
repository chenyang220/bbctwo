...
?>
    ...
    <div class="wrapper page">
        <div class="fixed-bar">
            <div class="item-title">
                ...
                <ul class="tab-base nc-row">
                    ...
                    ?>
                    <!-- <li><a class="current"><span><?= __('平台客服咨询列表'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Operation_Custom&met=type"><span><?= __('平台咨询类型'); ?></span></a></li> -->
                </ul>
            </div>
        </div>
        <!-- <?= __('操作说明'); ?> -->
        ...
        <div class="mod-toolbar-top cf">
            <div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        <li>
                            <input type="text" id="custom_service_question" class="ui-input ui-input-ph con" placeholder="<?= __('咨询内容'); ?>">
                        </li>
                        <li>
                            <input type="text" id="user_account" class="ui-input ui-input-ph con" placeholder="<?= __('咨询人'); ?>">
                        </li>
            ...
            <div class="fr">
                <a class="ui-btn ui-btn-sp mrb" id="btn-add"><?= __('新增'); ?><i class="iconfont icon-btn03"></i></a><a class="ui-btn ui-btn-sp" id="btn-refresh"><?= __('刷新'); ?><i class="iconfont icon-btn01"></i></a>
            </div>
        </div>
        <div class="grid-wrap">
            <table id="grid">
        ...
        <script src="<?=$this->view->js?>/controllers/operation/information_list.js"></script>
    </div>
