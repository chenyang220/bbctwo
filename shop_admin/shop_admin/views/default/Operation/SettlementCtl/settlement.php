    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a class="current"><span><?= __('结算管理'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
        ...
        <div class="mod-toolbar-top cf">
            <div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        <li>
                            <input type="text" id="settleId" class="ui-input ui-input-ph con" placeholder="<?= __('请输入结算单编号'); ?>...">
                        </li>
                        <li>
                            <input type="text" id="shopName" class="ui-input ui-input-ph con" placeholder="<?= __('请输入商铺名称'); ?>...">
                        </li>
                        <li>
                            <span id="source"></span>
                        </li>
