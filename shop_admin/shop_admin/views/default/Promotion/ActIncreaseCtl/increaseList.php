    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a class="current"><span><?= __('活动列表'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Promotion_ActIncrease&met=increaseQuota"><span><?= __('套餐列表'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=increase&config_type%5B%5D=increase"><span><?= __('设置'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
        ...
        <div class="mod-search cf">
            <div class="fl">
                <ul class="ul-inline">
                    ...
                    <li>
                        <input type="text" id="increase_name" name="increase_name" class="ui-input ui-input-ph matchCon" placeholder="<?= __('活动名称'); ?>">
