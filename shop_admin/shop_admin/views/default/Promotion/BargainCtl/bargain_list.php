        ...
        <div class="mod-search cf">
            <div class="fl">
                <ul class="ul-inline">
                    ...
                    <li>
                        <input type="text" id="goods_name" name="goods_name" class="ui-input ui-input-ph matchCon" placeholder="<?= __('砍价商品名称'); ?>">
...
<script src="<?= Yf_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/bargain/bargain_list.js"></script>
<?php
