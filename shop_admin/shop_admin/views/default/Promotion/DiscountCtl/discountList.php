    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Promotion_Discount&met=discountQuota"><span><?= __('套餐列表'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=discount&config_type%5B%5D=discount"><span><?= __('设置'); ?></span></a></li> -->
        ...
        <div class="mod-search cf">
            <div class="fl">
                <ul class="ul-inline">
                    ...
                    <li>
                         <input type="text" id="discount_name" class="ui-input ui-input-ph matchCon" name="discount_name" placeholder="<?= __('活动名称'); ?>...">
                         <input type="text" id="shop_name" class="ui-input ui-input-ph matchCon" name="shop_name" placeholder="<?= __('店铺名称'); ?>...">
                    </li>
