            ...
            <div class="mod-search cf">
                <div class="fl">
                    <ul class="ul-inline">
                        ...
                        <li>
                            <input type="text" id="groupbuy_name" class="ui-input ui-input-ph matchCon" name="groupbuy_name" placeholder="<?= __('团购名称'); ?>..."> <input type="text" id="goods_name" class="ui-input ui-input-ph matchCon" name="goods_name" placeholder="<?= __('商品名称'); ?>..."> <input type="text" id="shop_name" class="ui-input ui-input-ph matchCon" name="shop_name" placeholder="<?= __('店铺名称'); ?>...">
                        </li>
                        <li>
