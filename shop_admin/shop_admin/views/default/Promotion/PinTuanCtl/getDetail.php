...
?>
    ...
    <div id="manage-wrap" class="manage-wrap">
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit"><?= __('拼团时间段'); ?></dt>
                <dd class="opt"><span id="active_time"></dd>
            </dl>
            <dl class="row">
                <dt class="tit"><?= __('成团人数'); ?></dt>
                <dd class="opt"><span id="person_num"></dd>
            </dl>
            <dl class="row">
                <dt class="tit"><?= __('拼团规则'); ?></dt>
                <dd class="opt">
                    <div class="rule-goods-list">
                        <?php if (! empty($data)) { ?>
                            <?php foreach ($data as $item) { ?>
                                <div class="cou-rule">
                                    <span><?= __('商品名称'); ?>:<strong><?= $item['goods_name']; ?></strong></span>
                                    <span><?= __('拼团库存'); ?>:<strong><?= $item['goods_stock']; ?></strong></span>
                                    <span><?= __('商品原价'); ?>:<strong><?= $item['price_ori']; ?></strong></span>
                                    <span><?= __('单人买价格'); ?>:<strong><?= $item['price_one']; ?></strong></span>
                                    <span><?= __('拼团价格'); ?>:<strong><?= $item['price']; ?></strong></span>
                                </div>
                            <?php } ?>
                        <?php } ?>
                    </div>
