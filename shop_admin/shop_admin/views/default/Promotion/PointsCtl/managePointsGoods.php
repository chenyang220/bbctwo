        ...
        <form id="points_goods_form" action="" method="post">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    &nbsp;<?= __('不限制'); ?><span class="err"></span>
                    <p class="notic"></p>
                </dd>
            </dl>
            <dl class="row" id="limitnum_div" style="display: none;">
                <dt class="tit">
                    <label for="limitnum"> <?= __('每个会员限兑数量'); ?> </label>
                </dt>
                <dd class="opt">
                    <input type="text" name="limitnum" id="limitnum" class="input-txt" value="<?=@$data['points_goods_limitnum']?>" placeholder="<?= __('请填写不大于库存的正整数'); ?>">
                    <p class="notic"></p>
                </dd>
            </dl>
            <!--<dl class="row">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <span class="err"></span>
                    <p class="notic"><?= __('当会员兑换积分商品时，需要达到该级别或者以上级别后才能参与兑换'); ?></p>
                </dd>
            </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="showstate_1" class="cb-enable <?=(@$data['points_goods_shelves'] == 1 ? 'selected' : '')?>"><span><?= __('是'); ?></span></label>
                        <label for="showstate_0" class="cb-disable <?=(@$data['points_goods_shelves'] == 0 ? 'selected' : '')?>"><span><?= __('否'); ?></span></label>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="commendstate_1" class="cb-enable <?=(@$data['points_goods_recommend'] == 1 ? 'selected' : '')?>"><span><?= __('是'); ?></span></label>
                        <label for="commendstate_0" class="cb-disable <?=(@$data['points_goods_recommend'] == 0 ? 'selected' : '')?>"><span><?= __('否'); ?></span></label>
            ...
            <dl class="row" id="forbidreason_div" style="display: none;">
                <dt class="tit">
                    <label for="forbidreason"> <?= __('禁售原因'); ?> </label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="keywords"> <?= __('关键字'); ?> </label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="description"> SEO<?= __('描述'); ?></label>
                </dt>
                <dd class="opt">
            ...
            <div class="bot"><a href="javascript:void(0);" class="ui-btn ui-btn-sp submit-btn" id="submitBtn"><?= __('确认提交'); ?></a></div>
        </form>
    </div>
</div>
   ...
   //限制兑换时间'); ?>
    ...
    $(function(){
        ...
        $('#points_goods_form').validator({
            ...
            debug:true,
            rules: {
                goodsNameMaxLength: [/^[\u4e00-\u9fa5_a-zA-Z0-9_\s]{1,32}$/, "<?= __('礼品名称最长'); ?>32<?= __('个字符'); ?>"],
            },
            fields: {
                // points_goods_name: "required;goodsNameMaxLength",
                points_goods_name: "required;length[3~32]",
            ...
            valid: function(form){
                ...
                if($('#limitnum').val() == parseInt($('#limitnum').val()))
                {
                    ...
                    {
                        parent.parent.Public.tips({type: 1, content: "<?= __('限兑数量有误！'); ?>"});
                        $('#limitnum').val('').focus();
                        return false;
                    }
                }
                ...
                {
                    parent.parent.Public.tips({type: 1, content: "<?= __('限兑数量不能是小数！'); ?>"});
                    $('#limitnum').val('').focus();
                    return false;
                }
