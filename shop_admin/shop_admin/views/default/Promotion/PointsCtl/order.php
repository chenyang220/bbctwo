        ...
        <div class="mod-toolbar-top cf">
            <div class="fl">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        <li>
                            <input type="text" name="points_order_rid" id="points_order_rid" class="ui-input ui-input-ph matchCon" placeholder="<?= __('兑换单号'); ?>...">
                            <input type="text" name="points_buyername" id="points_buyername" class="ui-input ui-input-ph matchCon" placeholder="<?= __('会员名称'); ?>...">
                        </li>
