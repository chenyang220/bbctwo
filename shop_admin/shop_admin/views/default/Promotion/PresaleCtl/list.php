...
?>
            ...
            <div class="mod-search cf">
                <div class="fl">
                    <ul class="ul-inline">
                        ...
                        <li>
                            <input type="text" id="presale_name" name="pintuan_name" class="ui-input ui-input-ph matchCon" placeholder="<?= __('活动名称'); ?>">
    ...
    <script src="<?= Yf_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/presale/presale_list.js"></script>
<?php
