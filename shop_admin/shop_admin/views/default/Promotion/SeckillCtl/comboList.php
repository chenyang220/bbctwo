...
?>
    ...
    <div class="wrapper page">
        ...
        <div class="wrapper">
            <div class="mod-search cf">
                ...
                <div class="fr">
                    <a href="#" class="ui-btn" id="btn-refresh"><?= __('刷新'); ?><i class="iconfont icon-btn01"></i></a>
                </div>
            </div>
    ...
    <script src="<?= Yf_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/seckill/seckill_combo_list.js"></script>
<?php
