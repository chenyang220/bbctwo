...
?>
    ...
    <div class="wrapper page">
        ...
        <div class="wrapper">
            ...
            <input type="hidden" id="type" value="stop">
        </div>
    </div>
    <script src="<?= Yf_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/promotion/sellerwx/sellerwx_list.js"></script>
<?php
