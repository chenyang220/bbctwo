    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a class="current"><span><?= __('店铺代金券'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Promotion_Voucher&met=quota"><span><?= __('套餐列表'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Promotion_Voucher&met=price"><span><?= __('面额设置'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=voucher&config_type%5B%5D=voucher"><span><?= __('设置'); ?></span></a></li> -->
        ...
        <div class="mod-search cf">
            <div class="fl">
                <ul class="ul-inline">
                    ...
                    <li>
                        <input type="text" id="voucher_t_title" name="voucher_t_title" class="ui-input ui-input-ph matchCon" placeholder="<?= __('代金券名称'); ?>">
                        <input type="text" id="shop_name" name="shop_name" class="ui-input ui-input-ph matchCon" placeholder="<?= __('店铺名称'); ?>">
                    </li>
