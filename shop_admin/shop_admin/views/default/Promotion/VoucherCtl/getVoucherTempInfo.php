...
<div class="manage-wrap">
    ...
    <input type="hidden" name="voucher_temp_id" id="voucher_t_id" value="<?=($data['voucher_t_id'])?>">
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <label for="tstate_1"><input type="radio" value="1" class="v_t_state" name="voucher_t_state"  <?=($data['voucher_t_state']==1 ? 'checked' : '')?>><?= __('有效'); ?></label>
                <label for="tstate_2"><input type="radio" value="2" class="v_t_state" name="voucher_t_state"  <?=($data['voucher_t_state']==2 ? 'checked' : '')?>><?= __('失效'); ?></label>
            </dd>
        </dl>
        <dl class="row">
            ...
            <dd class="opt">
                <div class="onoff">
					<label title="<?= __('是'); ?>" class="cb-enable <?=($data['voucher_t_recommend']==1 ? 'selected' : '')?> " for="voucher_t_recommend_enable"><?= __('是'); ?></label>
					<label title="<?= __('否'); ?>" class="cb-disable <?=($data['voucher_t_recommend']==0 ? 'selected' : '')?>" for="voucher_t_recommend_disabled"><?= __('否'); ?></label>
