	...
	<form id="manage-form" action="#">
		 <dl class="row row-item">
		    <dt class="tit" style="width:20%;">
                <em>*</em><label class="voucher_price" for="voucher_price"><?= __('代金券面额'); ?></label>(<?= __('元'); ?>)
            </dt>
         ...
         <dl class="row row-item">
		    <dt class="tit" style="width:20%;">
                <em>*</em><label class="voucher_price_describe" for="voucher_price_describe"><?= __('描述'); ?></label>
            </dt>
            <dd class="opt" style="width:75%;">
        ...
        <dl class="row row-item">
		    <dt class="tit" style="width:20%;">
                <em>*</em><label class="voucher_defaultpoints" for="voucher_defaultpoints"><?= __('兑换积分数'); ?></label>
            </dt>
            <dd class="opt" style="width:75%;">
                <input type="text" value="" class="ui-input" name="voucher_defaultpoints" id="voucher_defaultpoints">
                <span class="err"></span>
                <p class="notic"><?= __('当兑换代金券时，消耗的积分数'); ?></p>
            </dd>
        </dl>
	</form>
</div>
