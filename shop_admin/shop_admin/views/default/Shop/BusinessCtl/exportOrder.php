...
<script>
	...
	$(function(){
        ...
        $("#export").click(function(){
            ...
            window.open(SHOP_URL + "?ctl=Api_Shop_Manage&met=getBusinessrExcel&debug=1&type=0"+query);
            api.close();
        })
        $("#export_all").click(function(){
            ...
            window.open(SHOP_URL + "?ctl=Api_Shop_Manage&met=getBusinessrExcel&debug=1&type=1"+query);
            api.close();
        })
	})
</script>
