...
<body class="<?=$skin?>">
        <form method="post" enctype="multipart/form-data" id="shop_edit_class" name="form1">
         ...
         <div class="ncap-form-default">
              <dl class="row">
                <dt class="tit">
                    <label for="shop_class_name">* <?= __('分类名称'); ?></label>
                </dt>
                <dd class="opt">
             ...
             <dl class="row">
                <dt class="tit">
                    <label for="shop_class_deposit">* <?= __('保证金数'); ?></label>
                </dt>
                <dd class="opt">
             ...
             <dl class="row">
                <dt class="tit">
                    <label for="shop_class_displayorder">*<?= __('排序'); ?></label>
                </dt>
                <dd class="opt">
	...
	$_form.validator({
          ...
          messages: {
            ...
            fields: {
                ...
                'shop_class_deposit':'required;integer[+0];range[0~99999999];' ,
