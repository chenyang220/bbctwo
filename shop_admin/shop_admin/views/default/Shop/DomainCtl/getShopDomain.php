...
<body class="<?=$skin?>">
        ...
        <div class="ncap-form-default">
             ...
             <dl class="row">
                <dt class="tit">
                    <label for="shop_edit_domain">*<?= __('编辑次数'); ?></label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="shop_sub_domain">*<?= __('二级域名'); ?></label>
                </dt>
                <dd class="opt">
                    <input id="shop_sub_domain" name="shop_sub_domain" placeholder="<?= __('请不要带有'); ?>.?&<?= __('等特殊符号'); ?>" value="<?=$value['shop_sub_domain']?>" class="ui-input w200" type="text"/>
                </dd>
