        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
             ...
             <dl class="row">
                ...
                <dd class="opt">
                <div class="onoff">
                        <label for="shop_grade_function_id1" class="cb-enable  "><?= __('开启'); ?></label>
                        <label for="shop_grade_function_id0" class="cb-disable  selected"><?= __('关闭'); ?></label>
             ...
             <dl class="row">
                ...
                <dd class="opt">
                    <select name="shop_grade_sort">
                        <!-- <?= __('写死，就'); ?>TM<?= __('五级'); ?> -->
                        <option value="1"><?= __('一级'); ?></option>
                        <option value="2"><?= __('二级'); ?></option>
                        <option value="3"><?= __('三级'); ?></option>
                        <option value="4"><?= __('四级'); ?></option>
                        <option value="5"><?= __('五级'); ?></option>
                    </select>
                </dd>
