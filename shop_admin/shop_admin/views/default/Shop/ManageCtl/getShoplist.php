        ...
        foreach ($data['base'] as $key => $value) {
            if (!empty($value['shop_company_name']) && $value['shop_business']) {
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
                    ...
                    <tr>
                        <th class="w150"><?= __('营业执照经营范围'); ?></th>
                        <td><?= $value['business_sphere'] ?></td>
                    </tr>
                    <tr>
                        <th><?= __('营业执照'); ?><br/>
                            <?= __('电子版：'); ?>
                ...
                <table border="0" cellpadding="0" cellspacing="0" class="store-joinin">
                    ...
                    <tr>
                        <th><?php if ($value['shop_business']) { ?><?= __('公司'); ?><?php } ?><?= __('银行账号：'); ?></th>
                        ...
                        <?php if ($value['shop_status'] == 1) { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span><?= __('（包括'); ?> <?= __('公司及联系人信息，营业执照信息（副本），组织机构代码证，一般纳税人证明）'); ?></span>
                        ...
                        <?php } else { ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span style="color:gray;"><?= __('（包括'); ?> <?= __('公司及联系人信息，营业执照信息（副本），组织机构代码证，一般纳税人证明）'); ?></span>
