    ...
    <div class="item-title">
      ...
      ?>
		 <!--  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=indexs" ><span><?= __('店铺设置'); ?></span></a></li>
		  <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=join" ><span><?= __('审核开店信息'); ?></span></a></li>
       <li><a  href="<?= Yf_Registry::get('url') ?>?ctl=Shop_Manage&met=pay" ><span><?= __('审核店铺付款'); ?></span></a></li>
