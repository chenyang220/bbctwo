...
<div class="wrapper page">
	...
	<div class="fr">
            <a href="#" class="ui-btn ui-btn-sp mrb" id="btn-setIm" style='display:none;'>IM<?= __('设置'); ?><i class="iconfont icon-btn04"></i></a><a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add"><?= __('新增'); ?><i class="iconfont icon-btn03"></i></a><a class="ui-btn" id="btn-refresh"><?= __('刷新'); ?><i class="iconfont icon-btn01"></i></a>
        </div>
	</div>
