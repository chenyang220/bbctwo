        ...
        <div class="ncap-form-default">
            <dl class="row max-image">
                ...
                <dd class="opt show gpc-upload-input">
                    <img src="../shop_admin/static/common/images/image.png" id="column_image0" alt="<?= __('选择图片'); ?>" class="image-line w100"/>
                    <a href="javascript:;" class="del-img"><?= __('删除'); ?></a>
                    <input id="column_logo0" value="" class="ui-input w400 img-path" type="hidden"/>
                    <p class="notic">建议尺寸：1200*450px</p>
            ...
            <dl class="row min-image">
                ...
                <dd class="opt gpc-upload-input">
                    <img src="../shop_admin/static/common/images/image.png" id="column_image1" alt="<?= __('选择图片'); ?>" class="image-line w100"/>
                    <a href="javascript:;" class="del-img"><?= __('删除'); ?></a>
            ...
            <dl class="row min-image">
                <dt class="tit"></dt>
                <dd class="opt gpc-upload-input">
                    <img src="../shop_admin/static/common/images/image.png" id="column_image2" alt="<?= __('选择图片'); ?>" class="image-line w100"/>
                    <a href="javascript:;" class="del-img"><?= __('删除'); ?></a>
            ...
            <dl class="row min-image">
                <dt class="tit"></dt>
                <dd class="opt gpc-upload-input">
                    <img src="../shop_admin/static/common/images/image.png" id="column_image3" alt="<?= __('选择图片'); ?>" class="image-line w100"/>
                    <a href="javascript:;" class="del-img"><?= __('删除'); ?></a>
            ...
            <dl class="row min-image">
                <dt class="tit"></dt>
                <dd class="opt gpc-upload-input">
                    <img src="../shop_admin/static/common/images/image.png" id="column_image4" alt="<?= __('选择图片'); ?>" class="image-line w100"/>
                    <a href="javascript:;" class="del-img"><?= __('删除'); ?></a>
