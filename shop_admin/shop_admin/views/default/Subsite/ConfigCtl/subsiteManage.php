...
<div class="wrapper">
	<form id="manage-form" action="#">
		<div class="ncap-form-default">
            <dl class="row">
                <dt class="tit">
                    <label for="sub_site_name"><?= __('分站名称'); ?></label>
                </dt>
                <dd class="opt">
                	<input type="hidden" id="subsite_id">
                    <input id="sub_site_name" name="sub_site_name" value="" class="ui-input w346 h27" type="text"/>

                    <p class="notic"><?= __('分站名称，将显示在前台顶部欢迎信息等位置'); ?></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label for="sub_site_logo"><?= __('分站'); ?>logo</label>
                </dt>
                <dd class="opt">
                	<img id="setting_logo_image" name="sub_site_logo" alt="<?= __('选择图片'); ?>" src="" width="150px" height="40px" />

                    <div class="image-line upload-image" id="sub_site_logo_upload"><?= __('上传图片'); ?><i class="iconfont icon-tupianshangchuan"></i></div>
                    <input id="sub_site_logo" name="sub_site_logo" value="" class="ui-input w400" type="hidden"/>

                    <p class="notic"><?= __('分站'); ?>logo,<?= __('通用头部显示，最佳显示尺寸为'); ?>240*60<?= __('像素'); ?></p>
                </dd>
            </dl>
<!--			<dl class="row">
                <dt class="tit">
                    <label for="parent_subsite"><?= __('上级分站'); ?></label>
                </dt>
                <dd class="opt">
                    <input id="parent_subsite" name="parent_subsite" value="" readonly="true" class="ui-input w346 h27" type="text" placeholder="<?= __('没有上级分站'); ?>"/>
					<input type="text" hidden="true" value="" class="ui-input" name="parent_id" id="parent_id">
                    <p class="notic"><?= __('当前分站所属的上级分站'); ?></p>
                </dd>
            </dl>-->
            <dl class="row">
                <dt class="tit">
                    <label for="sub_site_domain"><?= __('分站域名前缀'); ?></label>
                </dt>
                <dd class="opt">
                    <input id="sub_site_domain" name="sub_site_domain" value="" class="ui-input w346 h27" type="text"/>
                    <p class="notic"><?= __('当前分站的域名前缀，'); ?>20<?= __('个字符以内'); ?></p>
                </dd>
            </dl>

<!--            <dl class="row">
                <dt class="tit">
                    <label for="sub_site_template"><?= __('分站模板'); ?></label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="sub_site_des"><?= __('分站描述'); ?></label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="sub_site_copyright"><?= __('分站版权信息'); ?></label>
                </dt>
                <dd class="opt">
			...
			<dl class="row">
                <dt class="tit">
                    <label for="sub_site_web_title">SEO<?= __('标题'); ?></label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="sub_site_web_keyword">SEO<?= __('关键字'); ?></label>
                </dt>
                <dd class="opt">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="sub_site_web_des">SEO<?= __('描述'); ?></label>
                </dt>
                <dd class="opt">
