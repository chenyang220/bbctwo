...
.img_flied img{width: 100px; height: 30px;}
	...
	<div class="wrapper page">
		<div class="fixed-bar">
			<div class="item-title">
				...
				<ul class="tab-base nc-row">
					...
					<li><a class="current"><span><?= __('审核供应商付款'); ?></span></a></li>
		...
		<div class="explanation" id="explanation">
			...
			<ul>
				<li><?= __('点击审核按钮可以对供应商提交的支付凭证和信息进行审核。'); ?></li>
			</ul>
		</div>
        ...
        <div class="mod-toolbar-top cf">
			...
			<div class="fr"><a class="ui-btn" id="btn-refresh"><?= __('刷新'); ?><i class="iconfont icon-btn01"></i></a></div>
		</div>
