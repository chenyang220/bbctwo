    ...
    <div class="item-title">
      <div class="subject">
        ...
        <h5><?= __('店铺的审核续费及经营类目结算周期操作'); ?></h5>
		  ...
		  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Manage&met=indexs" ><span><?= __('店铺设置'); ?></span></a></li>
		  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Manage&met=join" ><span><?= __('审核开店信息'); ?></span></a></li>
                  <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Manage&met=shopPay" ><span><?= __('审核店铺付款'); ?></span></a></li>
                  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Manage&met=reopen" ><span><?= __('续签申请'); ?></span></a></li>
                  <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Supplier_Manage&met=category" ><span><?= __('经营类目申请'); ?></span></a></li>
