...
<body class="<?=$skin?>">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="user_password">* <?= __('登录密码'); ?></label>
                </dt>
                <dd class="opt">
