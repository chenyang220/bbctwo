    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a id="1" href="<?= Yf_Registry::get('url') ?>?ctl=Trade_Complain&met=complain&state=1"><span><?= __('新投诉'); ?></span></a></li>
                <li><a id="2" href="<?= Yf_Registry::get('url') ?>?ctl=Trade_Complain&met=complain&state=2"><span><?= __('待申诉'); ?></span></a></li>
                <li><a id="3" href="<?= Yf_Registry::get('url') ?>?ctl=Trade_Complain&met=complain&state=3"><span><?= __('对话中'); ?></span></a></li>
                <li><a id="4" href="<?= Yf_Registry::get('url') ?>?ctl=Trade_Complain&met=complain&state=4"><span><?= __('待仲裁'); ?></span></a></li>
                <li><a id="5" href="<?= Yf_Registry::get('url') ?>?ctl=Trade_Complain&met=complain&state=5"><span><?= __('已关闭'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Trade_Complain&met=subject"><span><?= __('主题设置'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Trade_Complain&met=setting"><span><?= __('时效设置'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
            ...
            <div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        ...
                        <li>
                            <input type="text" id="search_name" class="ui-input ui-input-ph con" placeholder="<?= __('请输入相关数据'); ?>...">
                        </li>
