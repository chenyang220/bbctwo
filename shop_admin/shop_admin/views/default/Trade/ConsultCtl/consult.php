    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a class="current"><span><?= __('咨询管理'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Trade_Consult&met=type"><span><?= __('类型设置'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=consult&config_type%5B%5D=consult"><span><?= __('头部文字设置'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
        ...
        <div class="mod-toolbar-top cf">
            <div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        <li>
                            <input type="text" id="consult_question" class="ui-input ui-input-ph con" placeholder="<?= __('咨询内容'); ?>...">
                        </li>
                        <li>
                            <input type="text" id="user_account" class="ui-input ui-input-ph con" placeholder="<?= __('咨询人账号'); ?>...">
                        </li>
                        <li>
