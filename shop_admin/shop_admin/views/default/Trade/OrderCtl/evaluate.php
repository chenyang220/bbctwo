...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      ?>
			<!-- <li><a class="current"><span><?= __('来自买家的评价'); ?></span></a></li>
			<li><a href="<?= Yf_Registry::get('url') ?>?ctl=Trade_Order&met=shopevaluate"><span><?= __('店铺动态评价'); ?></span></a></li> -->
		</ul>
    </div>
  </div>
  <!-- <?= __('操作说明'); ?> -->
      ...
      <div class="left">
        <div id="assisting-category-select" class="ui-tab-select">
          <ul class="ul-inline">
            ...
            <li>
              <input type="text" id="member_name" class="ui-input ui-input-ph con" placeholder="<?= __('请输入评价人'); ?>...">
            </li>
            <li>
              <input type="text" id="scores" class="ui-input ui-input-ph con" placeholder="<?= __('评价评分'); ?>...">
            </li>
            <li>
