    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a class="current" href="javascript:void(0)"><span><?= __('商品订单'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
        ...
        <div class="mod-toolbar-top cf">
                ...
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                       <!--  <li><span id="source"></span></li> -->
						<li>
                            <input type="text" id="order_id" class="ui-input ui-input-ph con" placeholder="<?= __('请输入订单编号'); ?>...">
                        </li>
						<li>
                            <input type="text" id="buyer_name" class="ui-input ui-input-ph con" placeholder="<?= __('请输入买家账号'); ?>...">
                        </li>
						<li>
                            <input type="text" id="shop_name" class="ui-input ui-input-ph con" placeholder="<?= __('请输入店铺名称'); ?>...">
                        </li>
                        <li>
                            <input type="text" id="payment_other_number" class="ui-input ui-input-ph con" placeholder="<?= __('请输入支付单号'); ?>...">
                        </li>
                        <li>
                            <label><?= __('付款日期'); ?>:</label>
            ...
            <div class="fr">
             ...
             <div style="float:left;display:inline-block;padding: 0 6px 0 0;line-height: 30px;height: 30px;font-size: 12px;border-radius: 2px;vertical-align: middle;">
                 <ul class="ul-inline">
                     <li><b><?= __('订单总金额：'); ?></b><?= __('￥'); ?> <span class="count_amount" id="totalSums"></span></li>
                     <li><b><?= __('当前页订单总金额：'); ?></b><?= __('￥'); ?> <span class="count_amount" id="totalSum"></span></li>
                 </ul>
            </div>
        </div>
        <div class="grid-wrap">
