...
<div id="manage-wrap" class="manage-wrap">
    <form id="manage-form" action="#">
        <ul class="mod-form-rows">
            ...
            <li class="row-item">
                <div class="label-wrap"><label for="payment_code"><?= __('付款方式'); ?>:</label></div>
                <div class="ctn-wrap"><span id="payment_code"></div><span class="msg-box" for="payment_code"></span>
            </li>
            <li class="row-item">
                <div class="label-wrap"><label for="payment_other_number"><?= __('第三方支付平台交易号'); ?>:</label></div>
