...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a class="current" href="javascript:void(0)"><span><?= __('虚拟订单'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <div class="mod-toolbar-top cf">
                ...
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                       <!--  <li><span id="source"></span></li> -->
                        ...
                        <li>
                            <input type="text" id="payment_number" class="ui-input ui-input-ph con" placeholder="<?= __('请输入支付单号'); ?>...">
                        </li>
                        <li>
                            <label><?= __('付款日期'); ?>:</label>
            ...
            <div class="fr">
                <a class="ui-btn" id="btn-excel" data-action="virtual"><?= __('导出'); ?><i class="iconfont icon-btn04"></i></a>
