...
<body class="<?=$skin?>">
    <form method="post" id="manage-form" name="settingForm">
        ...
        <div class="ncap-form-default">
			<dl class="row">
                <dt class="tit"><?= __('处理结果'); ?></dt>
                <dd class="opt">
                    <ul class="nofloat">
                        <li>
							<div class="onoff">
								<label title="<?= __('通过'); ?>" class="cb-enable selected" for="report_pass"><?= __('通过'); ?></label>
								<label title="<?= __('不通过'); ?>" class="cb-disable" for="report_unpass"><?= __('不通过'); ?></label>
            ...
            <dl class="row">
                <dt class="tit"><?= __('备注'); ?></dt>
                <dd class="opt">
                    <ul class="nofloat">
						<li>
							<textarea id="report_handle_message" name="report_handle_message" class="ui-input"></textarea>
						</li>
                    </ul>
                </dd>
            </dl>
