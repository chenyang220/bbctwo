...
?>
    ...
    <div class="wrapper page">
                ...
                <div class="subject">
                    <h3><?php if ($data['return_type'] == 2) { ?>
                        ...
                        <?php } else { ?>
                            <?= __('退款管理'); ?>
                        <?php } ?>
                        - <?= __('“退单编号：'); ?><?= $data['return_code'] ?><?= __('”'); ?></h3>
                    <h5><?= __('商品订单退款申请及审核处理'); ?></h5>
                </div>
            </div>
        </div>
        ...
        <div class="ncap-form-default">
            <dl class="row">
                <dt class="tit"><?= __('买家退款申请'); ?></dt>
            </dl>
            <dl class="row">
                <dt class="tit"><?= __('买家名称'); ?></dt>
                <dd class="opt">
                    <ul class="nofloat">
                        <li>
            ...
            <?php if ($data['return_state_etext'] == "plat_pass") { ?>
                <dl class="row">
                    <dt class="tit"><?= __('平台退款处理'); ?></dt>
                </dl>
                <dl class="row">
                    <dt class="tit"><?= __('平台确认'); ?></dt>
                    <dd class="opt">
                        <ul class="nofloat">
                            <li>
                                <?= __('已完成'); ?>
                ...
                <form method="post" id="handle_finish" action="">
                    ...
                    <dl class="row">
                        ...
                        <dd class="opt">
                            <ul class="nofloat">
                                <li>
                                    <a id="btn_handle_submit" class="ui-btn ui-btn-sp submit-btn" href="javascript:void(0)"><?= __('确认提交'); ?></a>
                                </li>
                            </ul>
                        </dd>
                    </dl>
