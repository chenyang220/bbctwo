...
?>
        ...
        <div class="fixed-bar">
            <div class="item-title">
                ...
                <ul class="tab-base nc-row">
                    ...
                    ?>
                    <!-- <li><a class="current"><span><?= __('标签列表'); ?></span></a></li>                -->
                </ul>
            </div>
        </div>
        <!-- <?= __('操作说明'); ?> -->
    ...
    <script src="<?= Yf_Registry::get('base_url') ?>/shop_admin/static/default/js/controllers/user/account/setAccount.js"></script>
<?php
