...
<div class="wrapper page">
    ...
    <div class="mod-toolbar-top cf mod-search" >
      <div class="fr"><a href="javascript:void(0)" id="btn-add_user" class="ui-btn ui-btn-sp"><?= __('新增同事'); ?></a></div>
      <!-- <div class="fr"><a href="./index.php?ctl=Rights_Group&met=index" class="ui-btn ui-btn-sp" id="btn-add"><?= __('权限组管理'); ?></a></div> -->
