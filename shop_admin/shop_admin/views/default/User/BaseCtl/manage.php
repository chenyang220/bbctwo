...
<div id="manage-wrap" class="manage-wrap">
	<form id="manage-form" action="#">
		<ul class="mod-form-rows">
			<li class="row-item">
				<div class="label-wrap"><label for="user_account"><?= __('用户'); ?>:</label></div>
				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="user_account" id="user_account"></div>
			</li>
			<li class="row-item">
				<div class="label-wrap"><label for="user_password"><?= __('密码'); ?>:</label></div>
				<div class="ctn-wrap"><input type="text" value="" class="ui-input" name="user_password" id="user_password"></div>
			</li>
			<li class="row-item">
				<div class="label-wrap row-salesman"><label for="rights_group_id"><?= __('权限组'); ?>:</label></div>
                <div class="ctn-wrap"><span id="rights_group_id"></span></div>
    		</li>
            <li class="row-item">
				<div class="label-wrap"><label for="subsite_id"><?= __('管理站点'); ?>:</label></div>
                <div class="ctn-wrap"><span id="subsite_id"></span></div>
    		</li>
			<!--<li class="row-item">
				<div class="label-wrap"><label for="user_realname"><?= __('真实姓名'); ?>:</label></div>
