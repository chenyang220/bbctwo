...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
			...
			<ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a class="current"><span><?= __('会员信息'); ?></span></a></li>                -->
            </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <div class="mod-toolbar-top cf">
            ...
            <div class="fr">
                <a class="ui-btn" id="btn-tag"><?= __('打标签'); ?></a>
                <a class="ui-btn" id="btn-redpacket"><?= __('送红包'); ?></a>
                <a class="ui-btn" id="btn-score"><?= __('修改积分'); ?></a>
                <a class="ui-btn" id="btn-level"><?= __('修改会员等级'); ?></a>
