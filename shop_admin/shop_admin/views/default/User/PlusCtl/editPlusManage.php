        ...
        <div class="mod-toolbar-top cf">
            <div class="left">
                <div id="assisting-category-select" class="ui-tab-select">
                    <ul class="ul-inline">
                        <li>
                            <input type="text" id="searchName" class="ui-input ui-input-ph con" value="<?= __('plus会员名称'); ?>">
                        </li>
                        <li>
                            <span id="source"></span>
                        </li>
...
<script type="text/javascript" src="<?=$this->view->js?>/controllers/user/plus/plus_list.js" charset="utf-8"></script>
<?php
