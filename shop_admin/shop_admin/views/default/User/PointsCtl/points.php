    ...
    <div class="fixed-bar">
        <div class="item-title">
			...
			<ul class="tab-base nc-row">
                ...
                ?>
                <!-- <li><a class="current"><span><?= __('积分明细'); ?></span></a></li>
                <li><a href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=points&config_type%5B%5D=points"><span><?= __('规则设置'); ?></span></a></li>
				<li><a href="<?= Yf_Registry::get('url') ?>?ctl=User_Points&met=addPoints"><span><?= __('积分增减'); ?></span></a></li> -->
            </ul>
        </div>
    </div>
    <!-- <?= __('操作说明'); ?> -->
