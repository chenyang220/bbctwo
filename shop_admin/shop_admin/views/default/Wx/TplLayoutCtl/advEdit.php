...
<div class="mb-item-edit-content">
    <div class="index_block adv_list">
        ...
        <a nctype="btn_add_item_image" class="ui-btn ui-btn-sp submit-btn" href="javascript:;" data-dialog_type="add"><?= __('添加新的广告条'); ?></a>
    </div>
</div>
<?php
...
<script id="item_image_template" type="text/html">
    <div nctype="item_image" class="item">
        ...
        <a nctype="btn_edit_item_image" href="javascript:;" style="right: 50px;"><?= __('编辑'); ?></a>
...
<script>
    ...
    $(function() {
        ...
        $('[nctype="btn_add_item_image"]').on('click', function () {
            $.dialog({
                title: '添加',
                content: 'url:' + SITE_URL + '?ctl=Wx_TplLayout&met=editImage&typ=e',
                max: false,
                min: false,
                cache: false,
                lock: true,
