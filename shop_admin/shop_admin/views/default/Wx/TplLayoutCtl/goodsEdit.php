...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        var api = frameElement.api,
            ...
            item_id = item_data.wx_tpl_layout_id,
          ...
          var goods_ids = new Array();
            var relayout = function () {
                ...
                var srcImgDiv = null;
                var index1,index2;
                imgs.off("dragstart",".item").on("dragstart",".item",function () {
                    index1=$(this).index();
                    srcImgDiv = $(this);
                });
                imgs.off("dragover",".item").on("dragover",".item", function (event) {
                    event.preventDefault();
                });
                imgs.off("drop",".item").on("drop",".item", function (event) {
                    var srcImgDiv2 = $(this);
                    index2=$(this).index();
                    var cur1=goods_ids[index1-1];
                    var cur2=goods_ids[index2-1];
                    var ht1=srcImgDiv.html();
                    var ht2=srcImgDiv2.html();
                    goods_ids[index1-1]=cur2;
                    goods_ids[index2-1]=cur1;
                    srcImgDiv2.html(ht1);
                    srcImgDiv.html(ht2);
