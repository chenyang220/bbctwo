...
<form method="post" enctype="multipart/form-data" id="publicmsg_add" name="form1">
    <div class="ncap-form-default">
        <dl class="row">
            ...
            <dd class="opt">
                <input id="words" name="words"   class="ui-input w200" type="text"/>
        ...
        <dl class="row">
            ...
            <dd class="opt">
                <textarea style="width: 450px;height: 200px;" id="content" maxlength="100" name="content"></textarea>
                <p class="notic"></p>
            </dd>
        </dl>
    </div>
    ...
    function postData(t, e)
    {
        ...
        $_form.validator({
            ...
            valid: function (form)
            {
                ...
                params = rowData.id ? { id: e, words: words, match_type: match_type, msg_type:msg_type, content:content } : {
                    words: words, match_type: match_type, msg_type:msg_type, content:content
                };
