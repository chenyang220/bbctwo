...
?>
    ...
    <div class="wrapper page">
        ...
        <div class="mod-search cf">
            <div class="fr">
                <a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add"><?= __('新增微信公众号菜单'); ?><i class="iconfont icon-btn03"></i></a>
                <a href="#" class="ui-btn ui-btn-sp mrb" id="btn-sync"><?= __('同步到微信公众号'); ?><i class="iconfont icon-btn05"></i></a>
            </div>
        </div>
...
?>
<script type="text/javascript" src="<?=$this->view->js?>/controllers/wxpublic/menu.js" charset="utf-8"></script>
