...
?>
    ...
    <div class="wrapper page">
        ...
        <div class="mod-search cf">
            <div class="fr">
                <a href="#" class="ui-btn ui-btn-sp mrb" id="btn-add"><?= __('添加自动回复'); ?><i class="iconfont icon-btn03"></i></a>
            </div>
        </div>
        <div class="grid-wrap">
            <table id="grid">
...
?>
<script type="text/javascript" src="<?=$this->view->js?>/controllers/wxpublic/msg.js" charset="utf-8"></script>
