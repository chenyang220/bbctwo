...
<!--    <link rel="stylesheet" href="//at.alicdn.com/t/font_cgohjwk5bd0io1or.css">-->
   <!--  <link href="<?= $this->view->css ?>/font_cgohjwk5bd0io1or.css" rel="stylesheet"> -->
    <link href="<?= $this->view->css ?>/ui.min.css?ver=811" rel="stylesheet">
    <link href="<?= $this->view->css ?>/common.css?ver=81191" rel="stylesheet" type="text/css">
	<link href="<?= $this->view->css ?>/sass/style.css?ver=8178" rel="stylesheet" type="text/css">
    ...
    <script src="<?= $this->view->js ?>/models/common.js?ver=2011240430"></script>
