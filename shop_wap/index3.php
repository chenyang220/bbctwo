...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/module-style3.css?v=81121111">
...
<div class="bgf">
	...
	<div class="swiper-box">
		<div id="main-container1" class="fz0 ml-20 mr-20"></div>
	</div>
</div>
<div class="nctouch-home-layout relative" id="main-container2"></div>
...
<script type="text/html" id="home3">
    <div>
        ...
        <% } %>
        <div class="layout2 pl-20 pr-20 bgf">
...
<script type="text/html" id="newGoods">
		<div class="bgf">
			<div class="common-tit">
				<h4 class="fz-32"><%= sx_title %></h4>
			</div>
			<div class="guess-like guess-goodsb index-model">
				<div class="index-fresh-module1 clearfix mt-20 ml-20 mr-20 mb-20">
					<% if (data) { %>
						<% for (var i in data) { %>
							<dl>
								<dt>
									<strong class="block"><%= data[i].goods_title %></strong>
									<span class="block"><%= data[i].goods_describe %></span>
								</dt>
								<dd class="clearfix">
									 <a href="<%= data[i].image_type_1 == 'url' ?  data[i].image_data_1 : 'javascript:void(0);' %>">
										<em class="img-box"><img class="wp100" src="<%= data[i].image_1 %>" alt="img"></em>
									</a>
									<a href="<%= data[i].image_type_2 == 'url' ?  data[i].image_data_2 : 'javascript:void(0);' %>">
										<em class="img-box"><img class="wp100" src="<%= data[i].image_2 %>" alt="img"></em>
									</a>
								</dd>
							</dl>
						<% } %>
				...
				<ul class="clearfix mb-10">
					<% if (goods_ids) { %>
						...
						<li><a href="tmpl/product_detail.html?goods_id=<%= goods_ids[i].goods_id %>">
								<em class=img-box>
									<img src="<%= goods_ids[i].goods_image %>"/>
								</em>
								<p><%= goods_ids[i].goods_name %></p></a>
						</li>
...
<script type="text/html" id="activityA">
    ...
    <div class="xs-discount index-model">
        <div class="title-discount clearfix">
            ...
            <!-- <span class="fr"><a class="index-more" href="tmpl/discount_list.html">更多</a></span> -->
        </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <a href="tmpl/product_detail.html?goods_id=<%= content_info[i].goods_id %>">
                            ...
                            <h4 class="more-overflow"><%= content_info[i].goods_name %></h4>
                        ...
                        <div class="time">
                            <div class="time-item iblock fnTimeCountDown"
                                ...
                                <p id="minute_show" class="hour">00</p>:<p id="second_show" class="mini">00</p>:<p id="second_show" class="sec">00</p>
    ...
    <div class="pt-discount index-model">
        <div class="title-discount clearfix">
            ...
            <span class="fr"><a class="index-more" href="tmpl/pintuan_index.html">更多</a></span>
        </div>
...
<script type="text/html" id="advA">
    <div class="shopping fz0 index-model bgf">
        <% if (title) { %>
        <h3 class="title-bg"><p><%= title %></p></h3>
        <% } %>
        <div class="clearfix">
