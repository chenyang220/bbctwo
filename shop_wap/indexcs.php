...
<script type="text/javascript">
    ...
    $(document).ready(function (){
        $("#ee").attr("href","http://www.titianren.site/index.php?token=" + getCookie("token") + "&enterId=0");

        $("#ee1").attr("href", WapSiteUrl + "/tmpl/ceshi.html?token=" + getCookie("token") + "&enterId=0");
    });
</script>
<body class=" bgf">
