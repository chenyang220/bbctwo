$.ajax({
    ...
    success: function(result) {
        if (result.data[0] == 1) {
            ...
            //生鲜模板
            window.location.href = ShopWapUrl + "/index3.html";
        } else {
            //工业模板
            $(function() {
                ...
                $.ajax({
                    url: ApiUrl + "/index.php?ctl=Index&met=index&typ=json&ua=wap&tpl_layout_style=2&sub_site_id="+sub_site_id + "&user_id=" + getCookie('id'),
                    type: 'get',
                    dataType: 'json',
                    success: function(result) {
                        ...
                        var swiper5 = new Swiper('.index-goods-select', {
                              slidesPerView:"5",
                              freeMode: true,
                            });
