...
(function(factory) {
    ...
    defaults = {
        ...
        preferredCountries: [ "cn","us", "gb","mn" ],
   ...
   ********************/
        ...
        _setInitialState: function() {
            ...
            var invoice_area_code = $('#invoice_area_code').val();
            var invoice_area_code1 = $('#invoice_area_code1').val();
                ...
                if (this.options.initialCountry) {
                    ...
                    if(area_code){
                        ...
                        for(var i in this.countries){
                            if(this.countries[i].dialCode==area_code){
                                this.defaultCountry = this.countries[i].iso2;
                                break;
                            }
                        }
                    }else if(invoice_area_code){

                        for(var i in this.countries){
                            if(this.countries[i].dialCode==invoice_area_code){
                                this.defaultCountry = this.countries[i].iso2;
                                break;
                            }
                        }
                    }else if(invoice_area_code1){

                        for(var i in this.countries){
                            if(this.countries[i].dialCode==invoice_area_code1){
                                this.defaultCountry = this.countries[i].iso2;
                                break;
                            }
                        }
        ...
        _setFlag: function(countryCode) {
            ...
            $('#re_user_mobile').attr('data-area_code',this.selectedCountryData.dialCode);
            $('#inv_ele_phone').attr('data-area_code',this.selectedCountryData.dialCode);
            $('#inv_tax_recphone').attr('data-area_code',this.selectedCountryData.dialCode);
            if(this.selectedCountryData.dialCode){
                $('#area_code').val(this.selectedCountryData.dialCode);
                $('#invoice_area_code').val(this.selectedCountryData.dialCode);
                $('#invoice_area_code1').val(this.selectedCountryData.dialCode);
            }
