...
$("#keyword").on("input",function(){
	...
	if(e==""){
		...
		$.getJSON(
			ApiUrl+"/index.php?act=goods&op=auto_complete",
			{term:$("#keyword").val()},
			function(e){
				if(!e.data.error){
					var t=e.data;t.WapSiteUrl=WapSiteUrl;
					if(t.list.length>0){
	...
	$.getJSON(ApiUrl+"/index.php?act=index&op=search_key_list",function(e){
		var t=e.data;t.WapSiteUrl=WapSiteUrl;$("#hot_list_container").html(template.render("hot_list",t));
