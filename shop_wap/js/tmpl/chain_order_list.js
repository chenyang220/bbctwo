...
$(function () {
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/index.php?ctl=Buyer_Order&met=chain&typ=json&typ=json&firstRow=" + curpage+'&shop_id_wap='+shop_id_wap,
    ...
    $("#chain-order-list").on("click", ".cancel-order", function () {
        var e = $(this).attr("order_id");
        $.sDialog({
