        ...
        $(".btn-l").click(function () {
            ...
            $.ajax({
                ...
                success: function (e) {
                    ...
                    if (e.status == 250) {
                        $.sDialog({skin: "red", content: '评价失败！'+e.msg, okBtn: false, cancelBtn: false});
                        return false
                    }
                    // 评价成功后即查看评价
                    if (from == 'chain') {

                        window.location.href = WapSiteUrl + "/tmpl/member/member_evaluation_again.html?from=chain&order_id=" + a; //门店自提订单
                    } else {
