...
function confirm(chain_id,goods_stock,is_delivery)
{
    if(goods_stock == 0){
        $.sDialog({
            skin: "red",
        ...
        window.location.href = WapSiteUrl + '/tmpl/ziti_confirm.html?goods_id=' + goods_id + '&chain_id=' + chain_id + '&is_delivery=' + is_delivery;
    }
