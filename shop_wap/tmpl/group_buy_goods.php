...
<header id="header" class="posf">
    <div class="header-wrap">
        ...
        <ul class="header-nav">
            <li class="cur"><a href="javascript:void(0)" id="productDetail"><?= __('商品'); ?></a></li>
            <li><a href="javascript:void(0)" id="productBody"><?= __('详情'); ?></a></li>
        </ul>
...
<script type="text/html" id="product_detail">
    ...
    <div class="goods-detail-cnt">
        <div class="priceTime clearfix">
            <div class="price">
                <span class="lt"><b><?= __('￥'); ?></b><%= groupbuy_detail.groupbuy_price %></span>
            <span class="rt">
        <span><b><%= groupbuy_detail.groupbuy_virtual_quantity %></b><?= __('件已团购'); ?></span>
            <del><b><?= __('￥'); ?></b><%= groupbuy_detail.goods_price %></del>
            </span>
            </div>
            <div class="time">
                <p class="txt"><?= __('距结束仅剩'); ?></p>
                ...
                <li>
                    <a href="product_detail.html?goods_id=<%= data_foot_recommon_goods[i].goods_id %>">
                        ...
                        <dl>
                            ...
                            <dd><?= __('￥'); ?><em><%= data_foot_recommon_goods[i].common_price %></em></dd>
                        </dl>
                    </a>
                </li>
                <% } %>
