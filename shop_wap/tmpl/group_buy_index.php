...
<header id="header" class="fixed">
    ...
    <div class="integral-wap fixed-Width nctouch-main-layout">
    ...
    <script type="text/html" id="swiper-container-nav">
        <div class="swiper-wrapper">
            ...
            <!--<div class="swiper-slide bor-2"><?= __('全部'); ?></div>-->
            <!--<% if(cat.physical){ %>
    ...
    <script type="text/html" id="swiper-banner">
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <a href="<%= banner[k].live_link %>">
                    <img src="<%= banner[k].slider_image %>">
                </a>
            </div>
            <%}%>
            <%}%>
    ...
    <script type="text/html" id="maskG">
        <div class="title mb-20">
            <a href="group_buy_list.html?groupbuy_type=1" class="fz-30 col2"><?= __('线上团'); ?></a>
        </div>
        ...
        <div class="title mb-20">
            <a href="group_buy_list.html?groupbuy_type=2" class="fz-30 col2"><?= __('虚拟团'); ?></a>
        </div>
        <ul class="list clearfix">
            <% if(cat.virtual){ %>
    ...
    <script type="text/html" id="Group-main">
        <h3 class="tit-style1">
            <a href="group_buy_list.html?groupbuy_type=1"><?= __('线上团'); ?></a><i><?= __('每天整点开抢'); ?></i>
            <span class="more"> <a href="group_buy_list.html?groupbuy_type=1"><?= __('更多'); ?><i class="iconfont icon-iconjiantouyou"></i></a></span>
        </h3>
        ...
        <div class="hot">
            ...
            <div class="content">
                ...
                <div class="num fr"><b><%= goods.physical.highly_recommend.groupbuy_virtual_quantity %></b><?= __('件已付款'); ?></div>
            </div>
            <div class="price clearfix">
                ...
                <div class="con clearfix">
                    <div class="left">
                        <div class="">
                            <b><?= __('￥'); ?></b><%= goods.physical.highly_recommend.groupbuy_price %> <del><%= goods.physical.highly_recommend.goods_price %></del>
                        </div>
            ...
            <ul class="clearfix">
                ...
                <li>
                    ...
                    <div class="content">
                        <!-- <div class="price clearfix"> -->
                            <!--<?= __('原价'); ?>-->
                           <!--  <b><?= __('￥'); ?></b><%= items[i].goods_price %>
                        </div> -->
                        <div class="price clearfix">
                            <b><?= __('￥'); ?></b><%= items[i].groupbuy_price %>
                        </div>
                        
                         <div class="right"><?= __('已售'); ?><b><%= items[i].groupbuy_virtual_quantity %></b></div>
        ...
        <h3 class="tit-style2">
            <a href="group_buy_list.html?groupbuy_type=2"><?= __('虚拟团'); ?></a><i><?= __('每天整点开抢'); ?></i>
            <span class="more"> <a href="group_buy_list.html?groupbuy_type=2"><?= __('更多'); ?><i class="iconfont icon-iconjiantouyou"></i></a></span>
        </h3>
        ...
        <div class="hot">
            ...
            <div class="content">
                ...
                <div class="num fr"><b><%= goods.virtual.highly_recommend.groupbuy_virtual_quantity %></b><?= __('件已付款'); ?></div>
            </div>
            <div class="price clearfix">
                ...
                <div class="con clearfix">
                    <div class="left">
                        <div>
                            <b><?= __('￥'); ?></b><%= goods.virtual.highly_recommend.groupbuy_price %> <del><%= goods.virtual.highly_recommend.goods_price %></del>
                        </div>
