    ...
    <div id="cart-list-wp"></div>
        ...
        <!--<div class="nctouch-cart-container">
            <dl class="nctouch-cart-store">
                <dt><span class="store-check">
						...
						</span> <i class="icon-store"></i> <?= __('林小夕的店铺'); ?>
            ...
            <ul class="nctouch-cart-item">
                ...
                <li cart_id="1530" class="cart-litemw-cnt">
                    ...
                    <dl class="goods-info">
                        <dt class="goods-name"><a href="<?= __('＃'); ?>"> <?= __('海尔（'); ?>haier<?= __('）'); ?>XNO28-YEW <?= __('智慧嫩烤箱'); ?> <?= __('电烤箱'); ?> <?= __('蒸汽烤箱'); ?> <?= __('家用'); ?> </a></dt>

                    </dl>
                    <div class="goods-del" cart_id="1530"><a href="javascript:void(0);"></a></div>
                    <div class="goods-subtotal"><span class="goods-price"><em>100<?= __('积分'); ?></em></span>
            ...
            <div class="nctouch-bottom-mask nctouch-bottom-mask0">
                ...
                <div class="nctouch-bottom-mask-block">
                    ...
                    <div class="nctouch-bottom-mask-top store-voucher">
                        <i class="icon-store"></i> <?= __('林小夕的店铺'); ?>&nbsp;&nbsp;<?= __('领取店铺代金券'); ?>
        ...
        <div class="nctouch-cart-container">
            <dl class="nctouch-cart-store">
                <dt><span class="store-check">
							<input class="store_checkbox" type="checkbox" checked="">
						</span> <i class="icon-store"></i> <?= __('爱丽丝仙境'); ?>
            ...
            <ul class="nctouch-cart-item">
                ...
                <li cart_id="1544" class="cart-litemw-cnt">
                    ...
                    <dl class="goods-info">
                        <dt class="goods-name">
                            <a href="http://wap.bbc-builder.com/tmpl/product_detail.html?goods_id=651"> <?= __('苹果'); ?>(Apple) iPhone 6s Plus 4G<?= __('手机'); ?> <?= __('深空灰'); ?> <?= __('公开版'); ?>(64G ROM)<?= __('标配'); ?> </a>
                        </dt>
        ...
        <div class="nctouch-cart-bottom">
            ...
            <div class="total">
                <dl class="total-money">
                    <dt><?= __('合计总积分：'); ?></dt>
                    <dd><em>100<?= __('积分'); ?></em></dd>
                </dl>
            </div>
            <div class="check-out ok">
                <a href="javascript:void(0)"><?= __('确认兑换'); ?></a>
            </div>
        </div>-->
    ...
    <% if ( integral_cart_list && integral_cart_list.length > 0  ) { %>
                ...
                <li cart_id="<%= integral_cart_list[i].id %>" class="buy-li clearfix box-size cart-litemw-cnt">
                    ...
                    <div class="goods-subtotal">
                        <span class="goods-price">
                            <em><%= integral_cart_list[i].points_goods_points %><?= __('积分'); ?></em>
                        </span>
                    </div>
                </li>
            </ul>
        ...
        <% }%>
         ...
         <div class="nctouch-cart-bottom">
                ...
                <div class="total">
                    <dl class="total-money"><dt><?= __('合计总积分：'); ?></dt><dd><em>0<?= __('积分'); ?></em></dd></dl>
                </div>
                <div class="check-out">
                    <a href="javascript:void(0)"><?= __('确认兑换'); ?></a>
                </div>
