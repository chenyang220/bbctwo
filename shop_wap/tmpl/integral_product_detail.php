    ...
    <script type="text/html" id="product_detail">
        ...
        <div class="goods-detail-top">
            <div class="goods-detail-pic" id="mySwipe">
                <ul>
                    <li style="height: 262px;"><img src="<%= goods_detail.points_goods_image %>"/></li>
                </ul>
            </div>
        </div>
        <div class="goods-detail-cnt bgf">
            <div class="goods-detail-name clearfix">
                <dl>
            ...
            <div class="goods-detail-price integral-detail pl-20 pr-20 pb-20 borb1">
                <dl>
                    ...
                    <dd class="fz-24 pt-10"><em class="colbc">原价：<%= goods_detail.points_goods_price %>元</em><em class='default-color' style="display:none">每人限兑：3</em></dd>
                </dl>
                <% if ( goods_detail.points_goods_limitgrade > 1 ) { %> <span class="sold level">v<%= goods_detail.points_goods_limitgrade - 1 %>专享</span> <% } %>
            </div>
            ...
            <div class="nctouch-bottom-mask-top goods-options-info borb1">
                ...
                <dl>
                    ...
                    <dd class="goods-price integral-price fz-28 wp100">
                        <em class="price-color"><%= goods_detail.points_goods_points %>积分</em> <span class="goods-storage">库存：<%= goods_detail.points_goods_storage %></span>
                    </dd>
                </dl>
...
<script type="text/javascript">
    $(function(){
      var height = $('.goods-detail-top').height();
      $('.goods-detail-pic li').css('height','262px');
    })
</script>