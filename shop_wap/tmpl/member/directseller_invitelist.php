...
<body>
    ...
    <div class="nctouch-main-layout">
        ...
        <!-- <div id="fixed_nav" class="nctouch-single-nav">
            <ul id="filtrate_ul" class="w20h">
                <li class="selected"><a href="javascript:void(0);" data-state=""><?= __('全部用户'); ?></a></li>
            </ul>
        </div> -->
    ...
    <script type="text/html" id="order-list-tmpl">
					...
					<div class="nctouch-order-item-con">
                        <div class="goods-block">
                            <a href="javascript:void(0);">
                                ...
                                <dl class="goods-info">
                                    <p><?= __('用户名：'); ?><%=memberinfo.user_name%></p>
									<p><?= __('手机号：'); ?><%=memberinfo.user_mobile%></p>
									<p><?= __('注册时间：'); ?><%=memberinfo.user_regtime%></p>
                                </dl>
                            </a>
                        </div>
                    </div>
        ...
        <% if (hasmore) {%>
            <li class="loading">
                <div class="spinner"><i></i></div><?= __('会员数据读取中'); ?>...</li>
            <% } %>
        <%}else {%>
