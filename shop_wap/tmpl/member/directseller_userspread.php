	...
	<script type="text/html" id="user_list_tmpl">
		...
		<li class="extension">
			...
			<div class="clearfix">
				<ul class="fl ">
					<li class="clearfix">
						<p class="fl tl"><?= __('手机号'); ?>:</p>
						<p class="fl"><%=info.user_mobile%></p>
					</li>
					<li class="clearfix">
						<p class="fl tl"><?= __('推广会员数'); ?>:</p>
						<p class="fl"><%=info.invitors%><?= __('人'); ?></p>
					</li>
					<li class="clearfix">
						<p class="fl tl"><?= __('带来佣金'); ?>:</p>
						<p class="fl"><?= __('￥'); ?><%=info.commission%></p>
					</li>
				</ul>
				<ul class="fr ">
					<li class="clearfix">
						<p class="fl tl"><?= __('性别'); ?>:</p>
						<p class="fl"><%info.user_sex%></p>
					</li>
					<li class="clearfix">
						<p class="fl tl"><?= __('消费总额'); ?>:</p>
						<p class="fl"><?= __('￥'); ?><%=info.expends%></p>
					</li>
					<li class="clearfix">
						<p class=" fl tl"><?= __('注册时间'); ?>:</p>
