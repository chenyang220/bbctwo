...
<body>
    <header id="header" class="fixed">
        <div class="header-wrap">
            ...
            <div class="header-title"><h1><?= __('佣金明细'); ?></h1></div>
    ...
    <div class="nctouch-main-layout-reset">
        ...
        <div id="fixed_nav" class="nctouch-single-nav">
            <ul id="filtrate_ul" class="w20h">
                <li class="selected"><a href="javascript:void(0);" data-state=""><?= __('一级佣金'); ?></a></li>
                <li><a href="javascript:void(0);" data-state="second"><?= __('二级佣金'); ?></a></li>
                <li><a href="javascript:void(0);" data-state="third"><?= __('三级佣金'); ?></a></li>
            </ul>
        </div>
		...
		%>
            <li class="<%if(orderinfo.order_payment_amount){%>green-order-skin<%}else{%>gray-order-skin<%}%> <%if(i>0){%>mt-20<%}%>">                    
				<div class="nctouch-order-item">
					...
					<div class="nctouch-order-item-head">
						<span class="fz-26 fr col6"><?= __('订单号：'); ?><%=orderinfo.order_id%></span>
					</div>
