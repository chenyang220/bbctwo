            ...
            <form action="" method="">
                <ul class="form-box">
                    <li class="form-item">
                        ...
                        <div class="input-box">
                            <input type="tel" placeholder="<?= __('请输入手机号'); ?>" class="inp" name="usermobile" id="usermobile" oninput="writeClear($(this));" maxlength="11" autocomplete="off" />
                ...
                <div class="form-notes"><?= __('请填写已经绑定过的手机号码。'); ?></div>
            </form>
        </div>
