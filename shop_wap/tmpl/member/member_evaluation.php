                ...
                <order_goods.length
                    ...
                    <li>
                        ...
                        <div class="evaluation-inp-block hg4 pl-30 pr-30">
                            <textarea type="text" class="js-content textarea wp100 chain" name="goods[<%=order_goods[i].order_goods_id%>][comment]" placeholder="<?= __('亲，写点什么吧，您的意见对其他买家有很大帮助！'); ?>" maxlength="200" style="position: relative;"></textarea>
