...
?>
    ...
    <script type="text/html" id="member-evaluation-script">
        ...
        %>
            <ul class="nctouch-evaluation-goods">
                <%for(var i=0; i < data.length; i++){%>
                    <% if(data[i].length > 1){ %>
                        ...
                        <li>
                            <%if(j>0){%>
                                <span class="fz-30 col5 pad20"><?= __('追加评价：'); ?></span>
                            <%}%>
                            <% if(j == 0){%>
                            <div class="evaluation-info  pad30 evaluation-info-new">
                                ...
                                <dl class="goods-info">
                                    <div class="flex-lr">
                                        ...
                                        <em class="goods-rate default-color"><?= __('￥'); ?><%=data[i][j].goods_price%></em>
                                    </div>
                                    <div class="flex-lr">
                            ...
                            <div class="evaluation-upload-block pl-20 pr-20">
                                <div class="fz-28 c-444 pb-30"><p><?= __('评价晒图'); ?></p></div>
                                <div class="clearfix">
            ...
            <a class="btn-l mt5 mb5"><?= __('追加评价'); ?></a>
            <%}%> --> 
            <%if(order_goods_evaluation_status != 2){%>
            <a class="btn-l mt5 mb5"><?= __('追加评价'); ?></a>
            <%}%>
        <%}%>
    </script>
