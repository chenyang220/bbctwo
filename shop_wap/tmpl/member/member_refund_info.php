...
<script type="text/html" id="refund-info-script">
   <!--<div>
        ...
        <span><?= __('￥'); ?><%=order_amount%></span>
        <span><?= __('￥'); ?><%=order_goods_price%></span>
    ...
    <h3 class="nctouch-default-list-tit"><?= __('我的退款申请'); ?></h3>
    ...
    <h3 class="nctouch-default-list-tit"><?= __('商家退款处理'); ?></h3>
    <ul class="nctouch-default-list">
        <li>
            <h4><?= __('审核状态'); ?></h4>
    ...
    <h3 class="nctouch-default-list-tit"><?= __('商城退款审核'); ?></h3>
    <ul class="nctouch-default-list">
        <li>
            <h4><?= __('平台确认'); ?></h4>
            <span class="num"><%=return_state_text%></span></li>
