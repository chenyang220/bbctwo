    ...
    <div class="nctouch-main-layout">
        ...
        <div id="fixed_nav" class="nctouch-single-nav">
            <ul id="filtrate_ul" class="w33h">
                <li><a href="predepositlog_list.html"><?= __('账户余额'); ?></a></li>
                <li><a href="pdrecharge_list.html"><?= __('充值明细'); ?></a></li>
                <li class="selected"><a href="javascript:void(0);"><?= __('余额提现'); ?></a></li>
            </ul>
        </div>
            ...
            <% for (var k in list) { var v = list[k]; %>
                <li>
                    <a href="pdcashinfo.html?pdc_id=<%=v.pdc_id %>">
                        <dl>
                            <dt><i></i><?= __('提现审核：'); ?><%=v.pdc_payment_state_text %></dt>
                            <dd><?= __('提现单号：'); ?>
                                <%=v.pdc_sn %>
                            </dd>
                        </dl>
