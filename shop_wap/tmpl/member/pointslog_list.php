...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../../css/nctouch_member.css?v=9">
</head>
<script type="text/javascript">
    //用app电话号码登录
    var u_id = '<?php echo $u_id;?>';
    if (u_id) {
       window.location.href = UCenterApiUrl + '/?ctl=Login&met=oauth&typ=e&u_id=' + u_id + "&return_url=" + WapSiteUrl + "/tmpl/member/pointslog_list.html";
    }
</script>
<body>
    <header id="header">
