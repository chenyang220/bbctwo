    ...
    <header id="header">
        <div class="header-wrap">
            ...
            <span class="header-tab">
                <a href="member_refund.html" style="border-right-width: 0px;"><?= __('退款'); ?></a>
                <a href="member_return.html"><?= __('退货'); ?></a>
                <a href="javascript:void(0);" class="cur"><?= __('虚拟退款'); ?></a>
            </span>
                ...
                <li class=" <%if(i>0){%>mt-20<%}%>">
                    <div class="nctouch-order-item">
                            ...
                            <div class="goods-block">
                                <a href="<%=WapSiteUrl%>/tmpl/member/member_refund_info.html?refund_id=<%=refund_list[i].order_return_id%>">
                                    <dl class="goods-info" style="margin-left: 0;margin-right: 0;width: 100%;">
                                        <dt class="goods-name"><?= __('订单编号'); ?></dt>
                        ...
                        <div class="nctouch-order-item-footer">
                            ...
                            <div class="handle">
                                <a href="<%=WapSiteUrl%>/tmpl/member/member_refund_info.html?refund_id=<%=refund_list[i].order_return_id%>" class="btn evaluation-again-order"><?= __('退款详情'); ?></a>
                            </div>
                        </div>
                    </div>
                </li>
