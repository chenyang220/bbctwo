...
<div id="container-fcode" class="hide">
    <div class="fcode-bg">
        <div class="con">
            ...
            <h5><?= __('请输入所知的'); ?>F<?= __('码序列号并提交验证'); ?><br /> <?= __('系统效验后可继续完成下单'); ?></h5>
    ...
    <div id="list-address-wrapper" class="nctouch-full-mask hide">
        ...
        <div class="nctouch-full-mask-block">
            ...
            <div id="addresslist" class="mt10" style="position: absolute; right: 0; left: 0; bottom: 0; z-index: 1;">
                <a href="javascript:void(0);" class="btn-l" id="new-address-valve"><?= __('新增收货地址'); ?></a></div>
        </div>
    </div>
    <!--<?= __('选择收货地址'); ?>End-->
    <!--<?= __('新增收货地址'); ?>Begin-->
            ...
            <li class="buy-item bgf6">
                <div class="buy-li">
                    ...
                    <dl class="goods-info">
                        <dt class="goods-name">
                            <a href="<%=WapSiteUrl%>/tmpl/pintuan_detail.html?goods_id=<%=goods.goods_id%>">
                                <em style="color:red">[<%= pintuan.person_num %><?= __('人团'); ?>]</em><%= pintuan.name %>
                            </a>
                        </dt>
                        <dd class="goods-type"><%= goods.goods_name %></dd>
                    </dl>
                    <div class="goods-subtotal">
                        <span class="goods-price"><?= __('￥'); ?><em><%= currentGoodsPrice %></em></span>
                    </div>
                    <div class="goods-num">
                        <em>x1</em>
                    </div>
...
<script type="text/html" id="list-address-add-list-script">
    ...
    <i></i>
    <dl>
        <dt><?= __('收货人：'); ?><span id=""><%=address_list[i].user_address_contact%></span><span id=""><%=address_list[i].user_address_phone%></span><% if (address_list[i].user_address_default == 1) { %><sub><?= __('默认'); ?></sub><% } %>
        </dt>
        <dd>
