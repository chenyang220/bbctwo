...
a.buy-now {
    ...
    <script type="text/html" id="draw_report">
        ...
        <!-- 商品名称 -->
        <!-- <div class="poster_goods_name">
            <% if(goods_name.length > 18){ %>
            <p class="poster_goods_name_p"><%=goods_name.substring(0,18)%>...</p>
            <% }else{ %>
            <p class="poster_goods_name_p"><%=goods_name%></p>
            <% } %>
        </div> -->
        <!-- 商品详情 -->
           ...
           <div class="goods-detail-price sale-pri">
			...
			<div class="flex1 goods-detail-pri-content">
				<div class="iblock align-top">
					...
					<!-- <p><%=goods_info.groupbuy_virtual_quantity%><?= __('件已团购'); ?></p> -->
				</div>
            ...
            <div class="goods-detail-price sale-pri">
				...
				<div class="flex1 goods-detail-pri-content">
					<div class="iblock align-top">
						...
						<!-- <p><?= __('每人限购'); ?><%=goods_info.lower_limit%><?= __('件'); ?></p> -->
					</div>
					<div class="iblock align-top tc fr">
					<% if(goods_info.promotion_is_start == 0){ %> <span class="sold"><?= __('距离开始'); ?></span>
					<div class="time fnTimeCountDown" data-end="<%=goods_info.groupbuy_starttime%>">
...
<!--                        <dd class="fr sharess_wap" id='shareit'><i class="iconfont icon-share"></i><span>--><?//= __('分享'); ?><!--</span></dd>-->
<!--                    --><?php //}elseif(strpos($_SERVER['HTTP_USER_AGENT'],'UCBrowser')!==false||strpos($_SERVER['HTTP_USER_AGENT'],'UCWEB')!==false){ ?>
<!--                         <dd class="fr" id='sharess_wap'><i class="iconfont icon-share"></i><span>--><?//= __('分享'); ?><!--</span></dd>-->
           ...
           <!-- <div class="goods-detail-item " id="goods_spec_selected">
            ...
            <!-- <div class="goods-detail-item clearfix">
                 <div class="fl fz-0">
                        ...
                        <span class="itme-name middle ml-20 fz6"><?= __('商品组合'); ?></span>
                    </div>
                    <div class="fr">
                        <span class="itme-name align-top fz6"><?= __('共'); ?>5<?= __('组'); ?></span>
                        <i class="iconfont icon-arrow-right fz6 col9 iblock align-top md-icon-lh"></i>
                    </div>
            </div>
            <div class="combination-module bgf borb1">
                <h3 class="fz-28 c-666"><?= __('组合'); ?>1</h3>
                <ul class="tc">
                    <li><div><img src="" alt=""></div><span class="block">A21<?= __('以存线上品'); ?></span></li>
            ...
            <!-- <?= __('门店自提'); ?> -->
            <div id="ziti" class="goods-detail-item ziti-area clearfix bort1" data-is_delivery="<%= is_delivery %>">
                <div class="clearfix">
                    <div class="fl fz-0">
                        <!-- <i class="icon middle"></i> --> <span class="itme-name middle fz-30"><?= __('门店服务'); ?></span>
                    </div>
                    <div class="fr">
                        <% if (is_delivery == 1) {%>
                         <span class="itme-name align-top fz6"><?= __('门店配送'); ?></span> <i class="iconfont icon-arrow-right fz6 col0 iblock align-top md-icon-lh"></i>
                        <% }else{ %>
                         <span class="itme-name align-top fz6"><?= __('门店自提'); ?></span> <i class="iconfont icon-arrow-right fz6 col0 iblock align-top md-icon-lh"></i>
                        <% } %>
                    </div>
                </div>
    ...
    <script>
        ...
        $(function () {
            ...
            UC.config = {
                ...
                //redirectUri: 'http://114.94.190.21:18080/netway_cityservice/cityservice/appeal_index.html?token=#TOKEN&enterId=#ENTERID'
...
//                    console.log("内容顶部的距离" + minNumber);
                    // console.log("y"+ y);
                    if (y < minNumber) {
                        console.log("当前在" + i + "区域");
//               $(".header-nav li").css("color","blue");
