    ...
    <div class="nctouch-main-layout">
        <div class="nctouch-tag-nav">
            <ul>1
                ...
                <li><a href="javascript:void(0);" data-state="4"><?= __('带图评价'); ?></a></li>
                <!--<li><a href="javascript:void(0);" data-state="5"><?= __('追加评价'); ?></a></li>-->
            </ul>
        </div>
                        ...
                        <%}%>
                            <% if ( goods_eval_list[i].length > 1 ) { var goods_eval_again = goods_eval_list[i][1]; %>
                                <div class="again-eval clearfix">
                                    <span><?= __('追评：'); ?></span><time class="fr"><%=goods_eval_again.create_time%></time></div>
