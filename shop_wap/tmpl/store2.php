...
?>
 ...
 <script type="text/html" id="store_sliders_tpl">
    ...
    <script type="text/html" id="goodsrank_collect_tpl">
        <div class="module-fresh-goods-rank">
        <% var goods_list = items; %>
        <% for (var i in goods_list) { var v = goods_list[i]; %>
            <div class="fresh-goods-rank-li" style="background:url(<%= v.common_image %>) no-repeat center;background-size:cover;">
                <a href="product_detail.html?goods_id=<%= v.goods_id[0].goods_id %>">
                    <!-- <dt><img alt="<%= v.common_name %>" src="<%= v.common_image %>"/></dt> -->
                    <p class="clearfix"><span class="fl"><?= __('收藏'); ?><em><%= v.common_collect %></em></span><span class="fr"><?= __('￥'); ?><em><%= v.common_price %></em></span></p>
                </a>
            </div>
        <% } %>
        </ul>
    ...
    <script type="text/html" id="goodsrank_salenum_tpl">
        ...
        <% for (var i in goods_list) { var v = goods_list[i]; %>
            <div class="fresh-goods-rank-li" style="background:url(<%= v.common_image %>) no-repeat center;background-size:cover;">
                <a href="product_detail.html?goods_id=<%= v.goods_id[0].goods_id %>">
                    <!-- <dt><img alt="<%= v.common_name %>" src="<%= v.common_image %>"/></dt> -->
                    <p class="clearfix"><span class="fl"><?= __('已售'); ?><em><%= v.common_salenum %></em></span><span class="fr"><?= __('￥'); ?><em><%= v.common_price %></em></span></p>
                </a>
            </div>
        <% } %>
        </ul>
   ...
   <!--  <script type="text/html" id="goodsrank_collect_tpl">
    ...
    <ul class="clearfix">
        <li  class="active shop_footer_dh">
            <a href="store2.html?shop_id=<%=data %>">
                <i class="iconfont icon-home-active"></i>
                <h3>首页</h3>
            </a>
        </li>
        <li class="shop_footer_dh">
            <a href="shop_goods_cat.html?shop_id=<%=data %>&mb=shop&style=2">
