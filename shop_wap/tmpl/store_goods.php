        ...
        <div class="header-wrap">
            <div class="header-l">
             ...
             <div class="header-inp clearfix header-inp-wreset"> <i class="icon"></i>
                <input type="text" class="search-input" id="goods_search"  placeholder="<?= __('搜索店铺内商品'); ?>" maxlength="50" autocomplete="on" autofocus>
            </div>
            <!-- <a class="header-inp" id="goods_search" href=""><i class="icon"></i><span class="search-input"><?= __('搜索店铺内商品'); ?></span></a> -->
            <div class="header-r"><!--  <a id="store_categroy" href="" class="store-categroy"><i></i>
      <p><?= __('分类'); ?></p>
    </a>  --><a id="search_btn" href="javascript:void(0);" class="search-btn"><?= __('搜索'); ?></a><a id="header-nav" href="javascript:void(0);"><i class="more"></i><sup></sup></a></div>
        </div>
