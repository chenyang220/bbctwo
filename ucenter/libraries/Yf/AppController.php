    ...
    public function __construct(&$ctl, $met, $typ)
    {
        ...
        if (true || 'e' == $this->typ)
        {
            ...
            if (!is_file($this->tpl)) {
                ...
                $static_url = str_replace('mobile', 'default', $static_url);
                $this->view->stc = $static_url;
                $this->view->img = $static_url  . '/images';
                $this->view->css = $static_url  . '/css';
                $this->view->js  = $static_url  . '/js';
                $static_url_com = str_replace('detfault', 'common', $static_url);
                $this->view->img_com = $static_url_com  . '/images';
                $this->view->css_com = $static_url_com  . '/css';
                $this->view->js_com  = $static_url_com  . '/js';
            }else{
