...
class Yf_Data
{
	...
	public $clear_session_code = null;
	...
	*/
	...
	public function setError($msg, $data=array(), $status=250)
	{
		...
		//$this->dataRows[] = $item;
		$this->dataRows = $item;
		//临时处理方案 @nsy 2020-06-05
		if($this->clear_session_code && ("auth" == $this->clear_session_code) ){
			if(isset($_SESSION[$this->clear_session_code])){
				unset($_SESSION[$this->clear_session_code]);
			}
		}
	}
