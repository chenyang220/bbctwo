...
class Plugin_Perm implements Yf_Plugin_Interface
{
    ...
    public function checkPerm()
    {
		...
		//无需权限判断的文件
		$not_perm = array('Login', 'Api', 'ImApi', 'Index', 'Connect_Qq', 'Connect_Weixin', 'Connect_WeixinIn','Connect_Weibo','Connect_Bind','Connect', 'Upload', 'OAuth2', 'Base_AppVersion','Connect_Wxapp','Test');
