...
(function(factory) {
    ...
    Plugin.prototype = {
            ...
            if (this._getDialCode(val) && !this._isRegionlessNanp(val)) {
                ...
                if (this.options.initialCountry) {
                    ...
                    if(area_code){
                        ...
                        for(var i in this.countries){
                            if(this.countries[i].dialCode==area_code1){
                                this.defaultCountry = this.countries[i].iso2;
                                break;
                            }
                        }
        ...
        _setFlag: function(countryCode) {
            ...
            $('#phone').attr('data-area_code',this.selectedCountryData.dialCode);
            if(this.selectedCountryData.dialCode){
                $('#area_code').val(this.selectedCountryData.dialCode);
                $('#area_code1').val(this.selectedCountryData.dialCode);
            }
