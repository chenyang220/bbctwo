...
<div class="third-part ">
        ...
        <div class="tc form-con">
            <div class="center">
                ...
                <dl class="clearfix">
                    <dt>手机号码：</dt>
                    <dd>
                        <input type="text" style="width: 212px!important;height: 36px!important;" id="re_user_mobile" class="field re_user_mobile" placeholder="建议使用常用手机" maxlength="11" default="<i class=&quot;i-def&quot;></i>完成验证后，可以使用该手机登录和找回密码" onblur="checkMobile()" autocomplete="off">
                        <p class="input-tip">
                            <span class="error"></span>
                        </p>
                    </dd>
                ...
                <dl class="clearfix">
                    <dt><?= _('图形验证码') ?>：</dt>
                    <dd>
                        <input type="text" name="yzm"  style="width: 110px!important;height: 36px!important;" id="yzm" maxlength="6" placeholder="<?= _('请输入验证码') ?>" default="<i class=&quot;i-def&quot;></i><?= _('看不清？点击图片更换验证码') ?>" onblur="checkCode()" />
                        <div style="float: right;">
                            <img onClick="get_randfunc(this);" title="<?= _('换一换') ?>" class="img-code" style="cursor:pointer;width: 110px!important;height: 36px!important;" src='./libraries/rand_func.php' />
                        </div>
                        <p class="input-tip">
                ...
                <dl class="clearfix">
                    <dt>手机验证码：</dt>
                    <dd class="clearfix">
                        <input type="text" autocomplete="off" class="fl"  style="width: 80px!important;height: 36px!important;" id="phonecode" /><a href="javascript:;" class="btn-code-get fr " id="btn-phonecode" onclick="get_randcode_phone()"> 获 取 验 证 码 </a>
                    </dd>
                ...
                <dl class="clearfix">
                    <dt>设置密码：</dt>
                    <dd class="pas-set">
                        <input type="text" autocomplete="false"  style="width: 212px!important;height: 36px!important;" id="re_user_password" class="field re_user_password" placeholder="建议至少使用两种字符组合密码" maxlength="20" onfocus="checkPwd()" onblur="pwdCallback()" autocomplete="off">
    ...
    <div class="third-part-con tab1 tabs" id='tab1' style="display:none;">
        ...
        <div class="tc form-con">
            <dl class="mrb20">
                <dt>用户名：</dt>
                <dd><input type="text" style="width: 212px!important;height: 36px!important;" id="user_account" placeholder="请输入用户名"></dd>
            </dl>
            <dl>
                <dt>登录密码：</dt>
                <dd><input type="text" style="width: 212px!important;height: 36px!important;" id="user_password" placeholder="请输入密码"></dd>
            </dl>
