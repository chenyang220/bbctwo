                  ...
                  <dd>
                      <div class="user-avatar">
                          ...
                          <div class="container" id="crop-avatar" style="    margin-left: 0; width: 220px;">
                              <!-- Current avatar -->
                              <div class="avatar-view" title="<?=__('修改头像')?>">
                                      ...
                                      <div class="modal-content">
                                          <form class="avatar-form" action="./libraries/crop.php" enctype="multipart/form-data" method="post">
                                              <div class="modal-header">
                                                  ...
                                                  <h4 class="modal-title" id="avatar-modal-label"><?=__('修改头像')?></h4>
                                              </div>
                                              <div class="modal-body">
                                                  <div class="avatar-body">
                                                      ...
                                                      <div class="avatar-upload">
                                                          ...
                                                          <label for="avatarInput"><?=__('上传')?></label>
                                                      ...
                                                      <div class="row avatar-btns">
                                                          ...
                                                          <div class="col-md-3">
                                                              <button type="submit" class="btn btn-primary btn-block avatar-save"><?=__('头像')?>上传</button>
                                                          </div>
                                                      </div>
                                                  </div>
                                              </div>
        ...
        <dl class="bottom">
                      ...
                      <dd>
                        <label class="submit-border">
                          <input type="button" id="submit"  class="submit bbc_btns" value="<?=__('保存修改')?>">
                        </label>
                      </dd>
                </dl>
              </div>
