...
function initGrid()
{
    ...
    var t = ["操作", "应用ID", "应用名称","显示名称", "应用类型", "应用密钥", "应用 IP 列表", "应用网址","后台网址", "是否启用"/*,"网址补给","检查订单是否存在的url地址","图片地址","域名列表","返回字段"*/];
    e = [{
        name: "operate",
        width: 60,
        //fixed: !0,
        ...
        {name: "app_showname", index: "app_showname", width: 200, align: "center",},
