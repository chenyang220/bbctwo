...
<form method="post" name="manage-form" id="manage-form">
	...
	<div class="ncap-form-default">
		...
		<dl class="row">
			<dt class="tit">
				<label class="input-label" for="app_version"><?= __('当前版本');?></label>
			</dt>
			<dd class="opt">
				<input type="text" class="ui-input ui-input-ph w400" name="app_version" id="app_version"  placeholder="<?= __('当前版本');?>" autocomplete="off" />
				<span class="err"></span>
				<p class="notic"></p>
			</dd>
		</dl>
		...
		<dl class="row">
			<dt class="tit">
				<label class="input-label" for="app_version_next"><?= __('下个版本');?></label>
			</dt>
			<dd class="opt">
				<div style="float: left;width:50%;">
					<input type="text" class="ui-input ui-input-ph w400" name="app_version_next" id="app_version_next"  placeholder="<?= __('下个版本');?>" autocomplete="off" />
				</div>
			</dd>
		</dl>
		...
		<dl class="row">
			<dt class="tit">
				<label class="input-label" for="app_res_filename"><?= __('资源名称');?></label>
			</dt>
			<dd class="opt">
				<div style="float: left;width:50%;">
					<input type="text" class="ui-input ui-input-ph w400" name="app_res_filename" id="app_res_filename"  placeholder="<?= __('资源名称');?>" autocomplete="off" />
				</div>
			</dd>
		</dl>
		...
		<dl class="row">
			<dt class="tit">
				<label class="input-label" for="app_res_filesize"><?= __('文件大小');?></label>
			</dt>
			<dd class="opt">
				<input type="text" class="ui-input ui-input-ph w400" name="app_res_filesize" id="app_res_filesize"  placeholder="<?= __('文件大小');?>" autocomplete="off" />
			</dd>
		</dl>
		...
		<dl class="row">
			<dt class="tit">
				<label class="input-label" for="app_package_url"><?= __('安装包地址');?></label>
			</dt>
			<dd class="opt">
				<input type="text" class="ui-input ui-input-ph w400" name="app_package_url" id="app_package_url"  placeholder="<?= __('安装包地址');?>:<?= __('脚本动态增量安装则不需要固定安装包');?>" autocomplete="off" />
			</dd>
		</dl>
		...
		<dl class="row">
			<dt class="tit">
				<label class="input-label" for="app_res_time"><?= __('版本时间');?></label>
			</dt>
			<dd class="opt">
				<input type="text" class="ui-input ui-input-ph w400" name="app_res_time" id="app_res_time"  placeholder="<?= __('版本时间');?>" autocomplete="off" />
			</dd>
		</dl>
		...
		<dl class="row">
			<dt class="tit">
				<label class="input-label" for="app_reinstall"><?= __('是否需要更新安装包');?></label>
			</dt>
			<dd class="opt">
				<label title="<?= __('动态增量升级');?>" for="app_reinstall_0"><input class="cbr cbr-success" id="app_reinstall_0" name="app_reinstall" value="0" type="radio" checked ><?= __('动态增量升级');?></label> &nbsp; &nbsp; &nbsp; &nbsp;<label title="<?= __('强制');?>APP<?= __('下载全新安装包');?>" for="app_reinstall_1"><input class="cbr cbr-success" id="app_reinstall_1" name="app_reinstall" value="1" type="radio"  ><?= __('强制');?>APP<?= __('下载全新安装包');?></label>
			</dd>
		</dl>
		...
		<dl class="row">
			<dt class="tit">
				<label class="input-label" for="app_release"><?= __('是否发布');?></label>
			</dt>
			<dd class="opt">
				<label title="<?= __('预发布');?>" for="app_release_0"><input class="cbr cbr-success" id="app_release_0" name="app_release" value="0" type="radio" checked ><?= __('预发布');?></label> &nbsp;<label title="<?= __('发布');?>" for="app_release_1"><input class="cbr cbr-success" id="app_release_1" name="app_release" value="1" type="radio"  ><?= __('发布');?></label>
			</dd>
		</dl>
		...
		<dl class="row">
			<dt class="tit">
				<label class="input-label" for="app_update_log"><?= __('更新日志');?></label>
			</dt>
			<dd class="opt">
				<textarea type="text" class="ui-input ui-input-ph w400" name="app_update_log" id="app_update_log"  placeholder="<?= __('更新日志');?>" autocomplete="off" ></textarea>
			</dd>
		</dl>
	</div>
</form>
