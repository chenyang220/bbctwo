...
<div class="wrapper page">
   ...
   <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <ul>
            <li><?= __('可以将不同的系统接入');?>Ucenter,<?= __('实现用户的同步');?>,<?= __('可以在此处配置需要接入的应用');?></li>
        </ul>
    </div>
        ...
        <div class="item-title">
          <div class="subject">
            ...
            <h5><?= __('增加或删除相关应用');?></h5>
	          ...
	          <li><a class="current"><span><?= __('应用配置');?></span></a></li>
	      </ul>
        </div>
    </div>
    <div class="ncap-form-default">
		<div class="mod-search cf">
		    ...
		    <div class="fr"><a href="#" class="ui-btn ui-btn-sp" id="btn-add"><?= __('新增');?><i class="iconfont icon-btn03"></i></a></div>
		</div>
	    <div class="cf">
			<div class="grid-wrap">
				<!-- <h3><?= __('应用配置');?>:<span id='currentCategory'></span></h3> -->
				<table id="grid">
				</table>
				<div id="page"></div>
			</div>
