...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current"><span><?= __('用户默认头像');?></span></a></li>
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <ul>
            <li><?= __('网站基础信息配置');?>,<?= __('系统安装成功后');?>,<?= __('应先配置此处。');?></li>
        </ul>
    </div>
    ...
    <form method="post" enctype="multipart/form-data" id="site-config-form" name="form">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                <dt class="tit">
                    <label><?= __('用户默认头像');?></label>
                </dt>
                <dd class="opt">
                    <img id="user_default_image" name="site[user_default_avatar]" alt="<?= __('选择图片');?>" src="<?=($data['user_default_avatar']['config_value'])?>" width="120px" height="120px" />

                    <div class="image-line upload-image"  id="user_default_avatar_upload"><?= __('上传图片');?></div>
                    ...
                    <div class="notic"><?= __('用户默认头像');?>,<?= __('通用与用户未设置头像时使用，最佳显示尺寸为');?>120*120<?= __('像素');?></div>
                </dd>
            </dl>
