    ...
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=settings&typ=e&config_type%5B%5D=site"><span><?= __('站点');?>Logo</span></a></li>
    ...
    <form method="post" enctype="multipart/form-data" id="site-config-form" name="form">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <img id="site_logo_image" name="site[site_logo]" alt="<?= __('选择图片');?>" src="<?=($data['site_logo']['config_value'])?>" width="240px" height="60px" />

                    <div class="image-line upload-image"  id="site_logo_upload"><?= __('上传图片');?></div>
