...
<div class="wrapper page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                ...
                <li><a class="current" href="<?= Yf_Registry::get('url') ?>?ctl=Config&met=site&config_type%5B%5D=site"><span><?= __('基础设置');?></span></a></li>
    ...
    <p class="warn_xiaoma"><span></span><em></em></p><div class="explanation" id="explanation">
        ...
        <ul>
            <li><?= __('网站全局基本设置，商城及其他模块相关内容在其各自栏目设置项内进行操作。');?></li>
        </ul>
    </div>
...
<!--            </dl>-->
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="monetary_unit">ICP<?= __('证书号');?></label>
                </dt>
                <dd class="opt">
                    <input id="icp_number" name="site[icp_number]" value="<?=($data['icp_number']['config_value'])?>" class="ui-input w346" type="text"/>

                    <p class="notic"><?= __('前台页面底部可以显示');?> ICP <?= __('备案信息，如果网站已备案，在此输入你的授权码，它将显示在前台页面底部，如果没有请留空');?></p>
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
