...
<form method="post" name="manage-form" id="manage-form">
    ...
    <div class="ncap-form-default">
        <dl class="row">
            <dt class="tit">
                <label class="licence_domain" for="licence_domain"><em>*</em><?= __('允许的域名');?></label>
            </dt>
            <dd class="opt">
                <input type="text" maxlength="200" value="" name="licence_domain" id="licence_domain" class="ui-input ui-input-ph w400">
                <span class="err"></span>
                <p class="notic"><?= __('添加多个域名的时候，以');?>","<?= __('隔开');?></p>
            </dd>
        </dl>

        <dl class="row">
            <dt class="tit">
                <label class="company_name" for="company_name"><em>*</em><?= __('授权名称');?></label>
            </dt>
            <dd class="opt">
                <input type="text" maxlength="200" value="" name="company_name" id="company_name" class="ui-input ui-input-ph w400">
                <span class="err"></span>
                <p class="notic"><?= __('可以填写公司名称或者个人名称');?></p>
            </dd>
        </dl>

        <dl class="row">
            <dt class="tit">
                <label><em>*</em><?= __('生效日期');?></label>
            </dt>
            <dd class="opt">
