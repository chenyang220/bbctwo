...
<form method="post" name="manage-form" id="manage-form">
    <input type="hidden" class="input-text form-control" name="reg_option_id" id="reg_option_id"  placeholder="<?= __('选项值');?>" autocomplete="off" />

    <div class="ncap-form-default">
        <dl class="row">
            <dt class="tit">
                <label class="reg_option_name" for="reg_option_name"><em>*</em><?= __('配置名称');?></label>
            </dt>
            <dd class="opt">
        ...
        <dl class="row">
            <dt class="tit">
                <label class="option_id" for="option_id"><em></em><?= __('类型');?></label>
        ...
        <dl class="row">
            <dt class="tit">
                <label class="reg_option_value" for="reg_option_value"><em></em><?= __('配置值');?></label>
            </dt>
            <dd class="opt">
        ...
        <dl class="row">
            <dt class="tit">
                <label class="reg_option_datatype" for="reg_option_datatype"><em></em><?= __('规则设定');?></label>
        ...
        <dl class="row">
            <dt class="tit">
                <label class="reg_option_required" for="reg_option_required"><em></em><?= __('是否必填');?></label>
            </dt>
        ...
        <dl class="row">
            <dt class="tit">
                <label class="reg_option_active" for="reg_option_active"><em></em><?= __('是否启用');?></label>
            </dt>
            <dd class="opt onoff" style="font-size:0;">
                <label for="a-enable1" class="cb-enable  "><?= __('是');?></label>
                <label for="a-enable0" class="cb-disable  selected"><?= __('否');?></label>
