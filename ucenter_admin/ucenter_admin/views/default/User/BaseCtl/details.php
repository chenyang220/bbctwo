...
<div class="ncap-form-default">
	<dl class="row">
		<dt class="tit">
			<label class="licence_domain" for="licence_domain"><em>*</em><?= __('用户名称');?> :</label>
		</dt>
	...
	<dl class="row">
		<dt class="tit">
			<label class="licence_domain" for="licence_domain"><em>*</em><?= __('真实姓名');?> :</label>
		</dt>
	...
	<dl class="row">
		<dt class="tit">
			<label class="licence_domain" for="licence_domain"><em>*</em><?= __('性别');?> :</label>
		</dt>
	...
	<dl class="row">
		<dt class="tit">
			<label class="licence_domain" for="licence_domain"><em>*</em><?= __('生日');?> :</label>
		</dt>
	...
	<dl class="row">
		<dt class="tit">
			<label class="licence_domain" for="licence_domain"><em>*</em><?= __('用户手机');?> :</label>
		</dt>
	...
	<dl class="row">
		<dt class="tit">
			<label class="licence_domain" for="licence_domain"><em>*</em><?= __('用户邮箱');?> :</label>
		</dt>
	...
	<dl class="row">
		<dt class="tit">
			<label class="licence_domain" for="licence_domain"><em>*</em><?= __('用户地址');?> :</label>
		</dt>
