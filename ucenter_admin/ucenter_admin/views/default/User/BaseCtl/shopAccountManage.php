    ...
    <div id="manage-wrap" class="manage-wrap">
    	<form id="manage-form" action="">
    		...
    		<ul class="mod-form-rows base-form cf" id="base-form">
				...
				?>
    			<li class="row-item odd">
    				<div class="label-wrap"><label for="ucenter_url"><?= __('用户中心');?>:</label></div>
    			...
    			<li class="row-item">
    				<div class="label-wrap"><label for="paycenter_url"><?= __('支付中心');?>:</label></div>
